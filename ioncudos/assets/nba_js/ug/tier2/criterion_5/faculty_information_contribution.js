...
$('#view').on('change','#year_list__5', function() {
    ...
    if(year){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c5_faculty/fetch_faculty_information_contributions',
            async:false,
            data: post_data,
...
$('#view').on('change','#curriculum_list__5_1', function() {
    ...
    $.ajax({
        type:"POST",
        url: base_url+'nba_sar/t2ug_c5_faculty/fetch_student_faculty_ratio_sfr',
        async:false,
        data: post_data,
        success: function(student_faculty_ratio_info) {
...
$('#view').on('change','#curriculum_list__5_2', function() {
    ...
    if(curriculum){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c5_faculty/fetch_faculty_cadre_proportion',
            async:false,
            data: post_data,
...
$('#view').on('change','#curriculum_list__5_3', function() {
    ...
    if(curriculum){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c5_faculty/fetch_faculty_qualification',
            async:false,
            data: post_data,
...
$('#view').on('change','#curriculum_list__5_4', function() {
    ...
    if(curriculum){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c5_faculty/fetch_faculty_retention',
            async:false,
            data: post_data,
...
$('#view').on('change','#year_list__5_6', function() {
    ...
    if(year){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c5_faculty/fetch_faculty_development_training',
            async:false,
            data: post_data,
            success: function(student_faculty_ratio_info) {
...
$('#view').on('change','#year_list__5_8', function() {
    ...
    if(year){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c5_faculty/fetch_faculty_performance_appraisal',
            async:false,
            data: post_data,
            success: function(student_faculty_ratio_info) {
...
$('#view').on('change','#year_list__5_9', function() {
    ...
    if(year){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c5_faculty/fetch_faculty_adjunct',
            async:false,
            data: post_data,
            success: function(student_faculty_ratio_info) {
