        ...
        <div class="span12">
            ...
            <section id="contents">
                ...
                <div class="bs-docs-example">
                    ...
                    <div class="navbar">
                        <div class="navbar-inner-custom">
                            <?php if ($ref_id == "ref_12") { ?>
                                <?php echo $this->lang->line('entity_cie_full'); ?> Assessment Data Import Details
                            <?php } else if ($ref_id == "ref_29") { ?>
                                <?php echo $this->lang->line('entity_mte_full'); ?> Assessment Data Import Details
                            <?php }else{?>
							 <?php echo $this->lang->line('entity_see_full'); ?> Assessment Data Import Details
							<?php } ?>
                        </div>
                    </div>
                    ...
                    <?php if ($ref_id == "ref_12") { ?>
                        <!--Re-import students marks for CIA-->
                        <a type="button" id="import_module" href="<?php echo base_url('assessment_attainment/import_assessment_data/temp_import_template/' . $dept_id . '/' . $prog_id . '/' . $crclm_id . '/' . $term_id . '/' . $crs_id . '/' . $qpd_id . '/' . $ao_id . '/' . $ref_id); ?>" class="btn btn-success pull-right" style="margin-right: 2px;"><i class="icon-upload icon-white"></i> Re-import </a>						

                        <!--close and return to list page - CIA-->
                        <a href="<?php echo base_url('assessment_attainment/import_cia_data/manage_cia_marks/' . $dept_id . '/' . $prog_id . '/' . $crclm_id . '/' . $term_id . '/' . $crs_id . '/' . $section_id); ?>" class="btn btn-primary pull-right" style="margin-right: 2px;"><i class="icon-ok icon-white"></i><span></span> Return to Manage <?php echo $this->lang->line('entity_cie'); ?> </a><br><br>
                    <?php } else if($ref_id == "ref_29"){ ?>
					  <a type="button" id="import_module" href="<?php echo base_url('assessment_attainment/import_assessment_data/temp_import_template/' . $dept_id . '/' . $prog_id . '/' . $crclm_id . '/' . $term_id . '/' . $crs_id . '/' . $qpd_id . '/' . $ao_id . '/' . $ref_id); ?>" class="btn btn-success pull-right" style="margin-right: 2px;"><i class="icon-upload icon-white"></i> Re-import </a>						

                        <!--close and return to list page - CIA-->
                        <a href="<?php echo base_url('assessment_attainment/import_mte_data/manage_mte_marks/' . $dept_id . '/' . $prog_id . '/' . $crclm_id . '/' . $term_id . '/' . $crs_id.'/'.$section_id); ?>" class="btn btn-primary pull-right" style="margin-right: 2px;"><i class="icon-ok icon-white"></i><span></span> Return to Manage <?php echo $this->lang->line('entity_mte'); ?> </a><br><br>
					
					
				<?php }else { ?>
                        <!--Re-import students marks for TEE-->
                        <a type="button" id="import_module" href="<?php echo base_url('assessment_attainment/import_assessment_data/temp_import_template/' . $dept_id . '/' . $prog_id . '/' . $crclm_id . '/' . $term_id . '/' . $crs_id . '/' . $qpd_id); ?>" class="btn btn-success pull-right" style="margin-right: 2px;"><i class="icon-upload icon-white"></i> Re-import </a>
                        <!--close and return to list page - TEE-->
                        <a href="<?php echo base_url('assessment_attainment/import_assessment_data'); ?>" class="btn btn-primary pull-right" style="margin-right: 2px;"><i class="icon-ok icon-white"></i><span></span> Return to List Page </a><br><br>
                    <?php } ?>
                    ...
                    <div id="drop_main_table_confirmation" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="drop_main_table_confirmation" data-backdrop="static" data-keyboard="false"></br>
                        ...
                        <div class="modal-footer">
                            <?php if ($ref_id == "ref_12") { ?>
                                <button class="btn btn-primary" data-dismiss="modal" onclick="cia_drop_main_table();"><i class="icon-ok icon-white"></i> Ok </button>
                            <?php } else if($ref_id == "ref_29"){?>
								<button class="btn btn-primary" data-dismiss="modal" onclick="mte_drop_main_table();"><i class="icon-ok icon-white"></i> Ok </button>
							<?php }else { ?>
					...
					<div id="inline_msg_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="inline_msg_modal" data-backdrop="static" data-keyboard="true">
						<div class="modal-header">
							<div class="navbar-inner-custom" id="modal_header">Error</div>
						</div>
