<?php
/**
 * Description          :   View for NBA SAR Report - Section 1.1 (TIER 2) - Vision and Mission.
 * Created              :   3-8-2015
 * Author               :    
...
echo $return_string;
?>
<!-- End of file t2ug_c1_1_mission_vision_vw.php 
        Location: .nba_sar/ug/tier2/criterion_1/t2ug_c1_1_mission_vision_vw.php -->