...
foreach ($result as $data) {
    ...
    $table .= "<tr>
                    <td style='text-align:right;'><input name='my_id_data' id='my_id_data' type='hidden' value=" . $data['uload_id'] . ">" . $i . "</td>
                    ...
                    <td onclick = 'delete_file($my_id)' ><input name='save_form_data[]' class='save_form_data cursor_pointer' type='hidden' value=" . $data['uload_id'] . ">
                        <a role='button' class='cursor_pointer delete_file' data-id=" . $data['uload_id'] . " ><center><i class='icon-remove icon-black'></i></center></a></td>
                    </tr>";
}
$table .= '</tbody></table>';
echo $table;
