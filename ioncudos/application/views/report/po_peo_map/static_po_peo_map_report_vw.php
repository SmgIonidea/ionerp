<?php
/** 
* Description	:	Static (read only) List View for PO to PEO Mapped Report Module. 
*					Select Curriculum then its related POs and PEOs and their corresponding 
*					mapping	is displayed in a report format.
                            ...
                            <!--content goes here-->
                                <div class="navbar">
                                    <div class="navbar-inner-custom">
                                        <?php echo $this->lang->line('student_outcomes_full'); ?> <?php echo $this->lang->line('student_outcomes'); ?> to Program Educational Outcomes (PEO) Mapped Report
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    <div class="span12">
