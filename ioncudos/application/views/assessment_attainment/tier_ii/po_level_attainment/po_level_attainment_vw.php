    ...
    <div class="row-fluid">
        ...
        <div class="span10">
            ...
            <section id="contents">
                <div class="bs-docs-example" >
                    ...
                    <form class="form-horizontal" method="POST" id="po_attainment_form" name="po_attainment_form" action="<?php echo base_url('tier_ii/po_level_attainment/export_to_doc'); ?>">
                        <div class="row-fluid">
                        ...
                        <ul id="myTab" class="nav nav-tabs">
                            <li  id= "tab1" class="active toggle_doc_button "><a href="#po_direct_attainment" data-toggle="tab"> Direct Attainment </a></li>
                            <li id = "tab2" class = 'toggle_doc_button'><a href="#extra_curricular_po_direct_report" data-toggle="tab"> Extracurricular / Co-curricular Activity </a></li>
                            <li id = "tab3" class = 'toggle_doc_button'><a href="#po_indirect_attainment" data-toggle="tab"> Indirect Attainment </a></li>
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="po_direct_attainment">
                                ...
                                <p> 
                                <button type="button"  disabled="disabled" id="export_doc" class="export_doc btn-fix btn btn-success pull-right" abbr="0"><i class="icon-book icon-white"></i> Export .doc</button>
                                ...
                                <input type="hidden" name="form_name" id="form_name" value="tier2_po_attainment_form" />
                                ...
                                <div id="course_attainment_no_data" ></div>
                                <div id="po_attainment_chart_2"></div>
                                </br>
                                <div id="po_attainment_graph_data" style="display:none;"></div>
								<div id="image_data" style="display:none;"></div>
                            ...
                            <div class="tab-pane fade" id="po_indirect_attainment">
                                <!--<form  method="POST" target="_blank" id="indirect_attainment_form" name="indirect_attainment_form" class="form-inline"  action="<?php echo base_url('tier_ii/po_level_attainment/export_to_pdf_indirect_attainment'); ?>">-->
                                    <label>
                                ...
                                <div id="finalized_po_data"></div>
                                    ...
                                    <div id="direct_indirect_attain_data">
                                        ...
                                        <table class="table table-bordered"  id="add_more_survey_rows">
                                            ...
                                            <td>
                                            <center>
                                                <select name="survey_title_shv_1" id="survey_title_shv_1"  class='survey_title_shv'>
                            ...
                            <div class="tab-pane fade" id="extra_curricular_po_direct_report">
                                ...
                                <br> 
                                <div style="display: block; position: relative; height: 300px;" class="row-fluid jqplot-target" id="extra_crricular_po_attain_chart">
                ...
                <input type="hidden" id= "po_id" name="po_id" /> <input type="hidden" id= "po_stmt" name="po_stmt" />
            </section>
        ...
        <div id="error_dialog_window" class="modal hide fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="error_dialog_window" data-backdrop="static" data-keyboard="true"></br>
            ...
            <div class="modal-body">
                <p> Make sure that you select all the options before proceeding. </p>
            </div>
        ...
        <div id="finalize_direct_indirect_success" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
            ...
            <div class="modal-body">
                <p>The Overall <?php echo $this->lang->line('student_outcomes_full'); ?> (<?php echo $this->lang->line('sos'); ?>) Attainment are finalized and updated successfully (includes Direct & Indirect Attainment).</p>
            </div>
            <div class="modal-footer">
        ...
        <div id="finalize_direct_indirect_confirmation" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
            ...
            <div class="modal-body">
                <p>Are you sure you want to Finalize the Overall <?php echo $this->lang->line('student_outcomes_full'); ?> (<?php echo $this->lang->line('sos'); ?>) Attainment (includes Direct & Indirect Attainment) for Final Submit to calculate PO Attainment ?</p>
            </div>
            <div class="modal-footer">
                <button type="button" id="finalize_po_attainment" class="finalize_po_attainment btn btn-primary" data-dismiss="modal"><i class="icon-ok icon-white"></i> Ok </button>
...
<script type="text/javascript" src="<?php echo base_url('twitterbootstrap/js/custom/assessment_attainment/tier_ii/po_level_attainment/po_level_attainment.js'); ?>"></script>
