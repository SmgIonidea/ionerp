...
<div class="row-fluid">
    <div class="span12 cl">
        <b>List of equipments in Machine Room :</b>
    </div>
</div>
<table class="table table-bordered table-nba">	
    ...
    <tbody>
        <?php foreach ($machine_room as $ltm) { ?>
            <tr>
...
<!-- End of file t2pharm_c6_3_equipment_in_machine_room_vw.php 
                Location: .nba_sar/pharm/tier2/criterion_6/t2pharm_c6_3_equipment_in_machine_room_vw.php-->