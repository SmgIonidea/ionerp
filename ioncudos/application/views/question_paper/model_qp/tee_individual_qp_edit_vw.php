...
<!--head here -->
    ...
    ================================================== -->
                    <section id="contents">
                        <div class="bs-docs-example fixed-height">
							...
							<form class="form-horizontal" method="POST" id="add_form_id" name="add_form_id" action= "<?php echo base_url('question_paper/manage_model_qp/update_qp_data/5'); ?>">
							  <div class="control-group">
	...
	<script type="text/javascript" src = "<?php echo base_url('twitterbootstrap/js/custom/curriculum/jquery.nailthumb.1.1.js'); ?> "> </script>
		<script src="<?php echo base_url('twitterbootstrap/js/custom/question_paper/tee_individual_qp_edit.js'); ?>" type="text/javascript"> </script>
