...
$(function() {
    $('#view').on('change','#curriculum_list_8_1',function() {
        ...
        if(curriculum){
            $.ajax({
                type:"POST",
                url: base_url + 'nba_sar/t2ug_c8_first_year_academics/display_fysfr_grid',
                async:false,
                data: post_data,
                success: function(msg) {
...
$(function() {
    $('#view').on('change','#curriculum_list_8_2',function() {
        ...
        if(curriculum){
            $.ajax({
                type:"POST",
                url: base_url + 'nba_sar/t2ug_c8_first_year_academics/display_facutly_teaching_fycc',
                async:false,
                data: post_data,
                success: function(msg) {
                    $('#fycc_vw_id').html(msg);
...
$(function() {
    $('#view').on('change','#curriculum_list_8_3',function() {
        ...
        if(curriculum){
            $.ajax({
                type:"POST",
                url: base_url + 'nba_sar/t2ug_c8_first_year_academics/display_fyap',
                async:false,
                data: post_data,
                success: function(msg) {
                    $('#fyap_vw_id').html(msg);
...
//Function is to fetch term list for course assesment method - criterion 8.4.1      
$('#view').on('change','#curriculum_list_c8_4_1', function() {
    ...
    $.ajax({
        type:"POST",
        url: base_url+'nba_sar/t2ug_c8_first_year_academics/get_term_list',
        async: false,
        data: post_data,
        success: function(msg) {
...
//Function is to fetch course list for course assesment method - criterion 8.4.1 
$('#view').on('change','#term_list_c8_4_1', function() {
    ...
    $.ajax({
        type:"POST",
        url: base_url+'nba_sar/t2ug_c8_first_year_academics/get_course_list',
        async:false,
        data: post_data,
        success: function(msg) {
...
//Function is to fetch is to fetch course for Course Assessment - criterion 8.4.1
$('#view').on('click','#generate_8_4_1_assessment_report', function() {
    ...
    if(course_id){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c8_first_year_academics/course_assement_occasions_list',
            async:false,
            data: post_data,
            success: function(msg) {
...
//Function is to clear the loaded details.
function clear_all() {
    $('#nba_qp_div').html('');
...
//Function is to fetch curriculum courses for qp - criterion 8.4.1 
$('#view').on('change','#curriculum_8_4_1', function() {
    ...
    if(curriculum){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c8_first_year_academics/display_curriculum_courses',
            async:false,
            data: post_data,
...
//Function is to fetch course qp for selected course- criterion 8.4.1 
$('#view').on('change','#curriculum_course_examination_8', function() {
    ...
    if(selected_course){
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c2_teachingLearningProcess/display_course_qp',
            async:false,
            data: post_data,
...
//Function is to clear the qp details criterion 8.4.1 
$('#view').on('change', '#course_qp_examination_8', function() {
    clear_all(); 
});

//Function is to fetch qp details of - criterion 8.4.1
$('#view').on('click','#generate_8_4_1_report', function() {
    ...
    if(selected_qp) {
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c2_teachingLearningProcess/generate_model_qp_modal_tee',
            async:false,
            data: post_data,
            success: function(question_paper) {
...
//Function is to fetch term list for rubrics - criterion 8.4.1 
...
//Function is to fetch course list for rubrics - criterion 8.4.1 
...
//Function is to fetch rubrics list for rubrics - criterion 8.4.1 
$('#view').on('change','#course_rubrics_list_8', function() {
    ...
    if(course_id){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c3_co_attainment/get_course_assessment_occasion_list',
            async:false,
            data: post_data,
            success: function(msg) {
                $('#rubrics_list').empty();
...
//Function is to fetch rubrics details - criterion 8.4.1 
$('#view').on('click', '#generate_8_4_1_rubrics_assessment_report', function(e){  
    ...
    if(ao_method_id) {
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c8_first_year_academics/co_attainment_qpd_rubrics',
            async:false,
            data: post_data,
...
//Function is to fetch course list for selected curriculum.
$('#view').on('change','#t1_c8_crclm_list', function() {
    ...
    $.ajax({
        ...
        async:false,
        type:'post',
        url: $('#get_baseurl').val()+"nba_sar/t2ug_c8_first_year_academics/clear_filter",
        success: function(msg){
        }
    });
    $.ajax({
    ...
    if(crclm_id){
        $.ajax({
            url: base_url+"nba_sar/t2ug_c8_first_year_academics/display_crs_grid",
            data: post_data,
            async: false,
            type: 'post',
            success: function(msg){
...
// Function is to select all course check box -SECTION 8.4.2 
$('#view').on('click','.c8_4_2_select_all_course_box',function() {
    ...
    if($('.select_all_chk_'+inc_val).is(':checked')) {
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c8_first_year_academics/co_target_levels',
            async:false,
            data: post_data,
            success: function(msg) {
                $('#co_target_level').empty();
...
//Function is to fetch co target levels - SECTION 8.4.2
...
//Function is to fetch po attainment grid
$('#view').on('change','#c8_5_1_crclm_list_for_po', function() {
    ...
    if(curriculum){    
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c8_first_year_academics/course_wise_po_attainment',
            async:false,
            data: post_data,
            success: function(msg) {
