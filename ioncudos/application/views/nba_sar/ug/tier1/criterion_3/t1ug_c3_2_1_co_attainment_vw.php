<?php
/**
 * Description          :   View for NBA SAR Report - Section 3.2.1 (TIER 1) - Attainment of Course Outcomes
 * Created              :   22-04-2016	
    ...
    <table id="assessment_methods_table" class="table table-bordered table-nba" width="100%">
        <tbody>
            <tr class="orange background-nba">
                <td width="200" class="orange background-nba"><h4  class="h4_margin font_h ul_class" >Sl No.</h4></td>
                <td width="600" class="orange background-nba"><h4  class="h4_margin font_h ul_class" >Assessment Method</h4></td>
            </tr>
            <?php $i = 1;
            foreach ($assessment_methods as $method) { ?>
                <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $method['ao_method_name']; ?></td>
                </tr>
                <?php $i++;
            } ?>
        </tbody>
...
<!-- End of file t1ug_c3_2_co_attainment_vw.php 
        Location: .nba_sar/ug/tier1/criterion_3/t1ug_c3_2_co_attainment_vw.php -->