...
/**
 * Description          :   Controller logic for Criterion 5 (TIER 2) - Faculty Information and Contributions.
 * Created              :   22-12-2016
...
class T2ug_c5_faculty extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('nba_sar/ug/tier2/criterion_5/t2ug_faculty_contribution_model');
    ...
    public function faculty_information_contribution($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_faculty_information_contribution_vw', $this->data, true);
    }
    ...
    public function fetch_faculty_information_contributions($year_id = NULL) {
        if ($year_id == NULL) {
            ...
            $data['faculty_data'] = $this->t2ug_faculty_contribution_model->fetch_faculty_information_contribution($year, $dept_id);
            echo $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_faculty_information_contribution_table_vw', $data, true);
        } else {
            $year = $year_id;
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['faculty_data'] = $this->t2ug_faculty_contribution_model->fetch_faculty_information_contribution($year, $dept_id);
            return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_faculty_information_contribution_table_vw', $data, true);
        }
    }
    ...
    public function student_faculty_ratio($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_1_student_faculty_ratio_vw', $this->data, true);
    }
    ...
    public function fetch_student_faculty_ratio_sfr($curriculum_id = NULL) {
        ...
        if ($curriculum_id == NULL) {
            ...
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $student_faculty_ratio_info = $this->t2ug_faculty_contribution_model->fetch_student_faculty_ratio_sfr($crclm_id, $pgm_id);
    ...
    /*
     * Function to fetch faculty cadre proportion view - Criterion 5.2
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_cadre_proportion($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_2_faculty_cadre_proportion_vw', $this->data, true);
    }
    ...
    public function fetch_faculty_cadre_proportion($curriculum_id = NULL) {
        if ($curriculum_id == NULL) {
            ...
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['faculty_cadre_info'] = $this->t2ug_faculty_contribution_model->fetch_faculty_cadre_proportion($curriculum, $dept_id, $pgm_id);
            echo $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_2_faculty_cadre_proportion_table_vw', $data, true);
        } else {
            $curriculum = $curriculum_id;
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['faculty_cadre_info'] = $this->t2ug_faculty_contribution_model->fetch_faculty_cadre_proportion($curriculum, $dept_id, $pgm_id);
            return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_2_faculty_cadre_proportion_table_vw', $data, true);
        }
    }

    /*
     * Function to fetch  faculty qualification - Criterion 5.3
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_qualification($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_3_faculty_qualification_vw', $this->data, true);
    }

    /*
     * Function to fetch  faculty qualification tabel
     * @parameters  : curriculum id
     * @return      : tabel
     */
    ...
    public function fetch_faculty_qualification($curriculum_id = NULL) {
        ...
        if ($curriculum_id == NULL) {
            ...
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $faculty_qualification_info = $this->t2ug_faculty_contribution_model->fetch_faculty_qualification($curriculum, $dept_id, $pgm_id);
    ...
    /*
     * Function to fetch faculty Retention - Criterion 5.4
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_retention($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_4_faculty_retention_vw', $this->data, true);
    }
    ...
    public function fetch_faculty_retention($curriculum_id = NULL) {
        ...
        if ($curriculum_id == NULL) {
            ...
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $faculty_retention_info = $this->t2ug_faculty_contribution_model->fetch_faculty_retention($curriculum, $dept_id, $pgm_id);
    ...
    /*
     * Function to fetch  faculty innovations - section 5.5
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_innovations() {
        ...
        return $this->load->view('nba_sar/ug/tier1/criterion_5/t2ug_c5_5_faculty_innovations_vw', $this->data, true);
    }

    /*
     * Function to fetch  faculty development - section 5.6
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_development($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_6_faculty_development_vw', $this->data, true);
    }

    /*
     * Function to fetch faculty information contributions table - section 5.6
     * @parameters  : year id
     * @return      : table view
     */
    ...
    public function fetch_faculty_development_training($year_id = NULL) {
        if ($year_id == NULL) {
            ...
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['development_training_data'] = $this->t2ug_faculty_contribution_model->fetch_faculty_development_training($year, $dept_id, $pgm_id);
            echo $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_6_faculty_development_table_vw', $data, true);
        } else {
            $year = $year_id;
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['development_training_data'] = $this->t2ug_faculty_contribution_model->fetch_faculty_development_training($year, $dept_id, $pgm_id);
            return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_6_faculty_development_table_vw', $data, true);
        }
    }

    /*
     * Function to fetch faculty Academic research and development - section 5.7.1
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_academic_development($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        $this->data ['nba_report_id'] = $nba_report_id;
        $dept_id = $this->input->post('dept_id');
        $this->data['academic_research'] = $this->t2ug_faculty_contribution_model->fetch_academic_research($dept_id);
        $this->data ['is_export'] = $is_export;
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_7_1_faculty_academic_development_vw', $this->data, true);
    }

    /*
     * Function to fetch  faculty Academic book published - section 5.7.2
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_academic_book_published($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        $this->data ['nba_report_id'] = $nba_report_id;
        $dept_id = $this->input->post('dept_id');
        $this->data['academic_research'] = $this->t2ug_faculty_contribution_model->fetch_academic_book_published($dept_id);
        $this->data ['is_export'] = $is_export;
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_7_1_faculty_academic_book_published_vw', $this->data, true);
    }

    /*
     * Function to fetch faculty Academic PHD details - section 5.7.3
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_academic_PHD_details($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        $this->data ['nba_report_id'] = $nba_report_id;
        $dept_id = $this->input->post('dept_id');
        $this->data['academic_research'] = $this->t2ug_faculty_contribution_model->fetch_academic_PHD_details($dept_id);
        $this->data ['is_export'] = $is_export;
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_7_1_faculty_academic_phd_details_vw', $this->data, true);
    }

    /*
     * Function to fetch faculty Academic research and development - section 5.7.2
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_sponsored_research($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        $this->data ['nba_report_id'] = $nba_report_id;
        $dept_id = $this->input->post('dept_id');
        $this->data['sponsored_research'] = $this->t2ug_faculty_contribution_model->fetch_sponsored_research($dept_id);
        $this->data ['is_export'] = $is_export;
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_7_2_faculty_sponsored_research_vw', $this->data, true);
    }

    /*
     * Function to fetch  faculty development activities - section 5.7.3
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_development_activities() {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_7_3_faculty_development_activities_vw', $this->data, true);
    }

    /*
     * Function to fetch  faculty consultancy - section 5.7.4
     * @parameters  :
     * @return      : view
     */
    ...
    public function faculty_consultancy($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        $this->data ['nba_report_id'] = $nba_report_id;
        $dept_id = $this->input->post('dept_id');
        $this->data['consultancy_projects'] = $this->t2ug_faculty_contribution_model->fetch_consultancy_projects($dept_id);
        $this->data ['is_export'] = $is_export;
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_7_4_faculty_consultancy_vw', $this->data, true);
    }

    /*
     * Function to fetch  faculty performance appraisal - section 5.8
     * @parameters:
     * @return:
     */
    ...
    public function faculty_performance_appraisal($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_8_faculty_performance_appraisal_vw', $this->data, true);
    }

    /*
     * Function to fetch faculty performance appraisal table - section 5.8
     * @parameters  : year id
     * @return      : table view
     */
    ...
    public function fetch_faculty_performance_appraisal($year_id = NULL) {
        if ($year_id == NULL) {
            ...
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['performance_appraisal_data'] = $this->t2ug_faculty_contribution_model->fetch_faculty_performance_appraisal($year, $dept_id);
            echo $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_8_faculty_performance_appraisal_table_vw', $data, true);
        } else {
            $year = $year_id;
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['performance_appraisal_data'] = $this->t2ug_faculty_contribution_model->fetch_faculty_performance_appraisal($year, $dept_id);
            return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_8_faculty_performance_appraisal_table_vw', $data, true);
        }
    }
    ...
    public function faculty_adjunct($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_9_faculty_adjunct_vw', $this->data, true);
    }

    /*
     * Function to fetch faculty information contributions table - section 5.9
     * @parameters  : year id
     * @return      : table view
     */
    ...
    public function fetch_faculty_adjunct($year_id = NULL) {
        if ($year_id == NULL) {
            ...
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['adjunct_data'] = $this->t2ug_faculty_contribution_model->fetch_faculty_adjunct($year, $dept_id);
            echo $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_9_faculty_adjunct_table_vw', $data, true);
        } else {
            $year = $year_id;
            $dept_id = $this->input->post('dept_id');
            $pgm_id = $this->input->post('pgm_id');
            $data['adjunct_data'] = $this->t2ug_faculty_contribution_model->fetch_faculty_adjunct($year, $dept_id);
            return $this->load->view('nba_sar/ug/tier2/criterion_5/t2ug_c5_9_faculty_adjunct_table_vw', $data, true);
        }
    }
...
/*
 * End of file t2ug_c5_faculty.php 
 * Location: .nba_sar/t2ug_c5_faculty.php
 */
?>