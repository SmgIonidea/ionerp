<div class="pull-right" id="create_button_div"><a class="btn btn-primary btn-sm" href="<?=APP_BASE?>products/products/create">Create</a></div>
<div class="row-fluid">
                <div class="col-sm-12 table-responsive no-pad">
                <?= generate_gird($grid_config, "products_list")?>
                    </div>
...
$(document).on('click','.delete-record',function(e){
                    ...
                    BootstrapDialog.show({
                        ...
                        buttons: [{
                                ...
                                action: function (dialog) {
                                    $.ajax({
                                        url: '<?=APP_BASE?>products/products/delete',
                                        method: 'POST',
                                        data: data,
