            ...
            <section id="contents">
                ...
                <div class="bs-docs-example">
                    ...
                    <div class="navbar">
                        <div class="navbar-inner-custom">
							<?php if($ref_id == "ref_12") { ?>
								<?php echo $this->lang->line('entity_cie_full'); ?> Tier-II Consolidated Assessment Data Import Details
							<?php } else { ?>
								<?php echo $this->lang->line('entity_see_full'); ?> Tier-II Consolidated Assessment Data Import Details
							<?php } ?>
                        </div>
                    </div>
                    ...
                    if (!empty($course_marks)) :
                        ...
                        <div class="span3">
                        <table class="table table-bordered table-hover" id="student_table_imported_data">
                            <thead>
                                <tr>
                                    <th><b>Student USN</b></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $student['student_usn']; ?></td>
                        ...
                        <table class="table table-bordered table-hover" id="table_imported_data">
                            <thead>
                                <tr>
                                    ...
                                    <?php if($header != 'student_usn' && $header != 'student_name') { ?>
                                    <th>
                                        <center>                                            
                                            <?php  
                                            ...
                                            //echo strtoupper(str_replace("_", " ",str_replace("Q_No_", "", $header)));//strtoupper(str_replace("_", " ",str_replace("Q_No_", "", $header)));
                                            
                                            if(stripos($header, '_qpdid_') == FALSE) {
                                                echo strtoupper(str_replace("_", " ",str_replace("Q_No_", "", $header)));
                                            } else {
                                                echo strtoupper(str_replace("_", " ",str_replace("Q_No_", "", substr($header, 0, strpos($header, "_qpdid_")))));//strtoupper(str_replace("_", " ",str_replace("Q_No_", "", $header)));
                                            }
                                            ?>
                                        </center>
                                    </th>
                                ...
                                <?php foreach ($course_marks as $marks) : ?>
                                    <tr>
                                        ...
                                        foreach ($marks as $key => $value) : 
                                            if($key != 'student_name' && $key!= 'student_usn') {
                                            $val = '-';
                                            $ass_id = '';
