                  ...
                  <?php  } ?>
                   ...
                   <?php }else{ ?> 
                    ...
                    <div id="edit_button_div" class="pull-right">
                        ...
                        <a class="btn btn-danger" id="cancel_criteria" href="<?php echo base_url('question_paper/tee_qp_list'); ?>"><i class="icon-remove icon-white"></i> Close  </a> 
    ...
    <!-- Finalize Rubrics Confirmation Modal message -->
     <div id="finalize_modal_confirmation" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="check_framework" data-backdrop="static" data-keyboard="true">
        ...
        <div class="modal-body">
            ...
            <p>Finalized rubrics will be available under <?php echo $this->lang->line('entity_see'); ?>  assessment import.</p>  
        </div>
        <div id ="modal_footer" class="modal-footer">
...
<script type="text/javascript" src="<?php echo base_url('twitterbootstrap/js/custom/question_paper/tee_rubrics/tee_rubrics.js'); ?>"></script>
