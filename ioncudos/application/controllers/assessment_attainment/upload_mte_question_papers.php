...
class Upload_mte_question_papers extends CI_Controller {
                    ...
                    if ($xl_crs_code != 'CODE') {
                      ...
                      //  var_dump($exls_data);
                        if ($data['crs_code'] == $xl_crs_code) {
                            ...
                            $check = isset($actual_data['questions'][0]['']['question']);
                        ...
                        $data['result'] = '<b>Invalid File Format.</b>';
                    }
//            }else{
//                
...
//            }
        ...
        $this->load->view('assessment_attainment/upload_question_papers/upload_mte_qp_vw', $data);
    }
