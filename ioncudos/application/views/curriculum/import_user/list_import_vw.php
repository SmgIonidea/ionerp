        ...
        <section id="contents">
            ...
            <div class="bs-docs-example">
                    ...
                    <table class="table table-bordered table-hover" id="example" aria-describedby="example_info">
                        <thead>
                            <tr role="row">
								...
								<th class="header headerSortDown span2" role="columnheader" tabindex="0" aria-controls="example" aria-sort="ascending" >FirstName</th>
                                <th  class="header headerSortDown span2" role="columnheader" tabindex="0" aria-controls="example" aria-sort="ascending" >LastName</th>
                        ...
                        <tbody role="alert" aria-live="polite" aria-relevant="all">
							...
							?>
								<tr><td><?php echo $i++ ?></td><td><?php echo $data['title'].' '.ucfirst($data['first_name']) ?></td><td><?php echo ucfirst($data['last_name']) ?></td><td><?php echo ucfirst($data['dept_acronym']) ?></td><td><?php echo ucfirst($data['designation_name']) ?></td><td><?php echo $data['email'] ?></td>
								<!-- <td><a href=""  id="edit_user_id" class="edit_user icon-pencil" rel="tooltip" title="Manage Role" value="<?php echo $data['id'] ?>"></a></td> -->
								<td>Course Owner</td>
								<td><a href=""  id="delete_user_id" class="delete_user icon-remove" rel="tooltip" title="Remove User" value="<?php echo $data['id'] ?>"></a></td></tr>
							<?php
								}
								}
							?>
				...
				<div class="row-fluid">
					<div class="span12">				
						...
						<div class="span6">					
							...
							</select>&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="user_email_div" class="color_maroon"></span></b>
						</div>
					</div>
				</div>
				...
				<div class="pull-right"><br>
					<button class="import_user_form_submit btn btn-primary" type="submit"><i class="icon-file icon-white"></i><span></span> Save </button>
					<button class="clear_all btn btn-info" type="reset" id="reset"><i class="icon-refresh icon-white"></i><span></span> Reset </button>
				</div><br><br><br>
				</form>
            </div>
		</div>
