                        ...
                        <div class="bs-docs-example fixed-height">
                            ...
                            <form  class="form-horizontal" method="POST" id="form1" name="form1" action= "">
                                <div class="control-group">
                                    <p class="control-label" for="unit_name">Duration:<font color="red">*</font></p>
                                    <div class="controls">
                                        <?php echo form_input($unit_name); ?>
                                    </div>
                                </div>
								<div class="control-group">
                                    <p class="control-label" for="unit_description">Description:</p>
                                    <div class="controls">
                            ...
                            <a href= "<?php echo base_url('configuration/unit'); ?>"><b class="btn btn-danger"><i class="icon-remove icon-white"></i><span></span> Cancel</b></a>
                        </div>
                        <br><br><br>
