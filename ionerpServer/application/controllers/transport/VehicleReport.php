...
class VehicleReport extends CI_Controller {
    
    public function __construct() {
        parent::__construct();
        $this->load->model('transport/VehicleReport_model');
    ...
    public function getVehicleReportList(){
        ...
        $vehicleName = $this->VehicleReport_model->getVehicleReportList($formData);
