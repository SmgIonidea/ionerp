...
$(function(){
    ...
    $('#view').on('change','#curriculum_2_2_2', function() {
        ...
        if(curriculum){
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t1ug_c2_teachingLearningProcess/display_curriculum_courses',
                async:false,
                data: post_data,
    ...
    $('#view').on('click','#generate_2_2_2_report', function() {
        ...
        if(selected_qp) {
            ...
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t1ug_c2_teachingLearningProcess/course_co_planned_coverage',
                async:false,
                data: post_data,
            ...
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t1ug_c2_teachingLearningProcess/course_bloom_level_marks_distribution',
                async:false,
                data: post_data,
            ...
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t1ug_c2_teachingLearningProcess/create_graph_image',
                async:false,
                data: post_data,
    ...
    $('#view').on('change','#curriculum_2_2_3_list', function() { 
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c2_teachingLearningProcess/get_term_list',
            async:false,
            data: post_data,
            success: function(msg) {
    ...
    $('#view').on('change','#term_2_2_3_list', function() {
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c2_teachingLearningProcess/get_course_list',
            async:false,
            data: post_data,
            success: function(msg) {
    ...
    $('#view').on('click','#generate_2_2_3_report', function() {
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c2_teachingLearningProcess/get_quality_student_project',
            async:false,
            data: post_data,
            dataType: 'json',
    ...
    $('#view').on('change','#curriculum_2_2_5', function() {
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c2_teachingLearningProcess/display_industry_internship',
            async:false,
            data: post_data,
            dataType: 'json',
            success: function(msg) {
