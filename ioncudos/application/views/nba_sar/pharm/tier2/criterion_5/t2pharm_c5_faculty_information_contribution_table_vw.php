<?php
/**
 * Description          :   View for NBA SAR Report - Section 5(Pharmacy TIER 2) - faculty information and contribution
 * Created              :   21-06-2017
...
<table class="table table-bordered table-nba span12" style="overflow:auto;">
    ...
    <tr>
        ...
        <td class="orange background-nba"><h4 class="h4_margin font_h ul_class">UG</h4></td>
        <td class="orange background-nba"><h4 class="h4_margin font_h ul_class">PG</h4></td> 
        <td class="orange background-nba"><h4 class="h4_margin font_h ul_class">Diploma</h4></td> 
    ...
    <?php foreach ($faculty_data as $data) { ?>
        <tr>
            ...
            <td><?php echo nl2br($data['UG']); ?></td>
            <td><?php echo nl2br($data['PG']); ?></td>		
            <td><?php echo nl2br($data['Diploma']); ?></td>
...
<!-- End of file t2pharm_c5_faculty_information_contribution_table_vw.php 
        Location: .nba_sar/pharm/tier2/criterion_4/t2pharm_c5_faculty_information_contribution_table_vw.php -->