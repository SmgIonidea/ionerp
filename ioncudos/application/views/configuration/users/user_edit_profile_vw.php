                        ...
                        <div class="bs-docs-example">
					     ...
					     <div class="row-fluid"><br>
					      <div class="span6">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="qualification"> Qualification: <font color='red'> * </font></label>
                                <div class="controls">
							...
							<div class="control-group">
                                <label class="control-label" for="experience"> Experience(In Years): <font color='red'> * </font></label>
                                <div class="controls">
					      ...
					      <div class="span6">
							...
							<div class="control-group">
                                <label class="control-label" for="usergroup_id"> User Group: <font color='red'> * </font></label>
                                <div class="controls">
                                    <?php
                                    foreach ($group as $list_item_group) {
                                        $select_options_group[$list_item_group['id']] = $list_item_group['name'];
                                    }
                                    echo form_multiselect('usergroup_id[]', $select_options_group, $selected_group,'disabled = "disabled"');
                                    ?>
                                </div>
                            </div>							
							...
							<div class="pull-right">
                                ...
                                <a href="<?php echo base_url('configuration/users/list_users'); ?>" style="margin-left: 10px;" class="btn btn-danger dropdown-toggle"><i class="icon-remove icon-white"></i><span></span> Cancel </a>
                            </div><br/><br/>
                            <?php echo form_close(); ?>
