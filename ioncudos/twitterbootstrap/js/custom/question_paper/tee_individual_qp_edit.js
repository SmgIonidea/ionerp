...
//alert(base_url);
//var replaced_data = url_data.replace(base_url+'question_paper/manage_model_qp/tee_individual_qp_edit/','');
var replaced_data = url_data.replace(base_url+'question_paper/manage_model_qp/forcible_tee_qp_edit/','');
        ...
        success: function(json_graph_data) {
			if (json_graph_data.length > 0) {
				...
				var plot2 = jQuery.jqplot('chart3', [items1],
					...
					$('#coplannedcoveragesdistribution > tbody:first').append('<tr><td><center><b>CO Level</b></center></td><td><center><b>Total Marks</b></center></td><td><center><b>% Distribution</b></center></td></tr>');
					$.each(json_graph_data, function(){
