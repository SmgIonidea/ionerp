...
$('#add_form_submit').click(function () {
    ...
    if (flag) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'configuration/companies_visited/insert_company_data',
            data: post_data,
            datatype: "json",
...
$('#edit_form_submit').click(function () {
    ...
    if (flag) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'configuration/companies_visited/update_company_data',
            data: post_data,
            datatype: "json",
            success: function (data) {
                list_companies_details();
...
function delete_check(delete_company_id) {
    $("#delete_id").val(delete_company_id);
    $("#loading").show();
    var post_data = {
    ...
    $.ajax({
        type: "POST",
        url: base_url + 'configuration/companies_visited/company_details_delete_check',
        data: post_data,
        datatype: "json",
        success: function (data) {
            if (data == 1) {
...
$('#delete_selected').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: base_url + 'configuration/companies_visited/company_details_delete',
        data: post_data,
        datatype: "json",
        success: function (data) {
            list_companies_details();
...
function list_companies_details() {
    ...
    $.ajax({
        type: "POST",
        url: base_url + 'configuration/companies_visited/list_companies_details',
        dataType: 'json',
        success: function (data) {
            populateTable(data);
            $("#loading").hide();
...
$('#companies_data').on('click', '.upload_file', function (e) {
    ...
    upclick({
        ...
        action: base_url + 'configuration/companies_visited/upload',
...
function display_upload_modal() {
    ...
    $.ajax({type: 'POST',
        url: base_url + 'configuration/companies_visited/fetch_files',
        data: post_data,
        success: function (data) {
...
$('#delete_file').click(function (e) {
    ...
    $.ajax({
        type: "POST",
        url: base_url + 'configuration/companies_visited/delete_file',
        data: {
            'upload_id': delete_id
        },
        success: function (data) {
...
$('#upload_form').on('submit', function (e) {
    ...
    if (form_val.length > 0) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'configuration/companies_visited/save_data',
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
...
$('#companies_data').on('click', '.view_details', function (e) {
    ...
    $.ajax({type: 'POST',
        url: base_url + 'configuration/companies_visited/stud_intake_details',
        data: post_data,
        success: function (data) {
