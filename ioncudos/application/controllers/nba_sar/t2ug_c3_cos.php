...
/**
 * Description          :	Controller logic for Criterion 3 (3.1) (TIER 2) - Correlation between the courses and the PO and PSO.
 * Created              :	04-04-2017
...
class T2ug_c3_cos extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('nba_sar/ug/tier2/criterion_3/t2ug_c3_cos_model');
    ...
    public function co($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            ...
            return $this->load->view('nba_sar/ug/tier2/criterion_3/t2ug_c3_1_1_cos_vw', $this->data, true);
        }
    }
    ...
    public function display_co($curriculum_id = '', $crs_list = array(), $nba_sar_view_id = '', $nba_report_id = '', $param='') {
        ...
        $clo_detail = $this->nba_sar_list_model->display_course_list($curriculum,2);
        $this->data ['clo_detail'] = $clo_detail;
        $this->data ['crs_list'] = $crs_list;
        $content_view = $this->load->view('nba_sar/ug/tier2/criterion_3/t2ug_c3_1_1_cos_contents_vw', $this->data, true);
    ...
    public function display_clo($curriculum = '', $nba_sar_view_id = '', $nba_report_id = '') {
        if (empty($curriculum)) {
            ...
            $clo_detail = $this->t2ug_c3_cos_model->get_clo($curriculum_id, '', '', 0, $crs_list);
        } else {
            $clo_detail = $this->t2ug_c3_cos_model->get_clo($curriculum, $nba_sar_view_id, $nba_report_id);
        }

        $this->data['clo_detail'] = $clo_detail;
        $content['clo_view'] = $this->load->view('nba_sar/ug/tier2/criterion_3/t2ug_c3_1_1_clo_contents_vw', $this->data, true);
    ...
    public function co_po($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        $data_without_pso = $this->t2ug_c3_cos_model->clo_po_mapping($param, 0);
        $this->data['without_pso'] = $this->load->view('nba_sar/ug/tier2/criterion_3/t2ug_c3_1_2_co_po_contents_vw', $data_without_pso, true);
        $data_with_pso = $this->t2ug_c3_cos_model->clo_po_mapping($param, 1);
        $this->data['with_pso'] = $this->load->view('nba_sar/ug/tier2/criterion_3/t2ug_c3_1_2_co_po_contents_vw', $data_with_pso, true);

        if ($is_export) {
            return $this->data['without_pso'] . $this->data['with_pso'];
        } else {
            return $this->load->view('nba_sar/ug/tier2/criterion_3/t2ug_c3_1_2_co_po_vw', $this->data, true);
        }
    }
    ...
    public function course_po($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            ...
            return $this->load->view('nba_sar/ug/tier2/criterion_3/t2ug_c3_1_3_course_po_vw', $this->data, true);
        }
    }
    ...
    public function display_course_po($curriculum_id = '') {
        ...
        $data_course_po = $this->t2ug_c3_cos_model->course_po_mapping($curriculum);

        if (!empty($data_course_po)) {
            $data['course_po'] = $this->load->view('nba_sar/ug/tier2/criterion_3/t2ug_c3_1_3_course_po_contents_vw', $data_course_po, true);
        } else {
            $data['course_po'] = '';
        }
...
/*
 * End of file t2ug_c3_cos.php
 * Location: .nba_sar/t2ug_c3_cos.php 
 */
?>