...
/**
 * Description          :   View for NBA SAR Report - Criterion 4 (Diploma TIER 2) - Students' Performance tables
 * Created              :   06-06-2017
...
$return_string = '<table class="table table-bordered table-nba" id="table_nba">
                    <tr>
                        <td class="orange background-nba" width="800">
                                <center><h4 class="font_h ul_class">Item</h4></center>
                        </td>
...
$return_string.= '<table class="table table-bordered table-nba" id="table_nba_without_backlogs">
                    <tr>
                        ...
                        <td class="orange background-nba" colspan="3" gridspan=4 width="800"><center><h4 class="font_h ul_class"><br>Number of students who have successfully<br>passed <b> without backlogs </b> in any year of study</h4></center></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
...
foreach ($section_2 as $data) {
    $return_string.= '<tr><td>' . $data['year'] . '</td><td>' . $data['total_students'] . '</td><td>' . $data['year1'] . '</td><td>' . $data['year2'] . '</td><td>' . $data['year3'] . '</td></tr>';
}
...
$return_string.= '<table class="table table-bordered table-nba" id="table_nba_students_graduated">
                    <tr>
                        ...
                        <td class="orange background-nba" width="200"><center><h4 class="font_h ul_class"><br>N1 + N2 + N3<br>(As defined above)</h4></center></td>
                        <td class="orange background-nba" colspan="4" gridspan=4 width="800"><center><h4 class="font_h ul_class"><br>Number of students who have successfully<br>graduated</h4></center></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
...
echo $return_string;
/*
 * End of file t2dip_c4_student_performance_table_vw.php 
 * Location: .nba_sar/dip/tier2/criterion_4/t2dip_c4_student_performance_table_vw.php
 */
?>