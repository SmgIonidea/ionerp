<?php
/**
* Description	:	Add View for User Designation Module.
* Created		:	03-04-2013. 
    ...
    ================================================== -->
                    <section id="contents">
                        <div class="bs-docs-example fixed-height">
                            ...
                            <form  class="form-horizontal" method="POST" id="add_form_id" name="add_form_id" action= "<?php echo base_url('configuration/user_designation/designation_insert_record'); ?>">
                                ...
                                <div class="pull-right">       
                                    <button class="submit_add_form btn btn-primary" type="submit"><i class="icon-file icon-white"></i> Save</button>
