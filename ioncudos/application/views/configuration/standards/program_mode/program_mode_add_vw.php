<?php
/**
* Description	:	Add View for Program Mode Module.
* Created		:	03-04-2013. 
    ...
    ================================================== -->
                    <section id="contents">
                        <div class="bs-docs-example fixed-height">
                            ...
                            <form  class="form-horizontal" method="POST" id="add_form_id" name="add_form_id" action= "<?php echo base_url('configuration/program_mode/program_mode_insert_record'); ?>">
                                ...
                                <!--####################################################-->
                                <!--Checkbox Modal-->
                                <div id="uniqueness_dialog" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="uniqueness_dialog" data-backdrop="static" data-keyboard="true">
                                    </br>
                                    <div class="container-fluid">
                                        <div class="navbar">
                                            <div class="navbar-inner-custom">
                                ...
                                <div class="pull-right">       
									...
									<a href= "<?php echo base_url('configuration/program_mode');?>" class="btn btn-danger"><i class="icon-remove icon-white"></i><span></span> Cancel</a>
								</div> <br><br><br>
