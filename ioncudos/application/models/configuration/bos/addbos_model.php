 ...
 *
 */
class addbos_model extends CI_Model {
    ...
    public function has_permission($group_list, $permission_name) {
        ...
        $query = 'SELECT permission_id
					...
					WHERE usergroup_id
					IN ( $group_list)
					AND permission_id = (	SELECT permission_id
											FROM permission
											WHERE permission_function = "'.$permission_name.'") ';
        $query_result = $this->db->query($query);
        return ($query_result->num_rows() > 0) ? TRUE : FALSE;
    }
	...
	*/     
	function designation_list() {
        ...
        return $this->db->select('designation_id, designation_name')->get('user_designation')->result_array();
    }
	...
	*/    
	function edit_default_department($id) {
        return $this->db
					->select('bos_dept_id')
					->where('bos_user_id', $id)
					->get('bos')->row_array();
    }
	...
	*/    
	...
	/* Function is to fetch BOS users ids from BOS table.
	* @param - 
	...
	*/
    public function update_bos($bos_dept_id, $uid) {
        $this->db->where('bos_user_id', $uid)
