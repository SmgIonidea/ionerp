...
import { MyRouteDetailsComponent } from './transport/my-route-details/my-route-details.component';
import { AllRouteBoardComponent } from './transport/all-route-board/all-route-board.component'
...
const route: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'routeDetails',
        component: MyRouteDetailsComponent,
        pathMatch: 'full',
        canActivate: [RoleGuard],
      ...
      {
        path: 'allRouteBoard',
        component: AllRouteBoardComponent,
        pathMatch: 'full',
        canActivate: [RoleGuard],
        data: { isAdmin:true,isChairman:false,isProgramOwner:false,isCourseOwner:false,isStudent:true },
        outlet: 'appCommon',
