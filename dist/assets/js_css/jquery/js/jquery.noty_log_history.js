...
(function($) {
  ...
  $.noty.stopConsumeAlert = function(){
	...
	$.noty.defaultOptions = {
		...
		buttons: true,
		modal: true,
		template: '<div class="noty_message"><span class="noty_text"></span><span class="log_history_hide"><input title = "Check : Prevent to show the log history. &#013;UnCheck : Show the log history. " id="log_history_dissable" name="log_history_dissable" type="checkbox"/>&nbsp;&nbsp;Don\'t show this log history again &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/><br/></span> <div class="noty_close"></div></div>',
		cssPrefix: 'noty_',
		custom: {
			container: null
		}
