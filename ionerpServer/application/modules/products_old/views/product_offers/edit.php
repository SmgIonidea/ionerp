...
$form_action= "/products/product_offers/edit";
...
"required"=>"", 
"type"=>"hidden", 
"value" => (isset($data["offer_id"]))?$data["offer_id"]:""
); 
echo form_error("offer_id"); echo form_input($attribute); ?><div class = 'form-group row'>
