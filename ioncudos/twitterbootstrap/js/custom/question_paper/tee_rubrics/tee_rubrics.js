...
$('#generate_scale').on('click',function(){
    ...
    $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/generate_scale',
            data: post_data,
            dataType:'html',
...
$('#button_div').on('click','#save_rubrics',function(){
    ...
    $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/save_criteria_details',
            data: post_data,
            dataType:'JSON',
            success: function(msg) {
                if($.trim(msg.message) == 'true'){
                    ...
                    var options = $.parseJSON(data_options);
                    noty(options); 
                    window.location = base_url + 'question_paper/tee_rubrics/tee_rubrics_edit_data/'+pgm_id+'/'+crclm_id+'/'+term_id+'/'+crs_id+'/'+qp_type+'/'+msg.qpd_id+'/'+msg.ao_method_id;
                }else{
...
$('#edit_button_div').on('click','#edit_save_rubrics',function(){
  ...
  //  glob_pgm_id = pgm_id;
    ...
    $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/edit_save_criteria_details',
            data: post_data,
            dataType:'JSON',
            success: function(msg) {
                console.log(msg)
...
$('.rubrics_type_val').on('click',function(){
  ...
  //  var ao_id = $('#ao_id').val();
    ...
    $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/get_rubrics_type_details',
            data: post_data,
            dataType:'html',
            success: function(msg) {
                $('#criteria_id').empty();
...
$('.edit_criteria').live('click',function(){
   ...
   $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/edit_rubrics_criteria',
            data: post_data,
            dataType:'html',
            success: function(msg) {
               $('#assessment_scale').empty();
...
$('#updata_criteria').on('click',function(){
   ...
   // var ao_type_id = $('#ao_type_id').val();
    ...
    $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/update_rubrics_criteria',
            data: post_data,
            dataType:'html',
            success: function(msg) {
               if($.trim(msg) == 'true'){
...
$('#gernerate_qp_button_div').on('click','#generate_qp',function(){
    ...
    $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/check_tee_rubrics_rollout',
            data: post_data,
            dataType:'json',
            success: function(msg) {
                console.log(msg)
...
function finalizing_rubrics_data(){
  ...
  //  var ao_id = $('#ao_id').val();
   // var ao_type_id = $('#ao_type_id').val();
    ...
    $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/generate_question_paper',
            data: post_data,
            dataType:'html',
            success: function(msg) {
                if($.trim(msg)=='true'){
...
$('#force_editing_critiria').on('click',function(){
   ...
   $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/delete_qp_force_insert_criteria',
            data: post_data,
            dataType:'html',
            success: function(msg) {
                if($.trim(msg)=='true'){
...
$('#regenerate_rubrics_scale').on('click',function(){
   ...
   // var ao_type_id = $('#ao_type_id').val();
    ...
    var post_data = {
     ...
     $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/regenerate_rubrics_scale',
            data: post_data,
            dataType:'html',
            success: function(msg) {
                console.log(msg);
...
$('#delete_criteria_modal').on('click','#delete_criteria_data',function(){
   ...
   $.ajax({type: "POST",
            url: base_url + 'question_paper/tee_rubrics/delete_criteria',
            data: post_data,
            dataType:'JSON',
            success: function(msg) {
                if($.trim(msg.message) == 'true'){
