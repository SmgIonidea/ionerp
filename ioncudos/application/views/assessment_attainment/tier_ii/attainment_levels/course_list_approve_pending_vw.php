...
<div class="pull-right" id="send_for_approve_div">
    <button type="button" class=" btn btn-success send_for_approve" id="send_for_approve" disabled="disabled"><i class="icon-user icon-white"></i> Send for Approval </button>
</div>
<br>
		...
		<tbody>
			<?php
				...
				<tr>
					...
					<td><center><a href="#myModal_edit_indirect_crs" id="<?php echo $data['alp_id']; ?>" class="edit_indirect_crs_al" data-toggle="modal" data-original-title="Edit" rel="tooltip" title="Cannot Edit as it is in Approval pending status"><i class="icon-pencil"></i></a></td>
				</tr>
			<?php }//end of foreach
				echo "<input type='hidden' name='alp_count' id='alp_count' value='".$i."' />";
			?>
