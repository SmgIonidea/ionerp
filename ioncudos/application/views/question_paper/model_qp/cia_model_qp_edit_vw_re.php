        ...
        <div class="span12">
            ...
            <div class="bs-docs-example ">
                <div ><b>Curriculum : <font color="#004b99"><?php echo $crclm_title; ?> </font>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;Course :<font color="#004b99"> <?php echo $course_title[0]['crs_title'] . "[" . $course_title[0]['crs_code'] . "]"; ?></font>
                        &nbsp;&nbsp;&nbsp;&nbsp;Assessment Occassion Name :<font color="#004b99"> <?php echo $course_title[0]['crs_title'] . "[" . $occassion_name[0]['ao_description'] . "]"; ?></font></b><br/></div>
            </div>
            ...
            <section id="contents">
                <div class="bs-docs-example ">
                    <!--content goes here-->
                    <a class="brand-custom" href= "<?php echo base_url('question_paper/manage_cia_qp'); ?>" id="cancel_button"><span class="btn btn-danger pull-right"><i class="icon-remove icon-white"></i><span></span> Close</span></a>
                    <div class="menu">
                        <div class="accordion">
                                ...
                                <div class="brand-custom">
                                    <a class="brand-custom cursor_pointer" data-toggle="collapse" href="#collapse1" style="text-decoration:none;">
                                        <h5><b>&nbsp;<i class="icon-chevron-down icon-black"  data-toggle="collapse" > </i>
                                                <?php echo "Edit " . $this->lang->line('entity_cie') . " Framework"; ?></b></h5>
                                    </a>
                            ...
                            <div id="collapse1" class="panel-collapse collapse">
                                <form class="form-horizontal" method="POST" id="add_form_id" name="add_form_id" action= "">
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            ...
                                            <div class="span3">
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="">Total Duration (H:M)<font color="red"><b>*</b></font>:</label>
                                                    <div class="controls">
                                                        <input type="text" id="total_duration" name="total_duration" class="text_align_right allownumericwithoutdecimal input-mini required total_duration" placeholder="In hrs" value="<?php echo $meta_data[0]['qpd_timing']; ?>"  >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="span4">
                                                <div class="control-group">
                                                    ...
                                                    <div class="">
                                                        Course: &nbsp;&nbsp;&nbsp;<input readonly class="required course_name" type="text" id="course_name" name="course_name" value="<?php echo $course_title[0]['crs_title'] . '  -  (' . $course_title[0]['crs_code'] . ')' ?>" style="width:265px;"  />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="span2">
                                                <div class="control-group">                                      
                                                    <div class="">
                                                        Maximum Marks<font color="red"><b>*</b></font> :
                                                        <input type="text" id="max_marks" name="max_marks" class="text_align_right input-mini required max_marks  allownumericwithoutdecimal numeric" placeholder="Max Marks" value ="<?php echo $meta_data[0]['qpd_max_marks']; ?>"  />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="span2">
                                                <div class="control-group">                                      
                                                    <div class="">
                                                        Grand Total <font class="font_color">*</font> :
                                                        <input type="text" id="Grand_total" name="Grand_total" placeholder="Grand Total" class="text_align_right allownumericwithoutdecimal input-mini required max_marks" value="<?php echo $meta_data[0]['qpd_gt_marks']; ?>"  />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="span1">
                                                <div class="control-group">                                     
                                                    <div class="">	<!---->										
                                                        Model QP: <?php if ($meta_data[0]['cia_model_qp'] == 1) { ?>
                                                            <input style="margin-top:0px;" type="checkbox" name="Model" id="Model" class="mandatory" title="Model Question Paper" style="margin:0px;" checked />
                                                        <?php } else { ?>
                                                            <input style="margin-top:0px;" type="checkbox" name="Model" id="Model" class="mandatory" title="Model Question Paper" style="margin:0px;" />
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                            </div> 
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <button type="button" name="save_header" id="save_header" class="btn btn-primary pull-right"><i class="icon-file icon-white"></i><span></span> Save</button>
                        ...
                        <!--<a role="button" type="button" onclick="toggle_visibility('Edit_FM');"  id="toggle_FM" class="btn btn-primary" ><i class="icon-pencil icon-white"></i> Edit Framework</a>-->
                                                        ...
                                                        foreach ($unit_data as $topic) {
                                                            ...
                                                            <tr  data-toggle="collapse"><td><?php echo $i; ?></td>
                                                                <td><input type="text" id="unitd_id" name="unitd_id[]" class="input-mini required max_marks" value="<?php echo $topic['qp_unit_code']; ?>"/>
                                                                    <input type="hidden" id="unitd_id_one" name="unitd_id_one[]" class="input-mini required" value="<?php echo $topic['qpd_unitd_id']; ?>"/></td>
                                                                ...
                                                                <td><input type="text" id="sub_marks" name="sub_marks[]" class="text_align_right allownumericwithoutdecimal input-mini edit_unit_max_marks required max_marks" value="<?php echo $topic['qp_utotal_marks']; ?>"/></td>
                                                    ...
                                                    <div class="form_container FM" >
                                                        ...
                                                        <table id="expense_table" cellspacing="0" cellpadding="0" class="table table-bordered table-hover"  aria-describedby="example_info">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" id="units_01" name="units_01" maxlength="255" class="required" />
                                                                        <span id="unit_error" class="font_color"></span>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" id="ques_no_01" name="ques_no_01" maxlength="255" class="text_align_right allownumericwithoutdecimal required" />
                                                                        <span id="ques_error" class="font_color"></span>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" id="marks_01" name="marks_01" maxlength="11" class="text_align_right allownumericwithoutdecimal required" />
                                                                        <span id="marks_error" class="font_color"></span>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                </tr>
                                                            </tbody>
                ...
                <!-- <div class="row-fluid" id="Edit_FM" style="display:none;">
                     <div class="span15">
                         <section id="contents">
                ...
                <?php echo "Edit FrameWork"; ?>
                  ...
                  <table class="table  table-condensed table-bordered table-hover" id="Edit_FM_table" style="border-collapse:collapse aria-describedby="example_info">
                         ...
                         <thead>
                          <tr role="row">
                              <th class="header" role="columnheader" tabindex="0" aria-controls="example" >Sl No.</th>
                              <th class="header" role="columnheader" tabindex="0" aria-controls="example" >UNITS</th>
                              <th class="header" role="columnheader" tabindex="0" aria-controls="example" >No.Question</th>
                ...
                foreach ($unit_data as $topic) {
                    ?>
                                                      <tr  data-toggle="collapse"><td><?php echo $i; ?></td>
                                                          <td><input type="text" id="unitd_id" name="unitd_id[]" class="input-mini required max_marks" value="<?php echo $topic['qp_unit_code']; ?>"/>
                                                                                                  <input type="hidden" id="unitd_id_one" name="unitd_id_one[]" class="input-mini required" value="<?php echo $topic['qpd_unitd_id']; ?>"/></td>
                                                          <td><input type="text" id="no_q" name="no_q[]" class="input-mini required max_marks" value="<?php echo $topic['qp_total_unitquestion']; ?>"/></td>
                                                          <td><input type="text" id="sub_marks" name="sub_marks[]" class="input-mini edit_unit_max_marks required max_marks" value="<?php echo $topic['qp_utotal_marks']; ?>"/></td>
                                                          <td><a role = "button" href="#" class="delete_Unit" id="<?php echo $topic['qpd_unitd_id']; ?>" ><i class="icon-remove icon-black"> </i></a>
                                                          </td></tr><?php
                    $i++;
                }
                ...
                <!--   <table id="expense_table" cellspacing="0" cellpadding="0" class="table table-bordered table-hover"  aria-describedby="example_info">
                     ...
                     <tbody>
                         <tr>
                             ...
                             <td>
                                                                             <input type="text" id="ques_no_01" name="ques_no_01" maxlength="255" class="required" />
                                                                             <span id="ques_error" class="font_color"></span>
                                                                     </td>
                             <td>
                                                                             <input type="text" id="marks_01" name="marks_01" maxlength="11" class="required" />
                                                                             <span id="marks_error" class="font_color"></span>
                                                                     </td>
                             <td>&nbsp;</td>
                         </tr>
                                    ...
                                    <div class="menu">
                                        <div class="accordion">
                                            ...
                                            <div id="collapse2" class="panel-collapse collapse">
                                                <a role="button" type="button"  id="Add_Question" class="btn btn-primary pull-right" ><i class="icon-plus-sign icon-white"></i>&nbsp;Add Question</a>
                                                <br><br>
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            foreach ($entity_id as $entity) {
                                                                if ($entity['entity_id'] == 22) {
                                                                    ?>
                                                                    <th class="header" role="columnheader" tabindex="0" aria-controls="example" >Performance Indicator(PI) Code</th>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
                                                            ...
                                                            foreach ($entity_id as $entity) {
                                                                if ($entity['entity_id'] == 29) {
                                                                    ?>
                                                                    <th class="header" role="columnheader" tabindex="0" aria-controls="example" >Question Type </th>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <section id="contents">
                                                ...
                                                <!-- <div class="row-fluid">
                            <div class="span12">
                                <a href= "<?php echo base_url('question_paper/manage_cia_qp'); ?>" id="cancel_button"><span class="btn btn-danger pull-right"><i class="icon-remove icon-white"></i><span></span> Close</span></a>
                            </div>
                        </div>--->
...
// Dynamic Loading of UNIT and Questions
                                ...
                                ?>
                                <div id="edit_qp" class="row-fluid modal hide fade local-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; margin-left: -500px; width:1000px;" data-controls-modal="myModal1" data-backdrop="static" data-keyboard="false">
                                    <div class="span12">
                                        <section id="contents">
                                            <div class="bs-docs-example ">
                                                <div class="navbar">
                                                    ...
                                                    <div id="questions" class="span12" style="display:none; padding-right:10px; margin:0px;">
                                                                    ...
                                                                    <!--<table style="width:900px">
                                                                            <tbody>
                                                                                    <tr>
                                                                                            <td >
                                                                                                            <th><input type="checkbox" name="mandatory" id="mandatory" class="mandatory" style="margin:200px;" title="Click check-box if it is a Mandatory Question"/></th>
                                                                                                            <th><label class="control-label" for="">Question No.<font color="red"><b>*</b></font>:</label></th>
                                                                                                            <th><input type="text" name="ques_nme" id="ques_nme" class="ques_nme input-small"  placeholder="Question No." readonly style="margin:0px;" /></th>						
                                                                                            </td>
                                                                                            <td style="width:20px"></td><td>JI<textarea class="question_textarea" name="question_1_1" id="question_1_1" style="margin: px; width:0; height: 40px;" ></textarea></td>
                                                                                    </tr>
                                                                            </tbody>
                                                                    </table>-->
             ...
             <!--<tr>
                     <th>Question No.</th>
                                                            <?php
                                                            foreach ($qp_entity as $qp_entity_data) {
                                                                if ($qp_entity_data['entity_id'] == 11) {
                                                                    ?>
                                                                     <th>Course Outcome<font class="font_color"><b>*</b></font></th>
                                                                    <?php
                                                                }
                                                                if ($qp_entity_data['entity_id'] == 6) {
                                                                    ?>
                                                                             <th>Program Outcome<font color="red"><b>*</b></font></th>
                                                                    <?php
                                                                }

                                                                if ($qp_entity_data['entity_id'] == 10) {
                                                                    ?>
                                                                             <th>Topic<font color="red"><b>*</b></font></th>
                                                                    <?php
                                                                }

                                                                if ($qp_entity_data['entity_id'] == 23) {
                                                                    ?>
                                                                             <th>ssssBloom's Level<font color="red"><b>*</b></font></th>
                                                                    <?php
                                                                }

                                                                if ($qp_entity_data['entity_id'] == 22) {
                                                                    ?>
                     ...
                     <th>Marks<font color="red"><b>*</b></font></th>
                                       ...
                                       <!-- <input type="hidden" name="question_name_<?php echo $mq_counter; ?>_1" id="question_name" value="<?php echo 'Q_No_' . $mq_counter . '_' . $counter; ?>" class="input-mini question_name_<?php echo $mq_counter; ?>" readonly />-->
																		...
																		if ($qp_entity_config['entity_id'] == 29) {?>
																			<tr>
																				<td>
																					<label class="control-label" for=""><b><div class=""></div>Question Type <font color="red">*</font></b>:</label>
																					<th> 
																						<select onmouseover="tool_tip_on(this.id);" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="" name="qp_type_1_1[]" id="qp_type_1_1" class="input-small qp_type_data" required multiple="multiple">
																							<?php foreach ($question_type_details as $qt) { ?>
																								<option value="<?php echo $qt['mt_details_id']; ?>" abbr="<?php echo $qt['mt_details_name']; ?>" ><?php echo $qt['mt_details_name']; ?></option>
																							<?php } ?>
																						</select>
																					</th>
																				</td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th><input type="text" name="mark" id="mark" class="input-small required mq_marks" style="margin:0px;" /></th>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                    ...
                                                    <input type="hidden" name="qpd_type" id="qpd_type" value="3"/>
                                                        ...
                                                        <div class="control-group">
                                                            <div class=" controls">
                                                                <div class="form-inline pull-right">
                                                                    <?php //echo $meta_data[0]['qpd_gt_marks'];    ?>
                                                                    <label for="qp_max_marks"><b>&nbsp;&nbsp;&nbsp; Grand Total Marks </b></label>
                                                                    <input type="text" id="qp_max_marks" name="qp_max_marks" class="input-mini required " value="<?php echo $total_marks . "/" . $meta_data[0]['qpd_gt_marks']; ?>" readonly />
                                                                </div>
                                                            </div>
                                                            <div class=" controls">
                                                                <div class="form-inline pull-right">
                                                                    <label for="qp_max_marks"><b>Section / Parts (Units) Marks </b></label>
                                                                    <input type="text" id="unit_marks" name="unit_marks" class="input-mini" value="" readonly />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><br/><br/>
                            ...
                            <div id="myModal_mapping_weightage" class="modal hide fade mapping_weightage" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="myModal_publish" data-backdrop="static" data-keyboard="false"></br>
                                <div class="container-fluid">
                                    <div class="navbar">
                                        <div class="navbar-inner-custom">
                                            Edit Weightage
                                ...
                                <div class="modal-footer">
                                    <button type="button" id="save_weight" class="save_weight btn btn-primary"><i class="icon-white icon-file"></i>Update</button>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="cancel btn btn-danger" data-dismiss="modal" id="import_cancel"><i class="icon-remove icon-white"> </i> Cancel</button>
                            ...
                            <div id="model_qp_actual_qp" class="modal hide fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="myModal4" data-backdrop="static" data-keyboard="false"></br>
                                ...
                                <div class="modal-body">
                                    Do you want to set this question paper as Model question paper ? <br/>
									If yes click <b>Ok</b> else click <b>Cancel</b>
                                </div>

                                <div class="modal-footer">
                                    <a class="btn btn-primary" data-dismiss="modal" id="click_ok" ><i class="icon-ok icon-white"></i> Ok </a>
                                    <a class="btn btn-danger" data-dismiss="modal" id="click_cancel" ><i class="icon-remove icon-white"></i> Cancel </a>
                            ...
                            <div id="unset_model_qp_actual_qp" class="modal hide fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="myModal4" data-backdrop="static" data-keyboard="false"></br>
								...
								<div class="modal-footer">
									<a class="btn btn-primary" data-dismiss="modal" id="unset_click" ><i class="icon-ok icon-white"></i> Ok </a>
									<a class="btn btn-danger" data-dismiss="modal" id="unset_click_cancel" ><i class="icon-remove-circle icon-white"></i> Cancel </a>
