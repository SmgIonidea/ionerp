<?php if ($this->rbac->has_permission('PRODUCT_BRAND', 'create')) { ?>
    <div class="pull-right" id="create_button_div">
        <a class="btn btn-primary btn-sm" href="<?= APP_BASE ?>products/product_brands/create">Create</a>
    </div>    
<?php } ?>

<div class="row-fluid">
    <div class="col-sm-12 table-responsive no-pad">
        <?php generate_gird($grid_config, "product_brands_list"); ?>
    </div>
    ...
    $(function ($) {
        ...
        $(document).on('click', '.delete-record', function (e) {
            e.preventDefault();
            var data = {'brand_id': $(this).data('brand_id')}
            ...
            BootstrapDialog.show({
                ...
                buttons: [{
                        ...
                        action: function (dialog) {
                            $.ajax({
                                url: '<?= APP_BASE ?>products/product_brands/delete',
                                method: 'POST',
                                data: data,
