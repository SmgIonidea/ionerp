...
class Curriculum_student_info extends CI_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('report/curriculum_student_info/curriculum_student_info_model');
    }
    ...
    public function index() {
        if (!$this->ion_auth->logged_in()) {
            ...
            $this->load->view('report/curriculum_student_info/curriculum_student_info_vw', $data);
        }
    }
    ...
    public function fetch_details() {
        ...
        $data['entrance_exam_list'] = $this->curriculum_student_info_model->fetch_entrance_exam();
        ...
        $details['d1'] = $this->load->view('report/curriculum_student_info/student_intake_table_vw', $data, true);
        $details['d2'] = $this->load->view('report/curriculum_student_info/student_graduate_table_vw', $data, true);
        $details['d3'] = $this->load->view('report/curriculum_student_info/student_placement_table_vw', $data, true);
    ...
    public function insert_student_info() {
        ...
        if ($save) {
            ...
            redirect('report/curriculum_student_info');
        } else {
            $program_id = $this->input->post('program');
            $num_year_count = $this->input->post('term_count');
            $crclm_id = $this->input->post('curriculum');
            ...
            $stud_higher_studies = $this->input->post('stud_higher_studies');
            $stud_entrepreneur = $this->input->post('stud_entrepreneur');
            $this->curriculum_student_info_model->update_student_info($program_id, $crclm_id, $stud_intake, $stud_admitted, $stud_migrated_other_pgm, $stud_migrated_this_pgm, $stud_lateral, $stud_division, $rank_from, $rank_to, $stud_graduate_data, $num_year_count, $stud_companies, $stud_higher_studies, $stud_entrepreneur);
            ...
            foreach ($admitted_details as $details) {
                $list[] = array(
                    ...
                    'edit' => '<a title="Edit" href="#" class="icon-pencil icon-black edit_stud_admitted_details" data-entrance_exam="' . $details['entrance_exam_id'] . '" data-id="' . $details['stud_admitted_id'] . '" 
                                               data-caste="' . $details['caste_id'] . '"data-gender="' . $details['gender_id'] . '" data-intake="' . $details['num_intake'] . '" data-from="' . $details['rank_from'] . '" data-to="' . $details['rank_to'] . '">
                                            </a>',
    ...
    public function insert_student_admitted_data() {
        ...
        $result = $this->curriculum_student_info_model->insert_student_admitted_data($pgm_id, $crclm_id, $ent_exam, $caste, $gender, $intake, $rank_from, $rank_to);
        echo $result;
    }
    ...
    public function stud_admitted_dropdowns() {
        ...
        $data['entrance_exam_list'] = $this->curriculum_student_info_model->fetch_entrance_exam_h($progrm_type);
        $data['category_list'] = $this->curriculum_student_info_model->fetch_category();
        $data['gender_list'] = $this->curriculum_student_info_model->fetch_gender();
        $details['d1'] = $this->load->view('report/curriculum_student_info/student_admitted_table_vw', $data, true);
        echo json_encode($details);
    }
    ...
    public function update_student_admitted_data() {
        ...
        $result = $this->curriculum_student_info_model->update_student_admitted_data($student_admitted_id, $pgm_id, $crclm_id, $ent_exam, $caste, $gender, $intake, $rank_from, $rank_to);
        echo $result;
    }
    ...
    public function stud_higher_studies_dropdowns() {
        ...
        $data['category_list'] = $this->curriculum_student_info_model->fetch_category();
        $data['gender_list'] = $this->curriculum_student_info_model->fetch_gender();
        $details['d1'] = $this->load->view('report/curriculum_student_info/stud_higher_studies_table_vw', $data, true);
        echo json_encode($details);
    }
        ...
        if ($higher_studies_details) {
            foreach ($higher_studies_details as $details) {
                $list[] = array(
                    ...
                    'edit' => '<a title="Edit" href="#" class="icon-pencil icon-black edit_higher_studies" data-entrance_exam="' . $details['entrance_exam_id'] . '" data-id="' . $details['stud_higher_studies_id'] . '" 
    ...
    public function insert_higher_studies_data() {
        ...
        $result = $this->curriculum_student_info_model->insert_higher_studies_data($pgm_id, $crclm_id, $ent_exam, $caste, $gender, $num_stud);
        echo $result;
    }
    ...
    public function update_higher_studies_data() {
        ...
        $gender = $this->input->post('gender');
        $num_stud = $this->input->post('num_stud');
        $result = $this->curriculum_student_info_model->update_higher_studies_data($higher_studies_edit, $pgm_id, $crclm_id, $ent_exam, $caste, $gender, $num_stud);
        echo $result;
    }
 ...
 * Location: .report/curriculum_student_info.php 
 */
?>