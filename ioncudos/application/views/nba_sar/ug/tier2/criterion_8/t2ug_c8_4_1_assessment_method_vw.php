<?php
/**
 * Description          :	View for NBA SAR Report - Section 8.4.1 (TIER II) - Attainment of Course Outcomes
 * Created		:	26-12-2016
        ...
        <tbody>
            ...
            foreach ($assessment_methods as $method) { ?>
                <tr>
                    ...
                    <td width="500"><?php echo $method['ao_method_name']; ?></td>
                </tr>
                <?php $i++;
            } ?>
        </tbody>
...
<!-- End of file t2ug_c8_4_1_assessment_method_vw.php 
        Location: .nba_sar/ug/tier2/criterion_8/t2ug_c8_4_1_assessment_method_vw.php -->