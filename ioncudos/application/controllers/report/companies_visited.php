...
class Companies_visited extends CI_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('report/curriculum_student_info/companies_visited_model');
    }
    ...
    public function index() {
        ...
        $details = $this->load->view('report/curriculum_student_info/companies_visited_list_vw', $data);
        echo ($details);
    }
    ...
    public function list_companies_details() {
        ...
        $companies_details = $this->companies_visited_model->fetch_companies_details($pgm_id, $crclm_id);
        $slNo = 0;
    ...
    public function insert_company_data() {
        ...
        $pgm_id = $this->input->post('pgm_id');
        $crclm_id = $this->input->post('crclm_id');
        $result = $this->companies_visited_model->insert_company_data($company_name, $company_type_id, $collaboration_date, $company_description, $pgm_id, $crclm_id);
        echo $result;
    }
    ...
    public function update_company_data() {
        ...
        $pgm_id = $this->input->post('pgm_id');
        $crclm_id = $this->input->post('crclm_id');
        $result = $this->companies_visited_model->update_company_data($company_id, $company_name, $company_type_id, $collaboration_date, $company_description, $pgm_id, $crclm_id);
        echo $result;
    }
    ...
    public function fetch_files() {
        ...
        $output = $this->load->view('report/curriculum_student_info/companies_visited_upload_file_vw', $data);
        echo $output;
    }
    ...
    public function stud_intake_details() {
        ...
        $output = $this->load->view('report/curriculum_student_info/companies_student_intake_table_vw', $data);
        echo $output;
    }
    ...
    public function check_insert_data() {
        ...
        $pgm_id = $this->input->post('pgm_id');
        $crclm_id = $this->input->post('crclm_id');
        $result = $this->companies_visited_model->check_insert_data($company_name, $company_type_id, $collaboration_date, $pgm_id, $crclm_id);
        echo $result;
    }
    ...
    public function check_update_data() {
        ...
        $pgm_id = $this->input->post('pgm_id');
        $crclm_id = $this->input->post('crclm_id');
        $result = $this->companies_visited_model->check_update_data($company_id, $company_name, $company_type_id, $collaboration_date, $pgm_id, $crclm_id);
        echo $result;
    }
 ...
 * Location: .report/companies_visited.php 
 */
?>