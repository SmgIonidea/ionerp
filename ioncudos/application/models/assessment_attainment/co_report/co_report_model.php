...
class Co_report_model extends CI_Model {
	...
	*/
	public function get_course_list($crclm_id,$term_id){
		$course_list_query = 'SELECT crs_id, crs_title FROM course WHERE crclm_id="'.$crclm_id.'" AND crclm_term_id = "'.$term_id.'" order by crs_title';
	...
	*/
	...
	public function get_course_report($crclm_id,$term_id,$crs_id){
		$course_report_query = 'CALL getCOAttainmentReport('.$crs_id.',NULL)';
