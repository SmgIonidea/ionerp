<?php
/**
 * Description          :   View for NBA SAR Report - Section 4.1 (Diploma TIER 2) - Enrollment Ratio
 * Created              :   06-06-2017
...
<tbody>
    <tr>
        <td width="700"><h4 class="font_h ul_class">>= 90% Students</h4></td>
        <td width="100" style="text-align:center"><h4 class="font_h ul_class">20</h4></td>
    </tr>
    <tr>
        <td width="700"><h4 class="font_h ul_class">>= 80% Students</h4></td>
        <td width="100" style="text-align:center"><h4 class="font_h ul_class">18</h4></td>
    </tr>
    <tr>
        <td width="700"><h4 class="font_h ul_class">>= 70% Students</h4></td>
        <td width="100" style="text-align:center"><h4 class="font_h ul_class">16</h4></td>
    </tr>
    <tr>
        <td width="700"><h4 class="font_h ul_class">>= 60% Students</h4></td>
        <td width="100" style="text-align:center"><h4 class="font_h ul_class">12</h4></td>
    </tr>
    <tr>
        <td width="700"><h4 class="font_h ul_class">>= 50% Students</h4></td>
        <td width="100" style="text-align:center"><h4 class="font_h ul_class">08</h4></td>
    </tr>
    <tr>
        <td width="700"><h4 class="font_h ul_class">< 50% Students</h4></td>
...
<!-- End of file t2dip_c4_1_enrolment_ratio_vw.php 
        Location: .nba_sar/dip/tier2/criterion_4/t2dip_c4_1_enrolment_ratio_vw.php -->
