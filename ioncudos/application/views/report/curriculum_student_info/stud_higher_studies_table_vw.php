...
<form  class="form-horizontal" method="POST"  id="higher_studies_form" name="higher_studies_form" action="">
    <div id="higher_studies_heading" style="display:none"><br/>
        <b style="color:green"> Edit Higher Studies Details</b>
    </div>
    <table>
        <tr>
            <td valign="top">
...
<script src="<?php echo base_url('twitterbootstrap/js/custom/report/stud_higher_studies.js'); ?>" type="text/javascript"></script>
<!-- End of file student_admitted_table_vw.php 
                        Location: report/curriculum_student_info/stud_higher_studies_table_vw.php  -->