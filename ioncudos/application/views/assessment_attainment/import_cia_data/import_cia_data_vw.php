                ...
                <div class="bs-docs-example">
                    ...
                    <div class="navbar">
                        <div class="navbar-inner-custom">
                            <?php echo $this->lang->line('entity_cie_full'); ?> (<?php echo $this->lang->line('entity_cie'); ?>) Data Entry / Import List
                        </div>
                    </div>
                    <table>
                        <tr>
                            ...
                            <table class="table table-bordered table-hover" id="example" aria-describedby="example_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="header" role="columnheader" tabindex="0" aria-controls="example" >Section</th>
                                        ...
                                        <th class="header" role="columnheader" tabindex="0" aria-controls="example" >Instructor</th>
                                        <th class="header" role="columnheader" tabindex="0" aria-controls="example" >Mode</th>
                                        <th class="header" role="columnheader" tabindex="0" aria-controls="example" >View <?php echo $this->lang->line('entity_cie'); ?> Details</th>
                                        <th class="header" role="columnheader" tabindex="0" aria-controls="example" >Manage <?php echo $this->lang->line('entity_cie'); ?> Marks</th>
