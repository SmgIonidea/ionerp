                ...
                <div class="tabbable"> <!-- tabbable -->
                    ...
                    <div class="tab-content "><!-- tab content-->
                        ...
                        for ($tabNo = 1; $tabNo <= $maxTab; $tabNo++):
                            ...
                            <div class="tab-pane <?= ($tabNo == 1) ? 'active' : ''; ?>" id="tab<?= $tabNo ?>" style="min-height:150px;">
                                ...
                                if ($qstnNo <= $totQstn) {
                                    ...
                                    for (; $qstnNo <= $qstnCounter; $qstnNo++, $qstnIndex++) {									
                                        ...
                                        if (array_key_exists('selected_template_type', @$template_data)){
                                          if(@$template_data['selected_template_type'] == 'Feedback Template' || $template_data['selected_template_type'] == 'feedback'){
                                              $feedBkFlag = 1;
                                          }else if(@$template_data['selected_template_type'] == 'Fresh Template' || $template_data['selected_template_type'] == 'fresh'){
                                              $freshFlag = 1;
                                          }  
                                        }  
                                        ...
                                        if ($freshFlag || ($feedBkFlag == 0 && $freshFlag == 0)) {
                                            ...
                                            <div class="question_panel bs-docs-example">
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span4">
                                                        <?php                                                        
                                                            echo form_dropdown("question_type_$qstnNo", @$question_type, (set_value("question_type_$qstnNo")) ? set_value("question_type_$qstnNo") : $template_data['su_template_questions'][$qstnIdArr[$qstnIndex]]['question_type_id'], "id=question_type_$qstnNo class='input question_type_box remove_err'");
                                                        ?>
                                        ...
                                        if ($feedBkFlag || ($feedBkFlag == 0 && $freshFlag == 0)) {
                                                ...
                                                <div class="panel_border question_panel_feedback_opt_div" style="display:block;"> 
                                                    <div class="row-fluid">
                                                        ...
                                                        <div class="span4">
                                                            ...
                                                            <?php 
                                                                //echo form_dropdown("standard_option_feedbk", @$standard_option_feedbk, (set_value("standard_option_feedbk")) ? set_value("standard_option_feedbk") : @$template_data['su_template_questions'][$qstnIdArr[$qstnIndex]]['question_type_id'], "id='standard_option_feedbk' class='input standard_option_feedbk remove_err'"); ?>                                                    
                                                            <span id="errorspan_custom_option_feedbk_<?= $qstnNo ?>" class="error help-inline"></span>
                                                        </div> 
														<div class="span2">
                                                                                                                    <label>Target Level:<font color="red">*</font></label>
														</div>
														<div class="span4" id="template_option_div">
                                                                                                                    <select id="template_options" name="template_options" class="input template_options remove_err">
                                            ...
                                            <div class="question_panel_feedback" style="display:block;">
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span4" class='su_for_qstn_render_<?=$qstnNo?>'>
                                                        <?php
                                                        if(array_key_exists('su_for_list', $template_data)){
                                                                    if($template_data['su_for_list']!=0){?>
                                                        <select class="input su_for_qstn remove_err" id="su_for_qstn_<?=$qstnNo?>" name="su_for_qstn_<?=$qstnNo?>">
							...
							<input type="hidden" id="qstnNo[]" name="qstnNo[]" value="<?php echo $qstnNo; ?>"/>
                    <?php endfor; ?> 
