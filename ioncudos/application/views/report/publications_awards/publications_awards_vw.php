					...
					<div class="bs-docs-example" style=" height:auto; overflow:auto;">  
						<div class="row-fluid">										  
							<table class="table table-bordered table-hover" id="example" style="width:100%;">
								<thead>
									<tr>
										<th>Title</th><th>Participants</th><th>Position</th><th>Venue</th><th>Date </th><th>Upload</th><th>Edit</th><th>Delete</th>
									</tr>
								</thead>
								<tbody>
									<tr>
						...
						<div class="row-fluid" id="">	<br/>									  
							...
							<input type="hidden" id="uload_id" name="uload_id"/>
								<div class="span6">				
									...
									<div class="control-group">
										<p class="control-label" for="participants">Participants: <font color="red"><b>*</b></font></p>
											<div class="controls">
												<div class="input-append ">
													<textarea type="text" id="participants" name="participants" class="required"></textarea>
												</div>
											</div>
									</div>	
										...
										<p class="control-label" for="position"> Position : <font color="red"><b></b></font></p>
											<div class="controls">
												<div class="input-append ">
													...
													<input type="text"  id="position" name="position" class=""/>
												</div>
											</div>
									</div>												
								...
								<div class="control-group">
										...
										<div class="input-append date">
											<input readonly  type="text" id="award_publc_date" name="award_publc_date" class="required" style="width:180px;"/>
									...
									<div class="control-group">
										<p class="control-label" for="Offerprogram">Venue : <font color="red"><b></b></font></p>
											<div class="controls">
												<div class="input-append ">
													<textarea type="text" id="award_venue" name="award_venue" class=""></textarea>
												</div>
											</div>
									 </div>	
								</div>
...
<script src="<?php echo base_url('twitterbootstrap/js/custom/report/publications_awards.js'); ?>" type="text/javascript"></script>
