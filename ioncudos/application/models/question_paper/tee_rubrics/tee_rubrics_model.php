...
/**
 * Description	:	Rubrics definition for the TEE.
...
class Tee_rubrics_model extends CI_Model {
    /*
    ...
    public function save_rubrics_data($criteria,$co_list,$criteria_desc,$range,$range_name,$selected_radio_entity_id,$selected_rubrics_type,$crclm_id,$term_id,$crs_id,$pgm_id){
        ...
        $create_ao_method = array(
            ...
            'crs_id'=>$crs_id,
            'section_id'=>NULL,
            'ao_method_name'=> 'TEE RUBRICS for - '.$crs_title['crs_title'],
            'ao_method_description'=>'TEE RUBRICS for - '.$crs_title['crs_title'],
        ...
        // create qp definition
         $create_question_paper = array(
            ...
            'crs_id'=>$crs_id,
            'qpd_title'=>'Rubrics based '.$this->lang->line('entity_see').' Assessment',
            'qpd_timing'=>'3:00',
            'qpd_gt_marks'=>0,
            'qpd_max_marks'=>0,
...
//        $range_max_val = $range_value[1];
        ...
        $update_all_rubrics = 'UPDATE qp_definition SET qp_rollout = 0 WHERE crs_id = "'.$crs_id.'" AND qpd_type = 5';
...
if($qp_unit_count['qp_unit_size']>=1){
   ...
   * @return:
   */
  public function delete_tee_rubrics_details($qpd_id,$ao_method_id){
