                        ...
                        <div class="bs-docs-example">
                            ...
                            <div class="navbar">
                                <div class="navbar-inner-custom">
                                    <a class="brand-custom" name= "course_add_title_heading" id="course_add_title_heading" type="text" style="text-decoration: none"> Add Usergroup</a>
                                </div>
                            </div>
                            <br/>
                            <form class="form-horizontal" method="POST" id="add_curr" action="<?php echo base_url('configuration/permissions/permissions_edit' . '/' . $group_id); ?>" name="frm" id="add_crclm">
