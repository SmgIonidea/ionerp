...
/**
 * Description      :	Controller logic for Criterion 8 (TIER 1) - First Year Academics.
 * Created          :   14-6-2016
...
class T1ug_c8_first_year_academics extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('nba_sar/nba_sar_list_model');
        $this->load->model('nba_sar/ug/tier1/criterion_8/t1ug_c8_first_year_academic_model');
        $this->load->model('nba_sar/ug/tier1/criterion_2/t1ug_c2_teaching_process_model');
    ...
    public function first_year_sfr($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            ...
            return $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_1_first_year_sfr_vw', $this->data, true);
        }
    }

    /**
     * Function is to get first year sfr table - section 8.1
    ...
    public function display_fysfr_grid($crclm_id = '') {
        ...
        $fysfr_detail = $this->t1ug_c8_first_year_academic_model->fysfr_grid($curriculum, $pgm_id);
        $this->data ['fysfr_list'] = $fysfr_detail;
        $content_view = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_1_first_year_sfr_grid_vw', $this->data, true);
    ...
    public function facutly_teaching_fycc($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            ...
            return $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_2_quality_of_faculty_teaching_fycc_vw', $this->data, true);
        }
    }

    /**
     * Function is to display first year academic performance table - section 8.2.
     * @parameters  : curriculum id
     * @return      : table
     */
    public function display_facutly_teaching_fycc($crclm_id = '') {
        ...
        $dept_id = $this->input->post('dept_id');
        $pgm_id = $this->input->post('pgm_id');
        $fycc_detail = $this->t1ug_c8_first_year_academic_model->get_facutly_teaching_fycc($curriculum, $pgm_id, $dept_id);
        $this->data ['fycc_list'] = $fycc_detail;
        $content_view = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_2_quality_of_faculty_teaching_fycc_grid_vw', $this->data, true);
    ...
    /**
     * Function is to display first year academic performance - section 8.3
     * @parameters  :
     * @return      : view
     */
    public function first_year_academic_performance($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            ...
            return $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_3_first_year_academic_performance_vw', $this->data, true);
        }
    }

    /**
     * Function to get the first year academic performance table - section 8.3
     * @parameters  :
     * @return      :   table
     */
    public function display_fyap($crclm_id = '') {
        ...
        $dept_id = $this->input->post('dept_id');
        $pgm_id = $this->input->post('pgm_id');
        $fyap_detail = $this->t1ug_c8_first_year_academic_model->get_academic_performance($curriculum, $pgm_id);
        $this->data ['academic_performance'] = $fyap_detail;
        $content_view = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_3_first_year_academic_performance_grid_vw', $this->data, true);
    ...
    public function assessment_method_for_co($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($crclm_id) {
            $this->data['term_list'] = $this->t1ug_c8_first_year_academic_model->get_term_list($crclm_id);
        ...
        if ($is_export) {
            $this->data['attainment_co_vw'] = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_4_1_assessment_method_vw', $this->data, true);
            // yet to create view for report.
            return $this->data['attainment_co_vw'];
        } else {
            return $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_4_1_assessment_method_vw', $this->data, true);
        }
    }

    /**
     * Function to form term dropdown list
     * @parameters  :
     * @return      :
     */
    public function get_term_list() {
        $crclm_id = $this->input->post('curriculum');
        $crclm_list = $this->t1ug_c8_first_year_academic_model->get_term_list($crclm_id);
    ...
    /**
     * Function to form course dropdown list
     * @parameters  :
     * @return      :
     */
    public function get_course_list() {
        ...
        $course_list = $this->t1ug_c8_first_year_academic_model->get_course_list($crclm_id, $term_id);
    ...
    public function display_curriculum_courses() {
        $crclm_id = $this->input->post('curriculum');
        $data ['course_list'] = $this->t1ug_c8_first_year_academic_model->list_curriculum_courses($crclm_id);
    ...
    /**
     * Function to get the Assement Occasions of Course - section 8.4.1
     * @parameters  :
     * @return      :
     */
    public function course_assement_occasions_list($course_id = NULL, $crclm_id=NULL, $term_id=NULL) {
        if ($course_id == NULL) {
            ...
            $this->data['assement_list'] = $this->t1ug_c3_co_attainment_model->course_assement_occasions_list($course_id, $crclm_id, $term_id);
    ...
    public function get_qp($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export && @$qpd_id) {
            $qp_details = $this->t1ug_c2_teaching_process_model->get_qpd_details(@$qpd_id);
        ...
        if ($curriculum_id) {
            $this->data['course_list_data'] = $this->t1ug_c8_first_year_academic_model->list_curriculum_courses($crclm_id);

            if ($course_id) {
                $this->data['qp_list'] = $this->t1ug_c2_teaching_process_model->list_course_qp($crclm_id, $course_id);
            }
        }

        return $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_4_1_qp', $this->data, true);
    }
    ...
    public function generate_model_qp_modal_tee_static($pgm_id = NULL, $crclm_id = NULL, $crclm_term_id = NULL, $crs_id = NULL, $qp_type = NULL, $nba_flag = NULL, $qpd_id = NULL) {
        ...
        $result = $this->t1ug_c2_teaching_process_model->qp_details($crclm_id, $term_id, $crs_id, $qp_type, $qpd_id);
        $model_qp_data['meta_data'] = $result['qp_meta_data'];
        $table = '';
        $qp_mapping_entity = $this->t1ug_c2_teaching_process_model->qp_mapping_entity();
    ...
    /**
     * Function to display attainment qpd rubrics - section 8.4.1
     * @parameters  : 
     * @return      : view
     */
    public function attainment_qpd_rubrics($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            ...
            return $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_4_1_co_rubrics_attainment_vw', $this->data, true);
        }
    }

    /**
     * Function to display CO attainment qpd rubrics - section 8.4.1
     * @parameters  : 
     * @return      : table
     */
    ...
    /*
     * Function to display the first year courses - section 8.4.2
     * @parameters  :
     * @return      : view
     */
    ...
    public function all_co_attainment($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            $this->data['attainment_co_vw'] = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_4_2_co_attainment_vw', $this->data, true);
            return $this->data['attainment_co_vw'];
        } else {
            return $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_4_2_co_attainment_vw', $this->data, true);
        }
    }

    /**
     * Function to populate the courses grid. - section 8.4.2
     * @parameters  :
     * @return      : view
     */
    public function display_crs_grid($curriculum = NULL, $selected_courses = NULL) {
        if ($curriculum == NULL) {
            ...
            $content_view = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_4_2_crs_grid_vw', $this->data, true);
    ...
    /*
     * Function to fetch the course target level - section 8.4.2
     * @parameters  : curriculum id, selected course ids
     * @return      : view
     */
    ...
    /*
     * Function to fetch the Course Wise PO Attainment and PO Indirect attainment - section 8.5.1
     * @parameters  :
     * @return      :
     */
    ...
    public function first_year_all_po_attainment($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            $this->data['attainment_co_vw'] = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_5_1_first_year_all_po_attainment_vw', $this->data, true);
            //yet to create the report view for this.
            return $this->data['attainment_co_vw'];
        } else {
            return $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_5_1_first_year_all_po_attainment_vw', $this->data, true);
        }
    }

    /*
     * Function to get the course wise po attainment and PO indirect attainment data - section 8.5.1.
     * @parameters  :
     * @return      :
     */
    ...
    public function course_wise_po_attainment($curriculum = NULL) {
        if ($curriculum == NULL) {
            $crclm_id = $this->input->post('curriculum');
            $po_data = $this->t1ug_c8_first_year_academic_model->for_all_po_mapping($crclm_id);
            $this->data['po_direct'] = $po_data['po_direct'];
            $this->data['po_indirect'] = $po_data['po_indirect'];
            $view_data = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_5_1_all_po_attainment_display_vw', $this->data, true);
            echo $view_data;
        } else {
            $po_data = $this->t1ug_c8_first_year_academic_model->for_all_po_mapping($curriculum);
            $this->data['po_direct'] = $po_data['po_direct'];
            $this->data['po_indirect'] = $po_data['po_indirect'];
            $view_data = $this->load->view('nba_sar/ug/tier1/criterion_8/t1ug_c8_5_1_all_po_attainment_display_vw', $this->data, true);
            return $view_data;
    ...
    /**
     * Function to delete filter id stored - section 8.4.2
     * @parameters  : 
...
/*
 * End of file t1ug_c8_first_year_academics.php
 * Location: .nba_sar/t1ug_c8_first_year_academics.php 
 */
?>