...
<div class="container-fluid">
                ...
                <div class="bs-docs-example">
                    <div class="navbar">
                        <div class="navbar-inner-custom">
                            Professional Societies / Chapters & Organizing Engineering Events
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span12">
                    ...
                    <input type="hidden" id="edit_prof_id" name="edit_prof_id">
    ...
    <script src="<?php echo base_url('twitterbootstrap/js/custom/nba_sar/prof_societies_chapter.js'); ?>" type="text/javascript"></script>
    <!-- End of file prof_list_vw.php 
                Location: .nba_sar/modules/prof_societies_chapter/prof_list_vw.php  -->
