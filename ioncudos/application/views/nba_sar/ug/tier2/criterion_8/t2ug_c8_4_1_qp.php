<?php
/**
 * Description          :   View for NBA SAR Report - Section 8.4.1 (TIER II) - tabel for Question Paper
 * Created              :   26-12-2016
            ...
            <div class="span4">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        echo form_dropdown('curriculum_list__' . $view_id . '_' . $nba_report_id, $select_curriculum_options, $curriculum_list_selected, 'id="curriculum_8_4_1" class="filter" autofocus = "autofocus"');
                        ?>
                    </div>
                </div>
            </div>
            <div class="span4">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <select name="<?php echo 'course_list__' . $view_id . '_' . $nba_report_id; ?>" id="curriculum_course_examination_8" class="filter course_list" autofocus = "autofocus">        
            ...
            <div class="span4">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <select name="<?php echo 'qp_list__' . $view_id . '_' . $nba_report_id; ?>" id="course_qp_examination_8" class="filter course_list" autofocus = "autofocus">        
...
<div class="row-fluid">
    <div class="span12">
        <input type="button" id="generate_8_4_1_report"  class="btn btn-success pull-right" value="Generate Report" />
        <br><br>
    </div>
    <?php
    if ($is_export) {
        if ($export_data != "") {
            ...
            <table class="table table-bordered" style="width:100%;">
                ...
                <h4 class="ul_class">Question Paper Title:  <?php echo $export_data['meta_data'][0]['qpd_title']; ?></h4>
                </th>
                </tr>
                <tr>
                    <th width="300" style="text-align:center;">
                <h4 class="ul_class">Total Duration (H:M):<?php echo $export_data['meta_data'][0]['qpd_timing']; ?></h4>
                </th>
                ...
                <tr>	
                    <td width="800" gridspan="4" style="text-align:center" colspan="3"><h4 class="ul_class">Note :<?php echo $export_data['meta_data'][0]['qpd_notes']; ?>
                        </h4></td>
                </tr>
                </tbody>
            </table>
    ...
    <div id="question_paper_display_div">
        <?php if (!$is_export) { ?>
            <script>$('#generate_8_4_1_report').click();</script> 
        <?php } ?>
    </div>
</div>
<!-- End of file t2ug_c8_4_1_qp.php 
        Location: .nba_sar/ug/tier2/criterion_8/t2ug_c8_4_1_qp.php -->