<?php
/**
 * Description          :       Edit View for Bloom's Domain Module.
 * Created		:	31-05-2015. 
        ...
        <div class="span10">
            ...
            <section id="contents">
                ...
                <div class="bs-docs-example fixed-height">
                    ...
                    <form  class="form-horizontal" method="POST"  id="add_form" name="add_form" action="<?php echo base_url('configuration/bloom_domain/update_bloom_domain'); ?>">
                        <?php echo form_input($bloom_domain_id); ?>
...
<script>
    //script count number of characters entered in the Edit description box for the first time.
...
<!-- End of file bloom_domain_edit_vw.php 
                      Location: .configuration/bloom_domain/bloom_domain_edit_vw.php -->