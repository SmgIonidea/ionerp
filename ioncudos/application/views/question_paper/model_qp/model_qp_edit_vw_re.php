...
================================================== -->
            ...
            <section id="contents">
                <div class="bs-docs-example ">
                    <a class="btn btn-danger pull-right"href= "<?php echo base_url('question_paper/manage_model_qp'); ?>" id="cancel_button"><i class="icon-remove icon-white"></i><span></span> Close</a>
                    <div class="menu">
                        <div class="accordion">
                                ...
                                <div class="brand-custom">
                                    <a class="brand-custom cursor_pointer" data-toggle="collapse" href="#collapse1" style="text-decoration:none;">
                                        <h5><b>&nbsp;<i class="icon-chevron-down icon-black"  data-toggle="collapse" > </i>
                                                <?php echo "Edit " . $this->lang->line('entity_tee') . " Model Framework"; ?></b></h5>
                                    </a>
                                </div>
                                <div></div></div>
                            <!--content goes here-->                                      
                            ...
                            <div id="collapse1" class="panel-collapse collapse">
                                <form class="form-horizontal" method="POST" id="add_form_id" name="add_form_id" action= "" class="collapse">
                                        ...
                                        <div class="span12">
                                            ...
                                            <div class="span4">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="total_duration" name="total_duration" class=" text_align_right allownumericwithoutdecimal input-mini required total_duration" placeholder="in hours" value="<?php echo $meta_data[0]['qpd_timing']; ?>" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="span4">
                                                <div class="control-group">
                                                    <div class="">Course:
                                                        <input class="required course_name" type="text" id="course_name" name="course_name" value="<?php echo $course_title[0]['crs_title'] . '  -  (' . $course_title[0]['crs_code'] . ')' ?>" style="width:270px;" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="span2">
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            ...
                                            <button type="button"  name="update_header" id="update_header" class="btn btn-primary pull-right" style="visibility:show"><i class="icon-file icon-white"></i><span></span> Update</button>
                                        </div>
                                    </div>
                                </form>
                                <!--	<a role="button" type="button" onclick="toggle_visibility('Edit_FM');"  id="toggle_FM" class="btn btn-primary pull-right" >
                                        <i class="icon-pencil icon-white " ></i>Edit Framework</a><br/><br/>-->

                                <!--content goes here style="display:none;"-->
                                ...
                                <div class="row-fluid" id="Edit_FM" >                     
                                    <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                        <table class="table table-bordered table-hover dataTable" id="Edit_FM_table" aria-describedby="Edit_FM_table_info">
                                            ...
                                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                ...
                                                foreach ($unit_data as $topic) {
                                                    ?>
                                                    <tr  data-toggle="collapse" class="table_row"><td><?php echo $i; ?></td>
                                                        <td><input type="text" id="unitd_id" name="unitd_id[]" class="input-mini required" value="<?php echo $topic['qp_unit_code']; ?>"/></td>
                                                        <td><input type="text" id="no_q" name="no_q[]" class="  text_align_right allownumericwithoutdecimal input-mini required " value="<?php echo $topic['qp_total_unitquestion']; ?>"/>
                                                            <input type="hidden" id="unitd_id_one" name="unitd_id_one[]" value="<?php echo $topic['qpd_unitd_id']; ?>"/></td>
                                                        <td><input type="text" id="sub_marks" name="sub_marks[]" class="  text_align_right allownumericwithoutdecimal input-mini edit_unit_max_marks required max_marks" value="<?php echo $topic['qp_utotal_marks']; ?>"/>										
                                                        </td>
                                                        <td><a role = "button" href="#" class="delete_Unit" id="<?php echo $topic['qpd_unitd_id']; ?>" ><i class="icon-remove icon-black"> </i></a>&nbsp;&nbsp;<font color="red"><span id="test"></span></font>
                                                        </td>
                                                    </tr><?php
                                                $i++;
                                            }
                                    ...
                                    <!--onclick="toggle_visibility('Edit_FM');"-->
                                    ...
                                    <br/>
                                    <form id="frame_work_container" action  method="post">
                                        <div class="form_container FM">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm pull-right" id="add_ExpenseRow">
                                                <i class="icon-plus-sign icon-white"></i> ADD Unit/Section
                                            </button>
                                            <table id="expense_table" cellspacing="0" cellpadding="0" class="table table-bordered table-hover"  aria-describedby="example_info">
                                                ...
                                                <tbody>
                                                    <tr id="expense_table_master_row">
                                                        <td><input type="text" id="units_01" name="units_01" maxlength="255" class="required" /></td>
                                                        <td><input type="text" id="ques_no_01" name="ques_no_01" maxlength="255" class="required" /></td>
                                                        <td><input type="text" id="marks_01" name="marks_01" class="unit_max_marks required" maxlength="11"  /></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
foreach ($unit_data as $topic) {
    ?>
                                                <tr  data-toggle="collapse" class="table_row"><td><?php echo $i; ?></td>
                                                    <td><input type="text" id="unitd_id" name="unitd_id[]" class="input-mini required" value="<?php echo $topic['qp_unit_code']; ?>"/>
                                                                                            <input type="hidden" id="unitd_id_one" name="unitd_id_one[]" class="input-mini required" value="<?php echo $topic['qpd_unitd_id']; ?>"/></td>
                                                    <td><input type="text" id="no_q" name="no_q[]" class="input-mini required " value="<?php echo $topic['qp_total_unitquestion']; ?>"/></td>
                                                    <td><input type="text" id="sub_marks" name="sub_marks[]" data-unit_marks="<?php echo $topic['qp_utotal_marks']; ?>" class="input-mini edit_unit_max_marks required max_marks" value="<?php echo $topic['qp_utotal_marks']; ?>"/></td>
                        ...
                        <form >				   
                            <div class="bs-docs-example" >	
                                ...
                                <div id="collapse2" class="panel-collapse collapse">
                                    <a role="button" type="button"  id="Add_Question" qp_crs_id="<?php echo $crs_id; ?>" qp_qpd_id="<?php echo $qpd_id; ?>"class="btn btn-primary pull-right" ><i class="icon-plus-sign icon-white"></i>&nbsp;Add Question</a>
                                    <br><br>
                                            ...
                                            <tr role="row">
                                                ...
                                                foreach ($entity_id as $entity) {
                                                    if ($entity['entity_id'] == 10) {
                                                        ?>
                                                        <th class="header" role="columnheader" tabindex="0" aria-controls="example" ><?php echo $this->lang->line('entity_topic'); ?> Title</th>
                                                    <?php
                                                    }
                                                }
                                                ?>
												...
												foreach ($entity_id as $entity) {
													if ($entity['entity_id'] == 22) {
														?>
														<th class="header" role="columnheader" tabindex="0" aria-controls="example" >Performance Indicator(PI) Codes</th>
													<?php
													}
												}
												?>
                                ...
                                <div class="menu">
                                    <div class="accordion">
                                        <div class="accordion-group">
                                            ...
                                            <div id="area4" class="accordion-body collapse" onl>
...
<?php } ?>
                                ...
                                <tr> 
                                    <td style="width:380px;">
                                        <table style="" align="">
                                            <tr>
                                                <td>
                                                    <label class="control-label" for=""><b><div class=""></div>Mandatory</b> :</label>
        ...
        <?php } ?>
                                                    ...
                                                    <tr> 
                                                        <td>							 
                                                            <label class="control-label" for=""><b><div class="span1"></div>Bloom's Level</b><font color="red"><b>*</b></font> :</label>
                                                        <th>							
        ...
        <?php } ?>
                                            ...
                                            <tr>
                                                ...
                                                <th><input type="text" name="mark" id="mark" class="input-small required mq_marks text_align_right allownumericwithoutdecimal" style="margin:0px;" /></th>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<?php if (!empty($qp_unit_data)) { ?><input type="hidden" name="qpf_id" id="qpf_id" value="<?php echo $qp_unit_data[0]['qpf_id']; ?>" /> <?php } else { ?> 
                        ...
                        <input type="hidden" name="qpd_type" id="qpd_type" value="4"/>
                            ...
                            <div class="control-group">
                                <div class=" controls">							
                                    <div class="form-inline pull-right">
                                        ...
                                        <input type="text" id="qp_max_marks" name="qp_max_marks" class="input-mini text_align_right allownumericwithoutdecimal" value="<?php echo $total_marks . "/" . $meta_data[0]['qpd_gt_marks']; ?>" readonly />
                                    </div>
                                </div>
                                <div class=" controls">
                                    <div class="form-inline pull-right">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="form-inline pull-right ">
                                    ...
                                    <button type="button" name="update" id="update" onclick="graph_load()" class=" btn btn-primary"><i class="icon-file icon-white" num required></i><span></span> Update</button>
                                    <button type="button" name="save_main_que" id="save_main_que" onclick="graph_load()" class="btn btn-primary"  onclick=""><i class="icon-file icon-white"></i><span></span> Save</button>
...
<div id="myModal5" class="modal hide fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="myModal4" data-backdrop="static" data-keyboard="false"></br>
    ...
    <div class="modal-footer">
        <!--<a class="btn btn-primary" onClick="javascript:publish();"><i class="icon-ok icon-white"></i> Ok </a> -->
        <a class="btn btn-primary" data-dismiss="modal" id="delete_Unit_modal" data-tr_val="" ><i class="icon-ok icon-white"></i> Ok </a>
        <button class="btn btn-danger" data-dismiss="modal" ><i class="icon-remove icon-white"></i> Cancel </button>
    </div>
</div>	
...
<div id="myModal_data_full" class="modal hide fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="myModal4" data-backdrop="static" data-keyboard="false"></br>
    ...
    <div class="modal-body">
        <h4><center><?php echo $this->lang->line('Unit'); ?> Full<font color="brown"><b id="crclm_name" style="color:#E67A17; text-decoration: underline;"></b></center></font></h4>
    </div>
...
<script>
    var unit_lang = "<?php echo$this->lang->line('Unit'); ?>";
    var co_lang = "<?php echo$this->lang->line('entity_clo'); ?>";
    var po_lang = "<?php echo$this->lang->line('so'); ?>";
</script>
...
<script src="<?php echo base_url('twitterbootstrap/js/custom/question_paper/model_qp_re.js'); ?>" type="text/javascript"></script>
