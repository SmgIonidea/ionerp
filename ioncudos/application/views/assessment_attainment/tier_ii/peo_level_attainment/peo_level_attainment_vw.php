            ...
            <section id="contents">
                <div class="bs-docs-example" >
                    ...
                    <div class="navbar">
                        <div class="navbar-inner-custom">
                            Program Educational Objective (PEO) Attainment
                        </div>
                    </div>

                    <form class="form-horizontal" method="POST" target="_blank" id="add_form" name="add_form" action="<?php echo base_url('tier_ii/peo_level_attainment/export_to_pdf'); ?>">
                        <div class="row-fluid">
						...
						echo form_dropdown('crclm_name', array('' => 'Select Curriculum') + $select_options1, set_value('crclm_id', '0'), ' "class="required target" id="crclm_id" autofocus = "autofocus"');
						?>	
                                            </label>
                        ...
                        <ul id="myTab" class="nav nav-tabs">
                            <li class="active"><a href="#peo_direct_attainment" data-toggle="tab"> Direct Attainment </a></li>
                            <li><a href="#peo_indirect_attainment" data-toggle="tab"> Indirect Attainment </a></li>
                            <li><a href="#peo_direct_indirect_report" data-toggle="tab"> Direct and Indirect Attainment </a></li>

                        </ul>								
                        <div id="myTabContent" class="tab-content">
                            <!-- Tab one - Course Plan starts here -->
                            <div class="tab-pane fade in active" id="peo_direct_attainment">
                                <div id="peo_attainment_chart_1"></div>
                                <div id="course_attainment_nav">
                                </div>
                                <div id="course_attainment_no_data" ></div>
                                <div id="peo_attainment_chart_2"></div>
                                </br>
                                <div id="peo_attainment_graph_data" style="display:none;"></div>
                                <input type="hidden" id="peo_attainment_graph_data_hidden" name="peo_attainment_graph_data_hidden" />
                            ...
                            <div class="tab-pane fade" id="peo_indirect_attainment">
                                <form  method="POST" target="_blank" id="indirect_attainment_form" name="indirect_attainment_form" class="form-inline"  action="<?php echo base_url('tier_ii/peo_level_attainment/export_to_pdf_indirect_attainment'); ?>">
                                    <label>Survey :<font color='red'>*</font> <?php echo str_repeat('&nbsp;', 6); ?>
					<select id="survey_id" name="survey_id" class="input-xlarge" >
                                            <option value="0">Select Survey</option>
                                        </select>
                                    </label><?php echo str_repeat('&nbsp;', 13); ?>
                                    <div id="peo_level_indirect_div" style="height:auto;">
                                    </div>
                                    <div id="chart_plot_peo_indirect_attain"></div>
                                    <div id="graph_val">
                                    </div>
                                    <div id="peo_indirect_attainment_graph_data" style="display:none"></div>
                                    <input type="hidden" name="peo_indirect_attainment_graph_data_hidden" id="peo_indirect_attainment_graph_data_hidden" />
                                </form>
                            </div>

                            <div class="tab-pane fade" id="peo_direct_indirect_report">
                                <div id="finalized_peo_data"></div>
                                <form  method="POST" target="_blank" id="peo_indirect_direct_attainment_form" name="peo_indirect_direct_attainment_form" action="<?php echo base_url('tier_ii/peo_level_attainment/export_to_pdf_direct_indirect_attainment'); ?>">
                                    <table>
                                        <tr>
                                            <td>
						    ...
						    <td><center><input type="text" style="text-align: right;" autocomplete="off" name="survey_wgt_perc_1"  id="survey_wgt_perc_1"  class=" onlyDigit max_wgt input-mini" />&nbsp;%</center></td>
						    <td><center><i id="tooltip" class="icon icon-remove disabled" title="Delete disabled" data-toggle="tooltip" data-placement="top"></i></center></td>
                                        ...
                                        <table>
                                            <tr>
                                                <td width="85%" colspan="2">&nbsp;</td><td><?php echo str_repeat("&nbsp;", 11); ?></td><td><center>&nbsp;Total: <input type="text" name="total_perc" class="total_wgt required input-mini" readonly='readonly' id="total_perc" value="100"/></center></td>
                                            </tr>
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <button id="save_peo_attainment" name="save_peo_attainment" class="save_peo_attainment btn btn-primary"><i class="icon icon-ok icon-white"></i>&nbsp;Submit</button>
                                        </div>
                                        <br /><br />

                                        <div id="peo_level_comparison_nav">                                           
                                        </div>
                                        <br>
                                        <div id="chart_plot_7"></div>	
                                        <!--<div id="finalize_btn"></div>-->
                                        <div id="peo_attainment_no_data_survey"></div>								
                                        <br>
                                    </div>

                                    <div id="peo_direct_indirect_attainment_graph_data" style="display:none"></div>
                                    <input type="hidden" name="peo_direct_indirect_attainment_graph_data_hidden" id="peo_direct_indirect_attainment_graph_data_hidden" />
                ...
                <div id="myModalQPdisplay_paper_modal_2" class="modal hide fade myModalQPdisplay_paper_modal_2 modal-admin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
                    ...
                    <div class="modal-header">
                        <div class="navbar">
                            <div class="navbar-inner-custom">
				Program Educational Objective Attainment by individual <?php echo $this->lang->line('student_outcomes_full'); ?>
                            </div>
                        </div>
                        <div id="peo_statement"></div>
...
<script type="text/javascript" src="<?php echo base_url('twitterbootstrap/js/custom/assessment_attainment/tier_ii/peo_level_attainment/peo_level_attainment.js'); ?>"></script>
