                        ...
                        <div class="bs-docs-example">
                            ...
                            <form class="form-horizontal" method="POST" id="delivery_method_add_form" name="delivery_method_add_form" action= "<?php echo base_url('curriculum/curriculum_delivery_method/crclm_delivery_method_insert_record'); ?>">
								...
								<div class="pull-right"><br>
                                    <button class="delivery_method_add_form_submit btn btn-primary" type="submit"><i class="icon-file icon-white"></i><span></span> Save </button>
                                    <button class="clear_all btn btn-info" type="reset"><i class="icon-refresh icon-white"></i><span></span> Reset </button>
