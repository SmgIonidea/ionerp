<?php
/**
 * Description          :   View for NBA SAR Report - Section 8.4.2 (TIER 2) - Course list semester wise.
 * Created              :   26-12-2016
                                            ...
                                            <table border="1" class="term_parent" cellpadding="4">
                                                <tr>
                                                    <td colspan=4 gridspan=3 title="Keep cursor on course code to see course title">
                                                        <b>' . $clo['term_name'] . '<span class="pull-right"><input data-count="' . $i . '" style="margin:0px;" type="checkbox" name="checkbox_' . $i . '" class="select_all_chk_' . $i . ' c8_4_2_select_all_course_box" />&nbsp;Select all</span></b>
                                                    </td>
                                                </tr>';
    ...
    foreach ($crs_id_list as $crs_id_list_key => $crs_id_list_value) {
        ...
        if ($crs_id_list_value) {
            ...
            $final_string.= '<tr>
                            ...
                            <td>' . form_checkbox('cos_checkbox_list__' . $view_id . '_' . $nba_report_id, $crs_id_list_value, $is_check, 'class="filter c8_4_2_course_checkbox select_all__' . $i . '"') . '</td>
                        </tr>';
        }
    }
...
?>
<!-- End of file t2ug_c8_4_2_crs_grid_vw.php 
        Location: .nba_sar/ug/tier2/criterion_8/t2ug_c8_4_2_crs_grid_vw.php -->