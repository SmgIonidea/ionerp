...
/*
        ...
        public function po_attainment_data($crclm_id,$po_id){
            $po_attainment_query = 'SELECT term_name, po_reference, po_statement, avg_po_attain, avg_da, hml_wieghted_avg_da, hml_wgtd_multiply_map_da, crs_id, crclm_term_id, crclm_id
                                    FROM (
                                    SELECT term.term_name, p.po_reference,p.po_statement, ROUND(AVG(at.average_po_direct_attainment),2) as avg_po_attain,
                                    ...
                                    UNION
                                    SELECT terms.term_name, 0 po_reference, 0 po_statement,0 avg_po_attain, 0 avg_da, 0 hml_wieghted_avg_da, 0 hml_wgtd_multiply_map_da, 0 crs_id, terms.crclm_term_id, terms.crclm_id
