<?php
/** 
* Description	:	Static (read only) List View for Unmapped Measures Report Module. 
*					Select Curriculum then its related unmapped POs, PIs and Measures 
*					is displayed in a report format.
                                    ...
                                    <div class="span12">
                                        <div class="row-fluid">
                                            <label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <select size="1" id="crclm" name="crclm" aria-controls="example" onChange = "select_unmapped_measures();">
