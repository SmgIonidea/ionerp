                        ...
                        if ($qstnNo <= $totQstn) {
                            ...
                            for (; $qstnNo <= $qstnCounter; $qstnNo++, $qstnIndex++) {
                                ...
                                if ($freshFlag || ($feedBkFlag == 0 && $freshFlag == 0)) {
                                    ...
                                    <div class="question_panel bs-docs-example" style="display:<?=$display?>;">
                                        <?php if ($qstnNo > 1): ?>
                                        ...
                                        <div class="row-fluid">                                    
                                            ...
                                            <div class="span7">
                                                <div class="row-fluid">                                                                        
                                                    <div class="span5">
                                                        <?php 
                                                            echo form_dropdown("option_type_$qstnNo", $option_type, (set_value("option_type_$qstnNo")) ? set_value("option_type_$qstnNo") : '0', "id='option_type_$qstnNo' 'qstn'=$qstnNo class='input hide option_type_sel_box remove_err'");
                                                        ?>
                                        ...
                                        <div class="custom_option_div_<?= $qstnNo ?> hide" id="custom_option_div_<?= $qstnNo ?>">

                                            <?php
                                            $tp='single';  //strtolower($question_choice[$template_data['su_template_questions'][$qstnIdArr[$qstnIndex]]['is_multiple_choice']]);
                                            ...
                                            foreach ($template_data['su_template_qstn_options'][$qstnIdArr[$qstnIndex]] as $optKey => $optVal):
                                                ...
                                                <div class="option-div_<?= $qstnNo ?>" >
                                                    ...
                                                    <div class="row-fluid">
                                                        ...
                                                        <div class="span1 questionChoiceBox_<?=$qstnNo?>" style="width:15px;">
                                                            <?php echo $fld .'&nbsp;&nbsp;'; ?>
                                                        </div>
                                                        <div class="span10">
                                                            <?php 
                                ...
                                if ($feedBkFlag || ($feedBkFlag == 0 && $freshFlag == 0)) {
                                    ...
                                    if ($qstnNo == 1) {
                                        ?>
                                        <div class="panel_border question_panel_feedback_opt_div" style="display:<?=$display?>;"> 
                                            <div class="row-fluid">
                                                <div class="span2">
