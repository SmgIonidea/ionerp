...
<!--head here -->
								...
								<div class="span12">
									...
									<div class="span3">
										  <div class="control-group">
											...
											<div class="controls">
											  <input type="text" id="max_marks" name="max_marks" class="input-mini required max_marks" value ="<?php echo $qp_mq_data[0]['qpf_max_marks'];?>">
											</div>
										  </div>
									</div>
								</div>
								...
								<div class="span12">
									<div class="span6 ">
										  <div class="control-group pull-left">
											...
											<div class="controls">
											  <input type="text" id="total_question_<?php echo $unit_counter; ?>" name="total_question_<?php echo $unit_counter; ?>" class="input-mini required total_question" value="<?php echo $unit_details['qpf_num_mquestions']; ?>"/>
											</div>
										  </div>
									</div>
									<div class="span6 ">
										  <div class="control-group pull-right">
											...
											<div class="controls">
											  <input type="text" id="attempt_question_<?php echo $unit_counter; ?>" name="attempt_question_<?php echo $unit_counter; ?>" class="input-mini required attempt_question total_marks_validation">
											</div>
										  </div>
									</div>
								</div>
							...
							?>
											<tr>
												...
												<div class="input-append marks">
													<input type="text" name="mq_marks_<?php echo $mq_counter;?>_1" id="mq_marks_<?php echo $mq_counter;?>_1" class="input-mini required mq_marks "/>
	...
	<script type="text/javascript" src = "<?php echo base_url('twitterbootstrap/js/custom/curriculum/jquery.nailthumb.1.1.js'); ?> "> </script>
		<script src="<?php echo base_url('twitterbootstrap/js/custom/question_paper/tee_qp_add.js'); ?>" type="text/javascript"> </script>