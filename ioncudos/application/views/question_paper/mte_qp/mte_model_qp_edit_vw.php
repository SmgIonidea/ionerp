    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <section id="contents">
                <div class="bs-docs-example ">
                    <!--content goes here-->
                    <a class="brand-custom" href= "<?php echo base_url('question_paper/manage_mte_qp'); ?>" id="cancel_button"><span class="btn btn-danger pull-right"><i class="icon-remove icon-white"></i><span></span> Close</span></a>
                    <div class="menu">
                        <div class="accordion">
                                ...
                                <div class="brand-custom">
                                    <a class="brand-custom cursor_pointer" data-toggle="collapse" href="#collapse1" style="text-decoration:none;">
                                        <h5><b>&nbsp;<i class="icon-chevron-down icon-black"  data-toggle="collapse" > </i>
                                                <?php echo "Edit " . $this->lang->line('entity_mte') . " Framework"; ?></b></h5>
                                    </a>
