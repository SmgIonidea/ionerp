...
================================================== -->
            <section id="contents">
                <div class="bs-docs-example fixed-height">
                            ...
                            <div class="controls">
                                <select name="pgm_type" id="pgm_type" class="required">
                                    ...
                                    <?php foreach ($pgm_type_list as $pgm_type) { ?>
                                        <option value="<?php echo $pgm_type['master_type_id'] ?>"><?php echo $pgm_type['master_type_name'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <a class="btn btn-danger" href= "<?php echo base_url('configuration/programtype'); ?>"><i class="icon-remove icon-white"></i> Cancel</a>
                </div>
