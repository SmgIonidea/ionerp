...
class Products extends CI_Controller {
    ...
    public function index($export = 0) {
        ...
        $this->scripts_include->includePlugins(array('datatable', 'products'), 'js');
        $this->scripts_include->includePlugins(array('datatable'), 'css');
        $this->breadcrumbs->push('product_list', '/products/index');
        $data = array();
        $buttons[] = array(
            'btn_class' => 'btn-info',
            'btn_href' => base_url('products/products/view'),
            'btn_icon' => 'fa-eye',
        ...
        $buttons[] = array(
            ...
            'btn_href' => base_url('products/products/edit'),
            'btn_icon' => 'fa-pencil',
        ...
        $config['grid_config'] = array(
            ...
            'grid' => array(
                'ajax_source' => 'products/products/index',
            ...
            'table_tools' => array(
                'xls' => array(
                    'url' => 'products/products/index/xls'
                ), 'csv' => array(
                    'url' => 'products/products/index/csv'
                )
            )
        );
        $data['data'] = $config;
    ...
    public function create() {
        $this->scripts_include->includePlugins(array('jq_validation', 'products'), 'js');
        $this->layout->navTitle = 'Product create';
        $data = array();
        $this->breadcrumbs->push('product_create', '/products/create');
        if ($this->input->post()):
            $config = array(
                array(
                    'field' => 'pro_sku',
            ...
            if ($this->form_validation->run()):
                $post_data = array(
                    'pro_sku' => trim($this->input->post('pro_sku')),
                    'pro_name' => trim($this->input->post('pro_name')),
                    'pro_model' => trim($this->input->post('pro_model')),
                    'pro_model_no' => trim($this->input->post('pro_model_no')),
                    'product_mrp' => trim($this->input->post('product_mrp')),
                    'pro_sell_price' => trim($this->input->post('pro_sell_price')),
                    'vat/cst' => trim($this->input->post('vat/cst')),
                    'sipping_charge' => trim($this->input->post('sipping_charge')),
                    'pro_weight' => trim($this->input->post('pro_weight')),
                    'pro_color' => trim($this->input->post('pro_color')),
                    'pro_note' => trim($this->input->post('pro_note')),
                    'pro_location' => trim($this->input->post('pro_location')),
                    'pro_stock' => trim($this->input->post('pro_stock')),
                    'pro_max_buy' => trim($this->input->post('pro_max_buy')),
                    'pro_cart_desc' => trim($this->input->post('pro_cart_desc')),
                    'pro_short_desc' => trim($this->input->post('pro_short_desc')),
                    'pro_long_desc' => trim($this->input->post('pro_long_desc')),
                    'pro_status' => trim($this->input->post('pro_status')),
                    'pro_catagory_id' => trim($this->input->post('pro_catagory_id')),
                    'pro_brand_id' => trim($this->input->post('pro_brand_id')),
                    'pro_page_title' => trim($this->input->post('pro_page_title')),
                    'pro_title' => trim($this->input->post('pro_title')),
                    'pro_created_date' => trim($this->input->post('pro_created_date')),
                    'pro_created_by' => trim($this->input->post('pro_created_by')),
                    'pro_modified_date' => trim($this->input->post('pro_modified_date')),
                    'pro_modified_by' => trim($this->input->post('pro_modified_by')),
                );
                $data['data'] = $post_data;
    ...
    public function edit($product_id = null) {
        ...
        $data = array();
        $this->breadcrumbs->push('product_edit', '/products/edit');
        if ($this->input->post()):
            $config = array(
                array(
                    'field' => 'pro_sku',
    ...
    public function view($product_id) {
        ...
        if ($product_id):
            ...
            $this->scripts_include->includePlugins(array('jq_validation', 'products'), 'js');
            $this->breadcrumbs->push('product_view', '/products/view');
