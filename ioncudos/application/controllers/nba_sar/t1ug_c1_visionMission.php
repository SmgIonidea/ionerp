...
/**
 * Description          :   Controller logic for Criterion 1 (TIER 1) - vision mission.
 * Created              :   3-8-2015
 * Author               :          
...
class T1ug_c1_visionMission extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('nba_sar/ug/tier1/criterion_1/t1ug_c1_vision_mission_model');
    ...
    public function vision_mission() {
        $organization_id = 1;
        $organisation_detail = $this->t1ug_c1_vision_mission_model->get_organisation_by_id($organization_id);
        ...
        return $this->load->view('nba_sar/ug/tier1/criterion_1/t1ug_c1_1_mission_vision_vw', $this->data, true);
    }
    ...
    public function dept_vision_mission($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            ...
            return $this->load->view('nba_sar/ug/tier1/criterion_1/t1ug_c1_1_dept_mission_vision_vw', $this->data, true);
        }
    }
    ...
    public function display_dept_vision_mission($id = '') {
        ...
        $dept_detail = $this->t1ug_c1_vision_mission_model->get_dept_by_id($dept_id);
        $content_view = '';
        ...
        if (!($dept_detail == null)) {
            ...
            $content_view = $this->load->view('nba_sar/ug/tier1/criterion_1/t1ug_c1_1_dept_mission_vision_contents_vw', $this->data, true);
        } else {
    ...
    public function peo($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            ...
            return $this->load->view('nba_sar/ug/tier1/criterion_1/t1ug_c1_2_peo_vw', $this->data, true);
        }
    }
    ...
    public function display_peo($id = '') {
        ...
        $peo_detail = $this->t1ug_c1_vision_mission_model->get_peo($curriculum);
        $this->data ['peo_list'] = $peo_detail;
        $content_view = $this->load->view('nba_sar/ug/tier1/criterion_1/t1ug_c1_2_peo_contents_vw', $this->data, true);
        if (empty($id)) {
            echo $content_view;
        } else {
            return $content_view;
    ...
    public function peo_me_map($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        $this->data ['pgm_id'] = $pgm_id;
        if ($is_export) {
            return $peomeList;
        } else {
            return $this->load->view('nba_sar/ug/tier1/criterion_1/t1ug_c1_5_peo_me_map_vw', $this->data, true);
        }
    }
    ...
    public function display_peo_me($id_department = '', $id_curriculum = '') {
        ...
        $peo_me_detail = $this->t1ug_c1_vision_mission_model->get_map_peo_me($curriculum, $department);
        $content_view = $this->load->view('nba_sar/ug/tier1/criterion_1/t1ug_c1_5_peo_me_table_vw', $peo_me_detail, true);
...
/*
 * End of file t1ug_c1_visionMission.php
 * Location: .nba_sar/t1ug_c1_visionMission.php 
 */
?>