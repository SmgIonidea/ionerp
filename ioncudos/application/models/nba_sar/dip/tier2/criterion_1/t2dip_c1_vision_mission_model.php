...
/**
 * Description          :   Model logic for Criterion 1 (Diploma TIER 2) - vision mission.
 * Created              :   04-06-2017
...
class T2dip_c1_vision_mission_model extends CI_Model {
    ...
    public function get_map_peo_me($curriculum_id, $dept_id) {
        ...
        //peo to me mapping
        $call_proce = $this->db->query('CALL nba_t2dip_c1_5_PEO_ME_Mapping(' . $dept_id . ', ' . $curriculum_id . ')');
...
/*
 * End of file t2dip_c1_vision_mission_model.php
 * Location: .nba_sar/dip/tier2/criterion_1/t2dip_c1_vision_mission_model.php 
 */
?>