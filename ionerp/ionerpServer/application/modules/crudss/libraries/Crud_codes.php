...
class Crud_codes extends Js_codes{
   ...
   // private $_string_code = '';
    ...
    public function _append_class($class_name, $extend_class = null, $string_code = null, $libraries = null,$module_name='',$class_type='controller') {
        $extends = '';
        if ($extend_class) {
        ...
        $code.=$this->_constructor($libraries,$module_name,$class_type);
    ...
    public function _constructor($array = null,$module_name='',$class_type) {
