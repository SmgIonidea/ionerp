...
<?php
	...
	?>
<div id="status_div">
    <center><b>Direct Attainment / Target Levels for Course - Current Status: Sent for Rework.</b></center>
</div>
...
<br>
	...
	<div id="myModaledit_acrsl" class="modal hide fade large_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		...
		<div class="modal-footer">
			<button class="btn btn-primary update_crs_btn" id="update_crs_btn"><i class="icon-file icon-white"></i> Update</button>
			<button class="btn btn-danger" data-dismiss="modal"><i class="icon-remove icon-white"></i> Cancel</button>
		</div>
	</div><!--Edit modal-->
	<!--Form for adding course level attainment-->
	<form name="acrsl_add_form" id="acrsl_add_form" method="POST">
                <input type="hidden" name="curriculum_id" id="curriculum_id" value="<?php echo @$crclm_id; ?>"/>
		<input type="hidden" name="term_id" id="term_id" value="<?php echo @$term_id; ?>" />
		<input type="hidden" name="course_id" id="course_id" value="<?php echo @$crs_id; ?>" />
                
                <input type="hidden" name="curriculum_id" id="curriculum_data" value="<?php echo @$crclm_id; ?>"/>
		<input type="hidden" name="term_id" id="term_data" value="<?php echo @$term_id; ?>" />
		<input type="hidden" name="course_id" id="course_data" value="<?php echo @$crs_id; ?>" />
    ...
    <div id="justifiction_div">
            Comments:
                ...
                <textarea style="width: 1000px; margin: 0px; height: 64px;" id="course_target_justify" name="course_target_justify" disabled="disabled"><?php echo @$comment; ?></textarea>
	...
	<div id="myModal_edit_indirect_crs" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		...
		<div class="modal-body">
			<p>Chairman / Program Owner should define Common Course Attainment / Target Levels, then only Course Owners can able to define individual Course Target Levels</p>
		</div>
		<div class="modal-footer">
	...
	<div id="select_dropdowns" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		...
		<div class="modal-body">
			<p>Select the Term and Course drop-down.</p>
		</div>
		<div class="modal-footer">
			<button class="btn btn-danger" data-dismiss="modal" id=""><i class="icon-remove icon-white"></i> Close </button>
		</div>
		...
		<div class="modal-footer">
			<button class="btn btn-primary send_approval_ok"  id="send_approval_ok"><i class="icon-user icon-white"></i> Ok </button>
