<?php
/**
 * Description          :   View for NBA SAR Report - Section 6.3 (TIER I) - Safety measures in laboratories 
 * Created              :   29-8-2016
 * Author               :   Arihant Prasad
 * Modification History :
 * Date                     Modified By                         Description
 * 19-12-2016               Shayista Mulla              Indentation,code cleanup and changes in html to export
  ----------------------------------------------------------------- */
?>
...
<!-- End of file c6_3_safety_measures_in_laboratories_vw.php 
                Location: .nba_sar/ug/tier1/criterion_6/c6_3_safety_measures_in_laboratories_vw.php-->