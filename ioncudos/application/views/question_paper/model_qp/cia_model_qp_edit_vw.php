...
<script src="<?php echo base_url('twitterbootstrap/js/custom/question_paper/cia_model_qp_edit.js'); ?>"></script>
<?php
...
================================================== -->
            <section id="contents">
                <div class="bs-docs-example fixed-height">
                    ...
                    <form class="form-horizontal" method="POST" id="add_form_id" name="add_form_id" action= "<?php echo base_url('question_paper/manage_model_qp/cia_update_qp_data/3'); ?>">
                        <div class="control-group">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="span3">
                                    <div class="control-group">
                                        <label class="control-label" for="total_duration">Total Duration (H:M)<font class="font_color">*</font> :</label>
                                        <div class="controls">
                                ...
                                <div class="span5">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="required course_name input-xlarge" type="text" id="course_name" name="course_name" value="<?php echo $meta_data[0]['crs_title'] . '  -  (' . $meta_data[0]['crs_code'] . ')'; ?>" style="width:320px" readonly />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="span3">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="max_marks" name="max_marks" class="input-mini required max_marks numeric max_marks_validation" value="<?php echo $meta_data[0]['qpd_max_marks']; ?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="span12">
                                        <div class="span6 ">
                                            <div class="control-group pull-left">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="total_question_<?php echo $unit_counter; ?>" name="total_question_<?php echo $unit_counter; ?>" class="input-mini required total_question" value="<?php echo $unit_details['qp_total_unitquestion']; ?>" readonly />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="span6 ">
                                            <div class="control-group pull-right">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="attempt_question_<?php echo $unit_counter; ?>" name="attempt_question_<?php echo $unit_counter; ?>" value="<?php echo $unit_details['qp_attempt_unitquestion']; ?>" class="input-mini required attempt_question numeric">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    foreach ($main_qp_data as $mq_data) {
        if ($temp != $mq_data['qp_mq_code']) {
            ...
            $button = '<button class="btn btn-primary add_subque" type="button" id="add_subque_' . $mq_counter . '_' . $sub_counter . '" name="add_subque_' . $mq_counter . '_' . $sub_counter . '" abbr="Q No ' . $mq_counter . '-' . $alpha_counter . '" main_que_abbr ="Q No ' . $mq_counter . '-' . $alpha_counter . '"><i class="icon-plus-sign icon-white"></i></button>';

            $button .= '<button class="btn btn-danger del_main_que error_add" type="button" id="del_main_que_' . $mq_counter . '_' . $sub_counter . '" name="del_main_que_' . $mq_counter . '_' . $sub_counter . '" abbr="Q N ' . $mq_counter . '-' . $alpha_counter . '" del_main_count ="' . $unit_counter . '" del_main_que ="row_' . $mq_counter . '" ><i class="icon-minus-sign icon-white"></i></button>';
            ...
            $button = '<button class="btn btn-inverse" type="button" id="delete_subque_' . $mq_counter . '_' . $sub_counter . '" name="delete_subque_' . $mq_counter . '_' . $sub_counter . '" abbr="QNO_' . $mq_counter . '_' . $sub_counter . '" disabled="disabled"><i class="icon-plus-sign icon-white"></i></button>';

            $button .= '<button class="btn btn-danger delete_subque error_add" type="button" id="delete_subque_' . $mq_counter . '_' . $sub_counter . '" name="delete_subque_' . $mq_counter . '_' . $sub_counter . '" abbr="QNO_' . $mq_counter . '_' . $sub_counter . '" sub_que_abbr="' . $mq_counter . '"><i class="icon-minus-sign icon-white" ></i></button>';
            ...
            $script .= '$("#add_subque_' . $mq_counter . '_1").attr("main_que_abbr",que_name);';
            ...
            $script .= 'console.log(temp_array);';
            $script .= 'console.log(counter_val);';
        ...
        if ($mq_data['qp_unitd_id'] == $unit_details['qpd_unitd_id']) {
            ?>
                                                <tr id= "row_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" class="row_<?php echo $mq_counter; ?>">
                                                ...
                                                <?php echo $checkbox; ?>
                                                    ...
                                                    <td style="width: 43%;">
                                                        <textarea class="required span12 text_area" name="question_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" id="question_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" rows="3" ><?php echo $mq_data['qp_content']; ?></textarea>
                ...
                if ($qp_entity_config['entity_id'] == 11) {
                    ?>
                        ...
                        ?> >
                                                        ...
                                                        <?php if ($qp_entity_config['entity_id'] == 6) { ?>
                                                            <td>
                                                                <select onmouseover="tool_tip_on(this.id);" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="" name="po_list_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" id="po_list_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" class="input-mini required po_list_data">
                                                                    <option value="" abbr="Select CO">Select</option>
                                                            <?php
                                                            foreach ($co_data as $po_data) {
                    ...
                    <?php foreach ($topic_data as $topic) {
                        ?>
                                                                        ...
                                                                        ?>  abbr="<?php echo $topic['topic_title']; ?>">
                                                        ...
                                                        <?php if ($qp_entity_config['entity_id'] == 23) { ?>
                                                            <td>
                                                                <select onmouseover="tool_tip_on(this.id);" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="" name="bloom_list_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" id="bloom_list_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" class="input-mini required bloom_list_data">
                                                                    ...
                                                                    <?php foreach ($bloom_data as $blevel) {
                                                                        ...
                                                                        ?> abbr="<?php echo $blevel['bloom_actionverbs']; ?>">
                                                                ...
                                                                <select  onmouseover="tool_tip_on(this.id);" data-toggle="tooltip" data-placement="bottom" title="" data-original-title=""  name="pi_code_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" id="pi_code_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" class="input-small pi_code_data">
                                                                    ...
                                                                    <?php foreach ($pi_list as $pi_data) {
                                                                        ...
                                                                        <option value="<?php echo $pi_data['msr_id']; ?>" 
                                                                                    ...
                                                                                    ?> abbr="<?php echo $pi_data['msr_statement']; ?>">
            ...
            ?>
                                                    ...
                                                    <td>
                                                        <div class=" input-append">
                                                            <input type="text" name="mq_marks_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" id="mq_marks_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" class="input-mini required mq_marks numeric" value="<?php echo $mq_data['qp_subq_marks']; ?>"/>
            <?php echo $button; ?>
                                                ...
                                                <tr id="img_placing_row_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" class="row_<?php echo $mq_counter; ?>">
                                                    <td id=""></td>
                                                    <td id="place_img_<?php echo $mq_counter; ?>_<?php echo $sub_counter; ?>" colspan="6" class="row_<?php echo $mq_counter; ?>">
                                                        <?php
                                                        $img_temp = '';
                                                ...
                                                <tr id="sub_que_ref_div_<?php echo $mq_counter; ?>"  class="sub_que_ref_div_<?php echo $mq_counter; ?>" class="row_<?php echo $mq_counter; ?>"></tr>
                                                <?php
                                            }
                                            //$mq_counter++; 
                                        }
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group pull-right" id="main_que_load">
                                        <div class="controls">
                        ...
                        <input type="hidden" name="main_que_counter" id="main_que_counter" value="<?php echo $mq_counter; ?>" class="input-mini"/>
                        ...
                        <!--<input type="hidden" name="qpf_id" id="qpf_id" value="<?php echo $meta_data[0]['qpf_id']; ?>" class="input-mini" />-->
                        <input type="hidden" name="qpd_id" id="qpd_id" value="<?php echo $meta_data[0]['qpd_id']; ?>" class="input-mini" />
                        ...
                        <div id="button_div" class="pull-right"></div>
        ...
        $new_script = "<script>
							...
							$(document).ready(function(){ 
								...
								tmp_var = temp_val[m].split('_');
								sub_que_array.push({index:parseInt(tmp_var[0]), value:parseInt(tmp_var[1])});
								}
								var main_que_count = $('#main_que_counter').val();
								for(  j = 1; j <= main_que_count; j++){
										main_que_array.push(j);
								}
