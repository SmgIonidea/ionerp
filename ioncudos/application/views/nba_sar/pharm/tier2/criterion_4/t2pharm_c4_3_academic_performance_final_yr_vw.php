<?php
/**
 * Description          :   View for NBA SAR Report - Section 4.3 (Pharmacy TIER I) - Academic performancea in Fianal year
 * Created              :   19-06-2017
...
<div class="row-fluid">
    <div class="span12 cl">
        <b>Academic Performance in Final Year : </b>
    </div>
</div>
<div id="enrolment_ratio">
    <?php echo @$academic_performance; ?>
</div>
<!-- End of file t2pharm_c4_3_academic_performance_final_yr_vw.php 
        Location: .nba_sar/pharm/tier2/criterion_4/t2pharm_c4_3_academic_performance_final_yr_vw.php -->