    ...
    <table class="table table-bordered" style="width:100%;">
        <tbody>
            <tr>
                ...
                <td>
                    <h4 class="text-center">Graduated without backlog </h4>  
                </td>
                <td>
                    <h4 class="text-center">Mean of graduate percentage average </h4>
                </td>
                <td>
                    <h4 class="text-center">Total No. of successful students </h4>
                </td>
            </tr>
            <?php
            if ($stud_graduate) {
                ...
                foreach ($stud_graduate as $list_data) {
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="without_backlog<?php echo $i ?>" name="without_backlog<?php echo $i ?>" class="numbers" value="<?php echo $list_data['without_backlog'] ?>">
                        </td>
                        <td>
                            <input type="text" id="mean_grade<?php echo $i ?>" name="mean_grade<?php echo $i ?>" class="number onlyNumber" value="<?php echo $list_data['mean_grade'] ?>">
                        </td>
                        <td>
                            <input type="text" id="successful_stud<?php echo $i ?>" name="successful_stud<?php echo $i ?>" class="numbers" value="<?php echo $list_data['successful_stud'] ?>">
                        </td>
                    </tr>
                    <?php
                    $i++;
