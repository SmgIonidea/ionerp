...
$('#view').on('change','#curriculum_3_2_1_co_attainment', function() {
    ...
    $.ajax({
        type:"POST",
        url: base_url+'nba_sar/t2ug_c3_co_attainment/get_term_list',
        async:false,
        data: post_data,
...
$('#view').on('change','#term_3_2_1_co_attainment', function() {
    ...
    $.ajax({
        type:"POST",
        url: base_url+'nba_sar/t2ug_c3_co_attainment/get_course_list',
        async:false,
        data: post_data,
        success: function(msg) {
...
$('#view').on('click', '#generate_3_2_1_assessment_report', function(e){
    ...
    if(course_id){
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c3_co_attainment/course_assement_occasions_list',
            async:false,
            data: post_data,
            success: function(msg) {
...
$('#view').on('click', '#generate_3_2_1_rubrics_assessment_report', function(e){    
    ...
    if(ao_method_id != '') {
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c3_co_attainment/co_attainment_qpd_rubrics',
            async:false,
            data: post_data,
...
$('#view').on('change','#curriculum_list__3_2_2',function(){
    ...
    $.ajax({
        ...
        async:false,
        type:'post',
        url: $('#get_baseurl').val()+"nba_sar/t2ug_c3_co_attainment/clear_filter",
        success: function(msg){
        }
    });     
    $.ajax({
    ...
    if(curriculum){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c3_co_attainment/display_crs_grid',
            async:false,
            data: post_data,
            dataType: 'json',
            success: function(msg) {
...
$('#view').on('click','.course_checkbox',function(){
    ...
    $.ajax({
        type:"POST",
        url: base_url+'nba_sar/t2ug_c3_co_attainment/co_target_levels',
        async:false,
        data: post_data,
        success: function(msg) {
            $('#co_target_level').empty();
...
$('#view').on('change','#curriculum_list__3_3_1_survey', function() {
    ...
    if(crclm_id){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c3_co_attainment/fetch_curriculum_survey_list',
            async:false,
            data: post_data,
            success: function(msg) {
...
$('#view').on('change', '#survey_list__3_3_1_survey', function(e){    
    ...
    if(survey_id){
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c3_co_attainment/fetch_curriculum_survey_attainment_tools',
            async:false,
            data: post_data,
...
$('#view').on('change','#curriculum_list__3_3_2', function() {
    ...
    if(curriculum){
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c3_co_attainment/course_wise_po_attainment',
            async:false,
            data: post_data,
            success: function(msg) {
...
$('#view').on('change', '#survey_list__3_3_2_survey', function(e){     
    ...
    if(survey_id){
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2ug_c3_co_attainment/fetch_curriculum_survey_attainment',
            async:false,
            data: post_data,
            success: function(curriculum_survey) {
