...
/**
 * Description          :   Controller logic for Criterion 5 (TIER 1) - Facilities and Technical Support.
 * Created              :   04-05-2016
...
class T1ug_c6_facilities_and_technical_support extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('nba_sar/ug/tier1/criterion_6/t1ug_c6_facilities_and_tech_support_model');
    ...
    /**
     * Function to fetch lab adequate details - section 6.1
     * @parameters  :
     * @return      : view
     */
    public function laboratories_technical_manpower($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        extract($other_info);
        $data['lab_tech_manpwr'] = $this->t1ug_c6_facilities_and_tech_support_model->fetch_adequate_data($dept_id);

        return $this->load->view('nba_sar/ug/tier1/criterion_6/t1ug_c6_1_laboratories_technical_manpower_vw', $data, true);
    }
    ...
    public function safety_measures_in_laboratories($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        extract($other_info);
        $data['lab_safety_msr'] = $this->t1ug_c6_facilities_and_tech_support_model->safety_measures($dept_id);

        return $this->load->view('nba_sar/ug/tier1/criterion_6/t1ug_c6_3_safety_measures_in_laboratories_vw', $data, true);
    }

}

/*
 * End of file t1ug_c6_facilities_and_technical_support.php 
 * Location: .nba_sar/t1ug_c6_facilities_and_technical_support.php
 */
?>