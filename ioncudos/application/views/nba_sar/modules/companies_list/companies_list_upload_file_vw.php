...
$output = '<table class="table table-bordered char_font_size_12">
		<thead>	
			<b> '.$this->lang->line('industry_sing').' Name :</b>  ' . $company[0]['company_name'] . '
	   		<tr>
...
foreach ($files as $file) {
    ...
    $output .= '<tr>
		    <td style="text-align:right;"><input name="company_id" type="hidden" value="' . $file['company_id'] . '">' . $i . '</td>
		    <td><a href="' . base_url() . 'uploads/companies_list_uploads/' . $folder_name . '/' . $file['upload_file_name'] . '" target="_blank" >' . $new_name . '</a></td>
...
<!-- End of file companies_list_upload_file_vw.php 
                        Location: .configuration/companies_list/companies_list_upload_file_vw.php  -->