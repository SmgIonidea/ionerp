...
/**
 * Description          :   Model logic for Criterion 5 (TIER 2) - Faculty Information and Contributions.
 * Created              :   22-12-2016
...
class T2ug_faculty_contribution_model extends CI_Model {
    /*
    ...
    public function fetch_faculty_information_contribution($year, $dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_Faculty_Information_Contributions(' . $year . ',' . $dept_id . ')');
    ...
    public function fetch_student_faculty_ratio_sfr($curriculum_id, $pgm_id) {
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c5_1_Student_Faculty_Ratio(' . $result['start_year'] . ', ' . $pgm_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_faculty_qualification($curriculum_id, $dept_id, $pgm_id) {
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c5_3_Faculty_Qualification(' . $result['start_year'] . ', ' . $pgm_id . ', ' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_faculty_retention($curriculum_id, $dept_id, $pgm_id) {
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c5_4_Faculty_Retention(' . $result['start_year'] . ', ' . $pgm_id . ', ' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_faculty_development_training($year, $dept_id, $pgm_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_6_Faculty_Development_Training(' . $dept_id . ',' . $year . ',' . $pgm_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_academic_research($dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_7_1_Academic_Research(' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_academic_book_published($dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_7_1_Book_Published(' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_academic_PHD_details($dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_7_1_PHD_details(' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_sponsored_research($dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_7_2_Sponsored_Research(' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    /**
     * Function is to fetch consultancy projects details - section 5.7.4
     * @paramenters : dept id
     * @return      : array
     */
    public function fetch_consultancy_projects($dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_7_4_Consultancy_Projects(' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_faculty_performance_appraisal($year, $dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_8_Faculty_Performance_Appraisal(' . $year . ',' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_faculty_adjunct($year, $dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c5_9_Faculty_Visiting(' . $year . ',' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
