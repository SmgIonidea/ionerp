...
================================================== -->
		...
		<div class="bs-docs-example fixed-height">
		    ...
		    <form class="form-horizontal" method="POST" id="add_form_id" name="add_form_id" action= "<?php echo base_url('question_paper/manage_model_qp/add_qp_data/4'); ?>">
			<div class="control-group">
			    <p class="control-label" for="inputEmail">Question Paper Title<font color="red"><b>*</b></font> :</p>
			    <div class="controls">
				<textarea class="required qpaper_title " name="qp_title" id="qp_title" style="margin: 0px; width: 889px; height: 60px;" rows="3" cols="20" placeholder="Enter Model Question Paper Title"></textarea>
			    </div>
			</div>
			<div class="row-fluid">
			    <div class="span12">
				...
				<div class="span3">
					...
					<div class="controls">
					    <input type="text" id="total_duration" name="total_duration" class="input-mini required total_duration" placeholder="in hours">
					</div>
				    </div>
				</div>
				...
				<div class="span5">
					...
					<div class="controls">
					    <input class="required course_name" type="text" id="course_name" name="course_name" value="<?php echo $course_title[0]['crs_title'] . '  -  (' . $course_title[0]['crs_code'] . ')' ?>" style="width:320px;" readonly />
					</div>
				    </div>
				</div>
				...
				<div class="span3">
					...
					<div class="controls">
					    <input type="text" id="max_marks" name="max_marks" class="input-mini required max_marks numeric" value ="<?php echo $qp_mq_data[0]['qpf_max_marks']; ?>">
					</div>
				    </div>
				</div>
			    </div>
			...
			<div class="control-group">
			    ...
			    <div class="controls">
				<textarea class="required qp_notes " name="qp_notes" id="qp_notes" style="margin: 0px; width: 889px; height: 40px;" rows="3" cols="20" placeholder="Enter Question Paper note here"><?php echo $qp_mq_data[0]['qpf_notes']; ?></textarea>
			    </div>
			</div>
			<div id="qp_unit_table">
				...
				?>
    				...
    				<div class="span12">
    				    <div class="controls">
    					<center> 
    					    <h4><?php echo $unit_details['qpf_unit_code']; ?></h4>
    					    <input type="hidden" name="unit_code_<?php echo $unit_counter; ?>" id="unit_code_<?php echo $unit_counter; ?>" value="<?php echo $unit_details['qpf_unit_code']; ?>" />
    					    <input type="hidden" id="total_main_question_<?php echo $unit_counter; ?>" name="total_main_question_<?php echo $unit_counter; ?>" class="input-mini required total_main_question_" value="<?php echo $unit_details['qpf_num_mquestions']; ?>"/>
    					</center>
    					<center>
    				...
    				<div class="span12">
    					...
    					<div class="control-group pull-left">
    					    ...
    					    <div class="controls">
    						<input type="text" id="total_question_<?php echo $unit_counter; ?>" name="total_question_<?php echo $unit_counter; ?>" class="input-mini required total_question" value="<?php echo $unit_details['qpf_num_mquestions']; ?>" readonly />
    					    </div>
    					</div>
    				    </div>
    				    <div class="span6 ">
    					<div class="control-group pull-right">
    					    ...
    					    <div class="controls">
    						<input type="text" id="attempt_question_<?php echo $unit_counter; ?>" name="attempt_question_<?php echo $unit_counter; ?>" class="input-mini required attempt_question numeric total_marks_validation">
    					    </div>
    					</div>
    				    </div>
    				</div>
					...
					foreach ($qp_mq_data as $mq_data) {
						...
						?>
	    					...
	    					<td style="white-space:nowrap;" class="textwrap">
	    					    <input type="checkbox" name="unit_<?php echo $unit_counter; ?>_<?php echo $mq_counter; ?>" id="unit_<?php echo $unit_counter; ?>_<?php echo $mq_counter; ?>" class="unit_<?php echo $unit_counter; ?>" value="1"></input> &nbsp; <input type="text" name="ques_nme_<?php echo $mq_counter; ?>_1" id="ques_nme_<?php echo $mq_counter; ?>_1" value="<?php echo $mq_data['qpf_mq_code'] . '-' . $counter; ?>" class="input-mini ques_nme_<?php echo $mq_counter; ?>" readonly />
	    					    <input type="hidden" name="question_name_<?php echo $mq_counter; ?>_1" id="question_name_<?php echo $mq_counter; ?>_1" value="<?php echo 'Q_No_' . $mq_counter . '_' . $counter; ?>" class="input-mini question_name_<?php echo $mq_counter; ?>" readonly />
	    					</td>
	    					<td style="width: 43%;">
	    					    <textarea class="required text_area " name="question_<?php echo $mq_counter; ?>_1" id="question_<?php echo $mq_counter; ?>_1" style="margin: 0px; width: 551px; height: 40px;" ></textarea>
							...
							<?php if ($qp_entity_config['entity_id'] == 6) { ?>
		    					<td>
		    					    <select onmouseover="tool_tip_on(this.id);" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="" name="po_list_<?php echo $mq_counter; ?>_1" id="po_list_<?php echo $mq_counter; ?>_1" class="input-small required po_list_data">
		    						<option value="" abbr="Select CO">Select</option>
		    					    </select>
		    					</td>
							<?php } ?>
		...
		<?php } ?>
							<?php if ($qp_entity_config['entity_id'] == 23) { ?>
		    					<td>
		    					    <select onmouseover="tool_tip_on(this.id);" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="" name="bloom_list_<?php echo $mq_counter; ?>_1" id="bloom_list_<?php echo $mq_counter; ?>_1" class="input-small required bloom_list_data">
	    ...
	    ?>
	    					...
	    					<td>
	    						...
	    						<button class="btn btn-primary add_subque error_add" type="button" id="add_subque_<?php echo $mq_counter; ?>" name="add_subque_<?php echo $mq_counter; ?>" abbr="QNO_<?php echo $mq_counter; ?>_a"><i class="icon-plus-sign icon-white"></i></button>
	    					    </div>
	    					    <span></span>
	    					</td>
	    				    </tr>
	    				    ...
	    				    <tr id="sub_que_ref_div_<?php echo $mq_counter; ?>" >
					...
					?>
    				    <tr id="ref_add_main_<?php echo $unit_counter; ?>"><tr>
    				</tbody>
    			    </table>
    			    <div class ="pull-right">
    				<input type="hidden" name="unit_total_marks_<?php echo $unit_counter; ?>" id="unit_total_marks_<?php echo $unit_counter; ?>" value="<?php echo $unit_details['qpf_utotal_marks']; ?>"  class="input-mini"/>
    			    </div>
    			    <!--<div class="row-fluid">
    			    <div class="span12">
    				      <div class="control-group pull-right">
    					    <div class="controls">
    					      <button name="main_que_<?php //echo $unit_counter;  ?>" id="main_que_<?php //echo $unit_counter;  ?>" type="button" unit_data="hi" abbr="unit_<?php //echo $unit_counter;  ?>" class="btn btn-primary add_main_que"><i class="icon-plus-sign icon-white"></i>Add Main Question </button>
    					    </div>
    				      </div>
    		    </div>
        </div>-->
			...
			<div class="pull-right">       
			    ...
			    <a href= "<?php echo base_url('question_paper/manage_model_qp'); ?>" class="btn btn-danger"><i class="icon-remove icon-white"></i><span></span> Cancel</a>
			</div><br><br>
		    </form>
		</div>
...
<script src="<?php echo base_url('twitterbootstrap/js/custom/question_paper/model_qp.js'); ?>" type="text/javascript"></script>