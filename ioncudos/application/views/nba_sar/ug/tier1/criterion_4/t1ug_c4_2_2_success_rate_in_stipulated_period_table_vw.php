...
/**
 * Description          :   View for NBA SAR Report - Section 4.2.1 (TIER I) - Students' Performance success rate in stipulated period table.
 * Created              :   17-12-2016
...
$table .= '</table><p>Average SI : ' . $average_si[0]['avg_si'] . '</p><p>Success rate : ' . 5 * $average_si[0]['avg_si'] . '</p>';
echo $table;
/*
 * End of file t1ug_c4_2_2_success_rate_in_stipulated_period_table_vw.php 
 * Location: .nba_sar/ug/tier1/t1ug_c4_2_2_success_rate_in_stipulated_period_table_vw.php
 */
?>