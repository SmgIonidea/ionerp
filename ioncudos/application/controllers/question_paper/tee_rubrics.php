<?php
/**
 * Description	:	Tee Rubrics Definition Controller
 * 					
...
class Tee_rubrics extends CI_Controller {
	
	function __construct() {
        // Call the Model constructor
        parent::__construct();
        $this->load->model('question_paper/tee_rubrics/tee_rubrics_model');
	...
	/*
         ...
         */
	public function tee_add_edit_rubrics($pgm_id=NULL, $crclm_id=NULL, $term_id=NULL, $crs_id = NULL, $qpd_type=NULL){
            $meta_data = $this->tee_rubrics_model->meta_data_details($crclm_id,$term_id,$crs_id); // get the meta data
            ...
            $this->load->view('question_paper/tee_rubrics/tee_add_edit_rubrics_vw', $data);
        ...
        public function generate_scale(){
                ...
                $rubrics_result = $this->tee_rubrics_model->rubrics_type_details($data);
                $co_list  = $this->tee_rubrics_model->get_co_list($data['crs_id']);
		...
		$output = $this->load->view('question_paper/tee_rubrics/tee_criteria_range_vw', $data);
        ...
        public function save_criteria_details(){
           ...
           $save_rubrics = $this->tee_rubrics_model->save_rubrics_data($criteria,$co_list,$criteria_desc,$range,$range_name,$selected_radio_entity_id,$selected_rubrics_type,$crclm_id,$term_id,$crs_id,$pgm_id);
        ...
        public function edit_save_criteria_details(){
           ...
           $save_rubrics = $this->tee_rubrics_model->edit_save_rubrics_data($criteria,$co_list,$criteria_desc,$range,$range_name,$ao_method_id,$qpd_id);
         ...
         * @return:
         */
        public function tee_rubrics_edit_data($pgm_id=NULL, $crclm_id=NULL, $term_id=NULL, $crs_id=NULL, $qpd_type=NULL, $qpd_id=NULL, $ao_method_id=NULL){
                    $meta_data = $this->tee_rubrics_model->meta_data_details($crclm_id,$term_id,$crs_id); // get the meta data
                    $chek_qp_roll_out = $this->tee_rubrics_model->check_qp_roll_out($qpd_id);
                    $criteria_count = $this->tee_rubrics_model->criteria_count($ao_method_id); // criteria count taken to dispaly finalize rubrics button in view papge
                    $range_count = $this->tee_rubrics_model->range_count($ao_method_id); // range count is taken to display the regenarate button in view papge.
		...
		$c = $data['colspan_val'] + 2;
                ...
                $this->load->view('question_paper/tee_rubrics/tee_add_edit_rubrics_edit_vw', $data);
        ...
        public function rubrics_list_table($ao_method_id,$qpd_id){
            $get_rubrics_details = $this->tee_rubrics_model->get_saved_rubrics($ao_method_id);
            $chek_qp_roll_out = $this->tee_rubrics_model->check_qp_roll_out($qpd_id); // Check Question question paper is created or not
     ...
     /*
        ...
        public function edit_rubrics_criteria(){
             ...
             $ao_method_id = $this->input->post('ao_method_id');
             $crs_id = $this->input->post('crs_id');
             $edit_criteria = $this->tee_rubrics_model->edit_rubrics_criteria($criteria_id,$ao_method_id,$crs_id);
             $co_list_array = array();
        ...
        public function update_rubrics_criteria(){
            ...
            $update_rubrics_criteria = $this->tee_rubrics_model->update_rubrics_criteria($criteria_id,$criteria,$ao_method_id,$criteria_desc_id_array,$criteria_desc_array,$co_list_id_array);
     ...
     public function generate_question_paper(){
        ...
        $ao_method_id = $this->input->post('ao_method_id');
        $qpd_id = $this->input->post('qpd_id');
        $generate_question_paper = $this->tee_rubrics_model->generate_question_paper($ao_method_id,$qpd_id,$crclm_id,$term_id,$crs_id);
...
public function delete_qp_force_insert_criteria(){
    $qpd_id = $this->input->post('qpd_id');
    $delete_qpd_data = $this->tee_rubrics_model->delete_qpd_data($qpd_id);
...
/*
        ...
        public function regenerate_rubrics_scale(){
                ...
                $rubrics_result = $this->tee_rubrics_model->regenerate_rubrics_scale($data);
        ...
        public function delete_criteria(){
            ...
            $ao_method_id = $this->input->post('ao_method_id');
            $qpd_id = $this->input->post('qpd_id');
            $delete_criteria = $this->tee_rubrics_model->delete_rubrics_criteria($criteria_id, $ao_method_id);
...
public function pdf_report_rubrics_list_table($ao_method_id,$qpd_id){
   ...
   // $check_qp_created = $this->cia_rubrics_model->check_question_paper_created($ao_id); // Check Question question paper is created or not
    $meta_data = $this->tee_rubrics_model->pdf_report_meta_data($qpd_id); // Check Question question paper is created or not
 ...
 * @return:
 */
public function delete_tee_rubrics_data(){
    $ao_method_id = $this->input->post('ao_method_id');
    $qpd_id = $this->input->post('qpd_id');
    $delete_tee_details = $this->tee_rubrics_model->delete_tee_rubrics_details($qpd_id,$ao_method_id);
 ...
 * @return:
 */
public function check_tee_rubrics_rollout(){
    $crs_id = $this->input->post('crs_id');
    $delete_tee_details = $this->tee_rubrics_model->check_rubrics_rollout($crs_id);
...
//    $delete_qp = $this->tee_rubrics_model->delete_qp($ao_id);
//    if($delete_qp == true){
//        echo 'true';
//    }else{
//        echo 'false';
