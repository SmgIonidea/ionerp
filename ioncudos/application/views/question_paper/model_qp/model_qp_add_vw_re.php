...
================================================== -->
		...
		<div class="bs-docs-example ">
			...
			<div class="brand-custom cursor_pointer" >
			    <h5> <a class="brand-custom cursor_pointer" data-toggle="collapse" href="#add_form_id" style="text-decoration:none;"> 
				    &nbsp;<i class="icon-chevron-down icon-black"  data-toggle="collapse" > </i>
				    <b> <?php echo "Add TEE Model Framework"; ?></b></a></h5>
				    <!--  <button "button" href="#" id='edit' class="  pull-right"><i class="icon-edit icon-white" > </i></button>-->
			</div>
		    </div>	
		    <br>
				...
				<table id="expense_table" cellspacing="0" cellpadding="0" class="table table-bordered table-hover"  aria-describedby="example_info">
				    ...
				    <tbody>
						<tr>
							...
							<td><input type="text" id="ques_no_01" name="ques_no_01" maxlength="255" required class=" text_align_right allownumericwithoutdecimal  "></td>
							<td><input type="text" id="marks_01" name="marks_01"  class="unit_max_marks" maxlength="11" required class=" text_align_right allownumericwithoutdecimal "/></td>                
							<td>&nbsp;</td>
						</tr>
				    </tbody>
				</table>
			...
			<div id="unit_defined_fm" class="dataTables_wrapper" role="grid" style="display:none">
                                    <div class="navbar">
                                        <div class="">
                                            <h5 style="color:#0088cc"><u><?php echo "Manage Section / Parts (Units)  Distribution"; ?></u></h5>
                                        </div>
                                    </div>
                                    <table class="table table-bordered table-hover dataTable" id="Edit_t" aria-describedby=""  >
                                        ...
                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            ...
                                            <?php $i = 1;
                                            foreach ($qp_unit_data as $topic) {
                                                ?>
                                                <tr  data-toggle="collapse" class="table_row">
													<td class="text_align_right allownumericwithoutdecimal"><?php echo $i; ?></td>
                                                    <td><?php echo $topic['qpf_unit_code']; ?></td>
                                                    <td class="text_align_right allownumericwithoutdecimal" ><?php echo $topic['qpf_num_mquestions']; ?></td>
                                                    <td class="text_align_right allownumericwithoutdecimal"><?php echo $topic['qpf_utotal_marks']; ?></td>
    ...
    <div class="row-fluid">
	<div class="span12">							
	    <a href= "<?php echo base_url('question_paper/manage_model_qp'); ?>" id="cancel_button"><b class="btn btn-danger btn-sm pull-right"><i class="icon-remove icon-white"></i><span></span>Close</b></a>																	
	</div>
    </div>
    <!--==============================================================================================================================================================-->
    ...
    <!--<td><textarea></textarea></td>-->
			...
			<div class="control-group">
				...
				<div class="form-inline pull-right">
				    ...
				    <input type="text" id="qp_max_marks" name="qp_max_marks" class="input-mini required max_marks_validation" value="<?php echo $qp_mq_data[0]['qpf_gt_marks']; ?>"  />
				</div>		
			    </div>		
			</div>
		    </div><br/><br/>		
...
<div id="myModal_qp" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
	...
	<div class="modal-footer">
		...
		<a href= "<?php echo base_url('question_paper/manage_model_qp'); ?>" id="del"class="btn btn-danger"><i class="icon-remove icon-white"></i><span></span> Cancel</a>								
	</div>
</div>
