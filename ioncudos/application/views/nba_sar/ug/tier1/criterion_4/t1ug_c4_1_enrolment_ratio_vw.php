<?php
/**
 * Description          :   View for NBA SAR Report - Section 4.1 (TIER 1) - Enrolment Ratio 
 * Created              :   22-4-2016
 * Author               :   Arihant Prasad
 * Modification History : 
 * Date                     Modified By 			Description
 * 20-5-2016                Mritunjay B S               Displaying the PO Attainment.
 * 16-12-2016               Shayista Mulla              Indentation and changes in html to export
  --------------------------------------------------------------------------------------------------------------- */
?>
<?php
if (!$is_export) {
...
<!-- End of file t1ug_c4_1_enrolment_ratio_vw.php 
        Location: .nba_sar/ug/tier1/t1ug_c4_1_enrolment_ratio_vw.php -->
