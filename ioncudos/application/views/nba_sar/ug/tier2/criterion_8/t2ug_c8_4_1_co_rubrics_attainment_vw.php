<?php
/**
 * Description          :   View for NBA SAR Report - Section 8.4.1 (TIER 2) - CO attainment qpd rubrics
 * Created              :   26-12-2016
...
if (!$is_export) {
            ...
            <div class="span4">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        echo form_dropdown('curriculum_list__' . $view_id . '_' . $nba_report_id . '_rubrics', $select_curriculum_options_rubrics, $rubrics_curriculum_list_selected, 'id="curriculum_rubrics_attain_8" class="filter" autofocus = "autofocus"');
                        ?>
                    </div>
                </div>
            </div>
            <div class="span4">
                <div class="control-group">
                    ...
                    <div class="controls">                      
                        ...
                        echo form_dropdown('term_list__' . $view_id . '_' . $nba_report_id . '_rubrics', $select_term_options_rubrics, $rubrics_term_list_selected, 'id="term_rubrics_list_8" class="filter term_list" autofocus = "autofocus"');
                        ?>
            ...
            <div class="span4">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        echo form_dropdown('course_list__' . $view_id . '_' . $nba_report_id . '_rubrics', $select_course_options_rubrics, $rubrics_course_list_selected, 'id="course_rubrics_list_8" class="filter course_list" autofocus = "autofocus"');
                        ?>
                    </div>
                </div>
            </div>
    ...
    <div class="span12">
        <input type="button" id="generate_8_4_1_rubrics_assessment_report"  class="btn btn-success pull-right" value="Generate Report" />
    </div>
<?php } ?>
<div class="row-fluid">
...
<!-- End of file t2ug_c8_4_1_co_rubrics_attainment_vw.php 
        Location: .nba_sar/ug/tier2/criterion_8/t2ug_c8_4_1_co_rubrics_attainment_vw.php -->