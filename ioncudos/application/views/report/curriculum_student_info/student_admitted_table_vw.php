...
<table class="table table-bordered table-hover " id="example1" aria-describedby="example_info">
    <thead align = "center">
        <tr class="gradeU even" role="row">
            ...
            <th class="header headerSortDown" role="columnheader" tabindex="0" aria-controls="example" aria-sort="ascending"  style="width:15%;">Entrance Exam</th>                         
            <th class="header headerSortDown" role="columnheader" tabindex="0" aria-controls="example" aria-sort="ascending"  style="width:10%;">Category</th>
            <th class="header headerSortDown" role="columnheader" tabindex="0" aria-controls="example" aria-sort="ascending"  style="width:20%;">Gender</th>
            <th class="header headerSortDown" role="columnheader" tabindex="0" aria-controls="example" aria-sort="ascending" style="width:10%;">Intake</th>
            <th class="header headerSortDown" role="columnheader" tabindex="0" aria-controls="example" aria-sort="ascending" style="width:10%;">Rank range</th>
        ...
        <tr>
            <td valign="top">
                <p>Entrance Exam : <font color="red">*</font><br/>
                    <select id="ent_exam" name="ent_exam" class="required">
            ...
            <td valign="top">
                <p>Category : <font color="red">*</font><br/>
                    <select  id="caste" name="caste" class="required">
        ...
        <tr>
            <td valign="top" style="padding-right:10px;">
                <p>
                    ...
                    <input type="text" name="num_intake" id="num_intake" class="required numbers text-right"></input>
                </p>
            </td>
            <td valign="top" style="padding-right:10px;">
                Rank range from :<br/>
                <input type="text" name="add_rank_from" id="add_rank_from" class="numbers text-right"></input>
            </td>
            <td valign="top">
                Rank range to :<br/>
                <input type="text" name="add_rank_to" id="add_rank_to" class="numbers text-right"></input></p>    
            </td>
        </tr>
    </table>
...
<script src="<?php echo base_url('twitterbootstrap/js/custom/report/curriculum_student_admitted.js'); ?>" type="text/javascript"></script>
<!-- End of file student_admitted_table_vw.php 
                        Location: report/curriculum_student_info/student_admitted_table_vw.php  -->