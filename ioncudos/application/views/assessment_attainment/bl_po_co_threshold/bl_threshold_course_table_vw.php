	...
	<form id="bl_course_table_view" name="bl_course_table_view" method="POST">
		...
		<table id="bloom_level_table" name="bloom_level_table" class="table table-bordered" style="width:100%">
			...
			<tr>
				...
				<th style="width:180px;"> Action Verbs </th>
			...
			foreach($bloom_level_threshold as $bloom_level) { ?>
				<tr>
					...
					<?php  if($mte_flag == 1){?>
						<td>
							<center><input type="text" maxlength="2" id="mte_min_data" name="mte_min_data[]" class="text_align_right input-mini onlyDigit mte" value="<?php echo $bloom_level['mte_bloomlevel_minthreshhold']; ?>"></center>
						</td>
					<?php } ?>
					<td>
