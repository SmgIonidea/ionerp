        ...
        <div class="container-fluid">
		   ...
		   <div class="row-fluid">
			   ...
			   <div class="bs-docs-example ">
                    ...
                    <!-- Contents
    ================================================== -->
			<input type="hidden" name="qpd_type_data" id="qpd_type_data" value="<?php echo $qpd_type;?>"/>
                    <section id="contents">
                        <div class="bs-docs-example ">
                            <!--content goes here-->	
								...
								<div class="span12">
									...
									<div class="span3">
										  <div class="control-group">
											...
											<div class="controls">
											  <input type="text" id="total_duration" name="total_duration" class="input-mini required total_duration" placeholder="in hours" value="">
											</div>
										  </div>
									</div>
										...
										<div class="span2">
										  <div class="control-group">											
											<div class="">Grand Total <font class="font_color">*</font> :
											  <input type="text" id="Grand_total" name="Grand_total" class="input-mini required max_marks" value=""/>
											</div>
										  </div>
									</div>
									...
									<table id="expense_table" cellspacing="0" cellpadding="0" class="table table-bordered table-hover"  aria-describedby="example_info">
										...
										<tbody>
											<tr>
												...
												<td><input type="text" id="marks_01" name="marks_01" maxlength="11" class="required unit_max_marks"/></td>                
												<td>&nbsp;</td>
											</tr>
										</tbody>
									</table>
...
<div class="row-fluid" style="display:none;">   
  ...
  <div class="row-fluid">
										<div class="span12">							
											<?php if($qpd_type == 4) {?>  <a href= "<?php echo base_url('question_paper/manage_model_qp'); ?>" id="cancel_button"><b class="btn btn-danger btn-sm pull-right"><i class="icon-remove-sign icon-white"></i><span></span> Close</b></a>	<?php } else if($qpd_type == 5) {?>
											<a href= "<?php echo base_url('question_paper/tee_qp_list'); ?>" id="cancel_button"><b class="btn btn-danger btn-sm pull-right"><i class="icon-remove-sign icon-white"></i><span></span> Close</b></a>	<?php } ?>
										</div>
									</div>
		<!--==============================================================================================================================================================-->
	  ...
	  <?php //Generating Main Questions with reference to the QP framework
					...
					<input type="hidden" name="qpf_id" id="qpf_id" value="" />
					<input type="hidden" name="qpd_id" id="qpd_id" value="<?php echo $qpd_id ; ?>" />
					...
					<input type="text" name="FM" id="FM" value="<?php if(!empty($data[0]['FM'])){echo $data[0]['FM'];}?>" />
					<input type="text" name="model_qp_existance" id="model_qp_existance" value="<?php echo $model_qp_existance;?>"/>
									...
									<div class="control-group">
										<div class=" controls">
											<div class="form-inline pull-right">
												...
												<input type="text" id="qp_max_marks" name="qp_max_marks" class="input-mini required max_marks_validation" value="" readonly />
											</div>		
										</div>		
									</div>
									</div><br/><br/>		
...
<!--=======================================================================================================================================--->
				<!--Do not place contents below this line-->
								...
								<input type="radio" name="FM" value="4"/>&nbsp;&nbsp;&nbsp;<b>With Frame Work<b>
								
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								
								<input type="radio" name="FM" value="0"/>&nbsp;&nbsp;&nbsp;<b>WithOut  Frame Work<b>
     ...
     <div id="model_qp_actual_qp" class="modal hide fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="myModal4" data-backdrop="static" data-keyboard="false"></br>
			...
			<div class="modal-footer">
				...
				<a class="btn btn-danger notbold" data-dismiss="modal" id="click_cancel" ><i class="icon-remove-circle icon-white"></i> Cancel </a>
	...
	<script type="text/javascript" src = "<?php echo base_url('twitterbootstrap/js/custom/curriculum/jquery.nailthumb.1.1.js'); ?> "> </script>
		...
		<script src="<?php echo base_url('twitterbootstrap/js/custom/question_paper/model_qp_without_fm.js'); ?>" type="text/javascript"> </script>
