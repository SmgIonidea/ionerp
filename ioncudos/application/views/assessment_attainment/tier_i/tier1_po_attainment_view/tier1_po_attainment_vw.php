 ...
 * 29-10-2014		Jyoti					Added snippets for graph display
 * 20-11-2014		Jyoti					Changed display of dropdown in the page display, PDF creation
 * 07-10-2015		Shivaraj B				Changed Display and Procedure calls in PO Level Attainment for Direct  
  & Indirect Attainment
 * 11-03-2016		Shivaraj B				Removed course attainment graph & data from display page
  ------------------------------------------------------------------------------------------------------------------------
 */
?>
<!--head here -->
                ...
                <div class="bs-docs-example" >
                    ...
                    <div class="navbar">
                        <div class="navbar-inner-custom">
                            <?php echo $this->lang->line('student_outcome_full'); ?> <?php echo $this->lang->line('student_outcome'); ?> Attainment (<?php echo $this->lang->line('entity_cie'); ?> & <?php echo $this->lang->line('entity_see'); ?>)
                        </div>
                    </div>

                    <form class="form-horizontal" method="POST" id="tier1_po_attainment_form" name="tier1_po_attainment_form" action="<?php echo base_url('assessment_attainment/tier1_po_attainment/export_to_doc'); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            <label>Term :<font color='red'>*</font> 
                                                <select id="term" name="term[]" class="example-getting-started term_id required" onchange="display();" style="margin-top:8px;" multiple="multiple">
                                    ...
                                    <!--<td>
                                        <p><label>Type :<font color='red'>*</font> 
                                                <select id="type_data" name="type_data" class="input-medium" onchange="display();">	
                        ...
                        <ul id="myTab" class="nav nav-tabs">
                            ...
                            <li><a href="#extra_curricular_po_direct_report" data-toggle="tab"> Extracurricular / Co-curricular Activity </a></li>
                            <li><a href="#po_indirect_attainment" data-toggle="tab"> Indirect Attainment </a></li>
                            <!-- <li><a href="#po_direct_indirect_report" data-toggle="tab"> Direct and Indirect Attainment </a></li> -->
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="po_direct_attainment">
                                ...
                                <input type="hidden" name="form_name" id="form_name" value="tier1_po_attainment_form" />
                                <input type="hidden" name="export_graph_data_to_doc" id="export_graph_data_to_doc" value="" />
                                <input type="hidden" name="file_name" id="file_name" value="" />
                                <br><br>
                                <div id="po_attainmnet_graph">
                                </div>
                                <div id="po_attainment_tbl_div">
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p><?php echo str_repeat('&nbsp;', 6); ?>
                                                        <!-- <a id="po_direct_indirect_submit" href="#" disabled="disabled" class="btn btn-primary"><i class="icon-ok icon-white"></i> Submit </a>    -->
...
<!--	<form name="survey_form_shv" onsubmit="return survey_form_validation();" id="survey_form_shv" method="POST" action='<?php echo base_url() ?>assessment_attainment/po_level_assessment_data/save_po_survey_attainment'>-->
                                    <div id="direct_indirect_attain_data">
                                        ...
                                        <table class="table table-bordered"  id="add_more_survey_rows">
                                            ...
                                            <!--<th><center>Specific Weightage % : <span class='err_msg'>*</span></center></th>-->
                                            ...
                                            <!--<td><center><input type="text" name="survey_spc_wgt_perc_1"  id="survey_spc_wgt_perc_1" class="spc_wgt" placeholder="%" /></center></td>-->
                                    ...
                                    <input type="hidden" name="da_weightage" id="da_weightage" value />
                                    <input type="hidden" name="ia_weightage" id="ia_weightage" value />
                                    <input type="hidden" name="threshold_da_attainment" id="threshold_da_attainment" value />
                                    <input type="hidden" name="threshold_ia_attainment" id="threshold_ia_attainment" value />
                                    <input type="hidden" name="average_da_attainment" id="average_da_attainment" value />
                                    <input type="hidden" name="average_ia_attainment" id="average_ia_attainment" value />
                                    <input type="hidden" name="po_id_val" id="po_id_val" value />
                                    <input type="hidden" name="threshold_po_overall_attainment" id="threshold_po_overall_attainment" value />
                                    <input type="hidden" name="average_po_overall_attainment" id="average_po_overall_attainment" value />
								...
								<button style="display:none;" type="button" id="po_finalize" name="po_finalize" class="po_finalize btn btn-success pull-right"><i class="icon-ok icon-white"></i> PO Finalize Attainment</button>
                                <!-- </form> -->
                            </div><!--Div ends-->
                            <!-- Tab Four Extra curricular activity po direct attainment div -->
                            <div class="tab-pane fade" id="extra_curricular_po_direct_report">
                                
                                <div id="extra_crricular_activity_display_div">
                                     <label>Activity: <span style="color:red;">*</span>
                                    <select name="activity_data" id="activity_data" class="activity_data form-control input-medium">
                                ...
                                <br> 
                                <div id="extra_crricular_activity_export_div"></div>
                                <br> 
                                <div style="display: block; position: relative; height: 300px;" class="row-fluid jqplot-target" id="extra_crricular_po_attain_chart1">
                                    
                                </div>
                                <br>
                                <div id="extra_crricular_po_attain_table_plot_div" class="extra_crricular_po_attain_table_plot_div">
                ...
                <!-- Tier1 Course wise PO Attainmnet Modal -->
                 <div id="tier1_po_attainmnet_modal" class="modal hide fade tier1_po_attainmnet_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" 
                     style="width: 80%;position: fixed;margin: 0px auto;top: 5%;left: 10%;right: 10%;bottom:10%;" data-controls-modal="myModal1" data-backdrop="static" data-keyboard="false" data-width="1200">
                    <div class="modal-header">
						<div class="navbar">
								<div class="navbar-inner-custom">
									<?php echo $this->lang->line('student_outcome_full'); ?> Attainment by individual Courses.
					...
					<div class="span12">
						<div class="span10">
							...
							<div id="po_statement_div"></div>
						</div>
						<div class="span2">
						<button type="reset" class="cancel btn btn-danger pull-right" data-dismiss="modal"><i class="icon-remove icon-white"></i> Close</button>
						</div>
					</div>
                        
                       <!-- <div class="span12">-->
                            <div class="span12" id="po_attainment_chart_div" style="height: 250px; position: relative;">
                            </div>
                            <div class="span12" id="crs_title_crs_code_tble">
                            </div>
							
                       <!-- </div>-->
						<div class="span12" id="course_po_attainment_note"></div>
                        <div class="modal-body" id="drilldown_content_display" width="100%" height="auto">
                            <div id="course_po_attainment_chart"></div>
                        </div>
...
<script type="text/javascript" src="<?php echo base_url('twitterbootstrap/js/custom/assessment_attainment/tier_i/tier1_po_attainment.js'); ?>"></script>
...
<!-- <script type="text/javascript" src="<?php echo base_url('twitterbootstrap/js/EnhancedLegendRenderer.min.js'); ?>"></script>-->
...
<!-- <script src="twitterbootstrap/js/jqplot.enhancedLegendRenderer.js" ></script>-->
<script>
