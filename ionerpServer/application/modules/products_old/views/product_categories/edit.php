...
$form_action= "/products/product_categories/edit";
...
echo form_error("category_id"); echo form_input($attribute); ?><div class = 'form-group row'>
...
echo form_error("cat_name"); echo form_input($attribute); ?>
                                </div>
                           </div>
...
echo form_error("cat_position"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("cat_parent_id"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("cat_title");echo form_textarea($attribute,$value); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("cat_description");echo form_textarea($attribute,$value); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("cat_created_date"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("cat_created_by"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("cat_modified_date"); echo form_input($attribute); ?>
                                </div>
                           </div>
<div class = 'form-group row'>
...
echo form_error("cat_modified_by"); echo form_input($attribute); ?>
                                </div>
                           </div>
