...
/**
 * Description          :	Controller logic for Criterion 2 (TIER 1) - Teaching Learning Process.
 * Created              :	08-11-2016
 * Author               :	Jyoti
...
class T1ug_c2_teachingLearningProcess extends CI_Controller {
    ...
    /**
     * Function to display Question Paper - section 2.2.2,3.2.1
     * @parameters  :
     * @return      : view
     */
    public function get_qp($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($curriculum_id) {
            $this->data['course_list_data'] = $this->t1ug_c2_teaching_process_model->list_curriculum_courses($crclm_id);
        ...
        return $this->load->view('nba_sar/ug/tier1/criterion_2/t1ug_c2_2_2_qp_vw', $this->data, true);
    }
    ...
    public function display_curriculum_courses() {
        ...
        $data ['course_list'] = $this->t1ug_c2_teaching_process_model->list_curriculum_courses($crclm_id);
    ...
    public function display_course_qp() {
        ...
        $data ['qp_list'] = $this->t1ug_c2_teaching_process_model->list_course_qp($crclm_id, $crs_id);
    ...
    public function generate_model_qp_modal_tee() {
        ...
        echo $this->load->view('nba_sar/ug/tier1/criterion_2/t1ug_c2_2_2_qp_display_vw', $model_qp_data);
    }
    ...
    public function get_qp_course_outcome($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if (@$qpd_id) {
            $this->data['course_outcome'] = $this->t1ug_c2_teaching_process_model->getCOLevelMarksDistribution($course_id, $qpd_id);
        }

        return $this->load->view('nba_sar/ug/tier1/criterion_2/t1ug_c2_2_2_qp_course_outcome_vw', $this->data, true);
    }
    ...
    public function get_qp_bloom_level($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if (@$qpd_id) {
            $this->data['bloom_level'] = $this->t1ug_c2_teaching_process_model->getBloomsLevelMarksDistribution_custom($course_id, $qpd_id);
        }

        return $this->load->view('nba_sar/ug/tier1/criterion_2/t1ug_c2_2_2_qp_bloom_level_vw', $this->data, true);
    }
    ...
    public function course_co_planned_coverage() {
        $crs_id = $this->input->post('crs_id');
        $qpd_id = $this->input->post('qpd_id');
        $course['co_outcome'] = $this->t1ug_c2_teaching_process_model->getCOLevelMarksDistribution($crs_id, $qpd_id);
    ...
    public function course_bloom_level_marks_distribution() {
        $crs_id = $this->input->post('crs_id');
        $qpd_id = $this->input->post('qpd_id');
        $course['blooms_level_marks'] = $this->t1ug_c2_teaching_process_model->getBloomsLevelMarksDistribution_custom($crs_id, $qpd_id);
    ...
    public function get_co_po_mapping($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        $this->data['is_export'] = $is_export;
        return $this->load->view('nba_sar/ug/tier1/criterion_2/t1ug_c2_2_3_student_quality_projects_vw', $this->data, true);
    }
    ...
    public function get_term_list() {
        $crclm_id = $this->input->post('curriculum');
        $crclm_list = $this->t1ug_c2_teaching_process_model->get_term_list($crclm_id);
    ...
    public function get_course_list() {
        $crclm_id = $this->input->post('crclm_id');
        $term_id = $this->input->post('term_id');
        $course_list = $this->t1ug_c2_teaching_process_model->get_course_list($crclm_id, $term_id);
    ...
    public function get_quality_student_project($crclm_id = NULL, $course_id = NULL) {
        ...
        if ($crclm_id == NULL) {
            ...
            $co_po_map = $this->t1ug_c2_teaching_process_model->get_quality_student_project($crclm_id, $course_id);
    ...
    public function get_program_companies_visited($pgm_id = NULL) {
        ...
        $companies_visited = $this->t1ug_c2_teaching_process_model->fetch_program_companies_visited($pgm_id);
    ...
    public function get_industry_internship($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        return $this->load->view('nba_sar/ug/tier1/criterion_2/t1ug_c2_2_4_initiative_industry_intership_vw', $this->data, true);
    }
    ...
    public function display_industry_internship($curriculum = NULL) {
        ...
        if ($this->input->post('curriculum')) {
            ...
            $industry_internship = $this->t1ug_c2_teaching_process_model->fetch_industry_internship($curriculum);
...
/* * End of file t1ug_c2_teachingLearningProcess.php
 * Location: .nba_sar/t1ug_c2_teachingLearningProcess.php 
 */
?>