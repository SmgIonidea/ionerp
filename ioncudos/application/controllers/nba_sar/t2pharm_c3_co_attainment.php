...
/**
 * Description          :   Controller logic for NBA SAR Report - Section 3.2 and 3.3 (Pharmacy TIER II) - Attainment of co and po.
 * Created              :   18-06-2017
...
class T2pharm_c3_co_attainment extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('nba_sar/nba_sar_list_model');
        $this->load->model('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_co_attainment_model');
    }
    ...
    public function attainment_co($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($crclm_id) {
            $this->data['term_list'] = $this->t2pharm_c3_co_attainment_model->get_term_list($crclm_id);
        ...
        $this->data['assessment_methods'] = $this->t2pharm_c3_co_attainment_model->pgm_assessment_methods($pgm_id);
        $this->data['is_export'] = $is_export;

        return $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_1_co_attainment_vw', $this->data, true);
    }

    /**
     * Function to form Term List - section 3.2.1
     * @parameters  :
     * @return      : Term List
     */
    public function get_term_list() {
        $crclm_id = $this->input->post('curriculum');
        $crclm_list = $this->t2pharm_c3_co_attainment_model->get_term_list($crclm_id);
    ...
    /**
     * Function to form Course List - section 3.2.1
     * @parameters  :
     * @return      : course list
     */
    public function get_course_list() {
        ...
        $course_list = $this->t2pharm_c3_co_attainment_model->get_course_list($crclm_id, $term_id);
    ...
    /**
     * Function to get the Assement Occasions of Course for section 3.2.1
     * @parameters  :
     * @return      :  table view for Assement Occasions of Course.
     * */
    public function course_assement_occasions_list($course_id=NULL, $crclm_id=NULL, $term_id=NULL) {
        if ($course_id == NULL) {
            ...
            $assement_list = $this->t2pharm_c3_co_attainment_model->course_assement_occasions_list($course_id, $crclm_id, $term_id);
            $this->data['assement_list'] = $assement_list;
            $content_view = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_1_course_assessment_method_vw', $this->data, true);
            echo $content_view;
        } else {
            $assement_list = $this->t2pharm_c3_co_attainment_model->course_assement_occasions_list($course_id, $crclm_id, $term_id);
            $this->data['assement_list'] = $assement_list;
    ...
    /**
     * Function to display attainment qpd rubrics - section 3.2.1 - 3 
     * @parameters  : 
     * @return      : view
     */
    public function attainment_qpd_rubrics($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($course_id) {
            ...
            $this->data['assessment_occasion_list'] = $this->t2pharm_c3_co_attainment_model->get_course_assessment_occasion($crclm_id, $term_id, $course_id);
        }
        ...
        if ($is_export) {
            $this->data['rubrics_attainment_co_vw'] = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_1_co_rubrics_attainment_vw', $this->data, true);
            return $this->data['rubrics_attainment_co_vw'];
        } else {
            return $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_1_co_rubrics_attainment_vw', $this->data, true);
        }
    }
    ...
    public function co_attainment_qpd_rubrics($course_id = NULL, $crclm_id = NULL, $term_id = NULL, $ao_method_id = NULL) {
        ...
        if ($crclm_id == NULL && $course_id == NULL && $term_id == NULL && $ao_method_id == NULL) {
            ...
            $rubrics_data = $this->t2pharm_c3_co_attainment_model->attainment_qpd_rubrics($crclm_id, $course_id, $term_id, $ao_method_id);
    ...
    public function get_course_assessment_occasion_list() {
        ...
        $term_id = $this->input->post('term_id');
        $course_id = $this->input->post('course_id');
        $assessment_occasion_list = $this->t2pharm_c3_co_attainment_model->get_course_assessment_occasion($crclm_id, $term_id, $course_id);
    ...
    public function all_co_attainment($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            $this->data['attainment_co_vw'] = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_2_all_co_attainment_vw', $this->data, true);
            return $this->data['attainment_co_vw'];
        } else {
            return $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_2_all_co_attainment_vw', $this->data, true);
        }
    }
    ...
    public function display_crs_grid($curriculum=NULL, $selected_courses = NULL) {
        if ($curriculum == NULL) {
            ...
            $content_view = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_2_crs_grid_vw', $this->data, true);
     ...
     * @parameters  : curriculum id ,selected couses id
     * @return      : view
     */
    public function co_target_levels($curriculum = NULL, $selected_courses = NULL) {
        if ($curriculum != NULL && $selected_courses != NULL) {
            $result = $this->t2pharm_c3_co_attainment_model->course_target_level($selected_courses);
            $result_data['course_waise_co_attainment'] = $result['course_wise_co_attainment'];
            $result_vw = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_2_co_target_level_vw', $result_data, true);
            return $result_vw;
        } else {
            ...
            if (!empty($crs_id_array)) {
                ...
                $result = $this->t2pharm_c3_co_attainment_model->course_target_level($crs_ids);
                $result_data['course_waise_co_attainment'] = $result['course_wise_co_attainment'];
                $result_vw = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_2_2_co_target_level_vw', $result_data, true);
                echo $result_vw;
            }
    ...
    public function curriculum_survey_attainment_tools($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if (@$filter_crclm_survey_id) {
            $this->data['survey_list'] = $this->t2pharm_c3_co_attainment_model->get_curriculum_survey_list($pgm_id, @$filter_crclm_survey_id);
        ...
        if ($is_export) {
            $this->data['attainment_co_vw'] = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_3_1_1_curriculum_survey_attainment_tools_vw', $this->data, true);
            return $this->data['attainment_co_vw'];
        } else {
            return $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_3_1_1_curriculum_survey_attainment_tools_vw', $this->data, true);
        }
    }
    ...
    public function fetch_curriculum_survey_attainment_tools($survey_id = NULL) {
        ...
        if ($survey_id) {
            $survey_data = $this->t2pharm_c3_co_attainment_model->fetch_curriculum_survey_attainment_tools($survey_id);
    ...
    /**
     * Function to display the PO and PSO attainment of curriculum - Section 3.3.2
     * @parameters  : 
     * @return      : view
     */
    public function all_po_attainment($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            $this->data['attainment_co_vw'] = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_3_2_all_po_attainment_vw', $this->data, true);
            return $this->data['attainment_co_vw'];
        } else {
            return $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_3_2_all_po_attainment_vw', $this->data, true);
        }
    }

    /**
     * Function to get the course wise po attainment data - section 3.3.2.
    ...
    public function course_wise_po_attainment($curriculum=NULL) {
        if ($curriculum == NULL) {
            $crclm_id = $this->input->post('curriculum');
            $po_data = $this->t2pharm_c3_co_attainment_model->for_all_po_mapping($crclm_id);
            $this->data['po_direct'] = $po_data['po_direct'];
            $this->data['po_indirect'] = $po_data['po_indirect'];
            $view_data = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_3_2_all_po_attainment_display_vw', $this->data, true);
            echo $view_data;
        } else {
            $po_data = $this->t2pharm_c3_co_attainment_model->for_all_po_mapping($curriculum);
            $this->data['po_direct'] = $po_data['po_direct'];
            $this->data['po_indirect'] = $po_data['po_indirect'];
            $view_data = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_3_2_all_po_attainment_display_vw', $this->data, true);
            return $view_data;
    ...
    /**
     * Function to get the Curriculum Survey Attainment - section 3.3.2 - 2
     * @parameters  : 
     * @return      : view
     */
    public function curriculum_survey_attainment($id = '', $nba_sar_id = '', $nba_report_id = '', $other_info = array(), $is_export = 0, $param = '') {
        ...
        if ($is_export) {
            $this->data['attainment_co_vw'] = $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_3_2_curriculum_survey_attainment_vw', $this->data, true);
            return $this->data['attainment_co_vw'];
        } else {
            return $this->load->view('nba_sar/pharm/tier2/criterion_3/t2pharm_c3_3_2_curriculum_survey_attainment_vw', $this->data, true);
        }
    }

    /**
     * Function to get curriculum survey list - section 3.3.2 
     * @parameters  : 
     * @return      : survey list
     */
    public function fetch_curriculum_survey_list() {
        $crclm_id = $this->input->post('crclm_id');
        $pgm_id = $this->input->post('pgm_id');
        $survey_list = $this->t2pharm_c3_co_attainment_model->get_curriculum_survey_list($pgm_id, $crclm_id);
    ...
    /**
     * Function to get the curriculum survey attainment table - section 3.3.2 2
    ...
    public function fetch_curriculum_survey_attainment($survey_id = NULL) {
        ...
        if ($survey_id) {
            $survey_data = $this->t2pharm_c3_co_attainment_model->fetch_curriculum_survey_attainment($survey_id);
            $survey_data = $this->table->generate($survey_data);
            return $survey_data;
        } else {
            $survey_id = $this->input->post('survey_id');
    ...
    /**
     * Function to to clear the store stored filter id's
     * @parameters  : 
    ...
    public function clear_filter() {
        ...
        echo $this->t2pharm_c3_co_attainment_model->clear_filter($nba_sar_id, $filter_nba_sar_view_id, $filter_nba_id);
        exit();
    }
...
/*
 * End of file t2pharm_c3_co_attainment.php 
 * Location: .nba_sar/t2pharm_c3_co_attainment.php
 */
?>