...
$("#submit").click(function () {
    ...
    if (flag) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'nba_sar/curriculum_student_info/check_insert_data',
            data: post_data,
            datatype: "json",
            success: function (data) {
                if (data == 1) {
                    $.ajax({
                        type: "POST",
                        url: base_url + 'nba_sar/curriculum_student_info/insert_student_admitted_data',
                        data: post_data,
                        datatype: "json",
                        success: function (data) {
...
function display_admitted_modal() {
    ...
    $.ajax({type: 'POST',
        url: base_url + 'nba_sar/curriculum_student_info/stud_admitted_details',
        data: post_data,
        dataType: 'json',
        success: function (data) {
            populateTable(data);
...
function populateTable(data) {
    ...
    $('#example1').dataTable(
            {"aoColumns": [
                    ...
                    {"sTitle": "Nationality - State", "mData": "nation_state"},
                    {"sTitle": "Intake", "mData": "num_intake"},
                    {"sTitle": "Opening - Closing Score/Rank", "mData": "rank_range"},
...
$("#update").click(function () {
    ...
    if (flag) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'nba_sar/curriculum_student_info/check_update_data',
            data: post_data,
            datatype: "json",
            success: function (data) {
                if (data == 1) {
                    $.ajax({
                        type: "POST",
                        url: base_url + 'nba_sar/curriculum_student_info/update_student_admitted_data',
                        data: post_data,
                        datatype: "json",
                        success: function (data) {
                            display_admitted_modal();
...
$("#delete_selected").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: base_url + 'nba_sar/curriculum_student_info/student_admitted_details_delete',
        data: post_data,
        datatype: "json",
        success: function (data) {
            display_admitted_modal();
...
//function to show country field.
