            ...
            <section id="contents">
                <div class="bs-docs-example fixed-height" >
                        ...
                        <fieldset>
                            ...
                            <div></br>
                                <table class="table table-bordered table-hover" id="example" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            <th class="header headerSortDown" role="columnheader" tabindex="0" aria-controls="example" aria-sort="ascending"> CO Code </th>
                    ...
                    <div id="myModal_publish" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="myModal_publish" data-backdrop="static" data-keyboard="true">
                        ...
                        <div class="modal-body">
                            ...
                            <p> You will <span class="badge badge-important"> not </span> be able to add, edit, delete after this, to the current set of COs.
                            </p>
                        </div>
                    ...
                    <div id="my_force_delete_modal" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="myModal_publish" data-backdrop="static" data-keyboard="true">
                        ...
                        <div class="modal-body">
                            <p></p>
                            <p> You cannot delete this CO, as it is proceeded for mapping.
                            </p>
                        </div>
                    ...
                    <div id="pre_requisite_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-controls-modal="pre_requisite_modal" data-backdrop="static" data-keyboard="true">
                        ...
                        <div class="modal-body">
                            <div class="row-fluid ">
                                <div class="span4">
                                    <div class="control-group">
                                        <div class="controls" id="pre_requisite_curriculum_name">
                                        </div>
                                    </div>
                                </div>
                                <div class="span4">
                                    <div class="control-group">
                                        <div class="controls" id="pre_requisite_term_name">
                                        </div>
                                    </div>
                                </div>
                                <div class="span4">
                                    <div class="control-group">
                                        <div class="controls" id="pre_requisite_course_name">
                                        </div>
                                    </div>
                                </div>
                                <div class="span12">
                    ...
                    <div id="course_import_modal" class="modal hide fade"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width: 1100px; left: 400px;" data-controls-modal="myModal1" data-backdrop="static" data-keyboard="true">
                        <div class="modal-header">
                            <div class="navbar">
                                <div class="navbar-inner-custom">
                                    Course wise Import of COs, Topics & TLOs
                                </div>
                            </div>
                        </div>
                        <div class="modal-body">
                            <div class="row-fluid ">
                                <div class="span4">
									...
									<font id="place_curriculum_name"> </font>
									</label>
                                </div>

                                <div class="span4">
                                    <label class="control-label" for="inputIcon">Term :
                                    <font class="controls" id="place_term_name"> </font>
									</label>
                                </div>
                                ...
                                <div class="span4">
                                    <label class="control-label" for="inputIcon">Course :
                                        <font class="controls" id="place_course_name"></font>	
                                        </label>
                                </div>
                            ...
                            <div class="row-fluid ">
								<div class="span10">
                                    <div class="control-group">
                                        <label class="control-label" for="inputIcon">Department: <font color="red"> * </font></label>
                                        <div id="place_department_dropdown">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="inputIcon">Program: <font color="red"> * </font></label>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="inputIcon">Curriculum: <font color="red"> * </font></label>
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    <div class="control-group">
                                        <label class="control-label" for="inputIcon">Term: <font color="red"> * </font></label>
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    <div class="control-group">
                                        <label class="control-label" for="inputIcon">Course: <font color="red"> * </font></label>
                                        <div class="controls" id="place_course_dropdown">
                            ...
                            <p><b>Note : <br>1. You cannot import COs, <?php echo $this->lang->line('entity_topic'); ?> & <?php echo $this->lang->line('entity_tlo'); ?> of all <?php echo $this->lang->line('entity_topic'); ?> from the same Curriculum<br> 2. Import feature will import all the COs, <?php echo $this->lang->line('entity_topic'); ?>, <?php echo $this->lang->line('entity_tlo'); ?>, Review & Assignment questions of all respective <?php echo $this->lang->line('entity_topic'); ?>s.</b></p>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-primary" data-dismiss="modal" aria-hidden="true" id="courses_entity_level_import" disabled="disabled"><i class="icon-download icon-white"></i> Import </button>
                            <button type="reset" class="cancel btn btn-danger" data-dismiss="modal"><i class="icon-remove icon-white"></i> Cancel</button>
                        </div>
                    </div>
                    ...
                    <div id="modal_co_existence_alert" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-controls-modal="myModal1" data-backdrop="static" data-keyboard="true">
                        ...
                        <div class="modal-body" id="help_content">
                            <p>COs are already defined for this Course, hence all COs will be removed(erased) and new set of COs will be imported.</p>
                        </div>
				...
				<!-- <div id="co_data_import" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-controls-modal="myModal1" data-backdrop="static" data-keyboard="true">-->
                    ...
                    <div id="modal_tlo_existence_alert" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-controls-modal="myModal1" data-backdrop="static" data-keyboard="true">
                        ...
                        <div class="modal-body" id="help_content">
                            <p>Topics and TLOs are already defined for this Course, hence all Topic and TLOs will be removed(erased) and new set of Topics and TLOs will be imported.</p>
                        </div>
