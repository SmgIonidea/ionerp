...
/**
 * Description          :   Model logic for Criterion 1 (TIER 2) - vision mission.
 * Created              :   3-8-2015
...
class T2ug_c1_vision_mission_model extends CI_Model {
    ...
    public function get_map_peo_me($curriculum_id, $dept_id) {
        ...
        //peo to me mapping
        $call_proce = $this->db->query('CALL nba_t2ug_c1_5_PEO_ME_Mapping(' . $dept_id . ', ' . $curriculum_id . ')');
...
/*
 * End of file t2ug_c1_vision_mission_model.php
 * Location: .nba_sar/ug/tier2/criterion_1/t2ug_c1_vision_mission_model.php 
 */
?>