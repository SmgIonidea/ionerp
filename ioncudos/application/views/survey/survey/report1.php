...
<?php
    ...
    <table style="width:100%;border-collapse: collapse">
        ...
        <div id="table_div_<?php echo $i+1; ?>">
            <b>Comments : </b><br><br>
            <div id="DataTables_Table_<?php echo $i+1; ?>_wrapper" class="dataTables_wrapper" role="grid"  style="overflow: auto;">
                    <div id="DataTables_Table_<?php echo $i+1; ?>_length" class="dataTables_length">
                        <label>Show <select size="1" name="DataTables_Table_<?php echo $i+1; ?>_length" aria-controls="DataTables_Table_<?php echo $i+1; ?>">
                    ...
                    <div class="dataTables_filter" id="DataTables_Table_<?php echo $i+1; ?>_filter">
                        <label>Search: <input type="text" aria-controls="DataTables_Table_<?php echo $i+1; ?>"></label>
                    </div>
                    <table class="table table-bordered table-hover display dataTable" id="DataTables_Table_<?php echo $i+1; ?>" aria-describedby="DataTables_Table_<?php echo $i+1; ?>_info">
                        <thead>
                            <tr role="row">
                                <th class="header headerSortDown" role="columnheader" tabindex="0" aria-controls="DataTables_Table_<?php echo $i+1; ?>" rowspan="1" colspan="1" aria-sort="ascending" aria-label="S.No: activate to sort column descending">S.No</th>
                                <th class="header" role="columnheader" tabindex="0" aria-controls="DataTables_Table_<?php echo $i+1; ?>" rowspan="1" colspan="1" aria-label="Stakeholder: activate to sort column ascending">Stakeholder</th>
                                <th class="header" role="columnheader" tabindex="0" aria-controls="DataTables_Table_<?php echo $i+1; ?>" rowspan="1" colspan="1" aria-label="Remarks: activate to sort column ascending">Remarks</th>
                            </tr>
                        </thead>
                        <tbody role="alert" aria-live="polite" aria-relevant="all">
            <?php 
                foreach ($c[$i-1] as $ckey => $cval){
                    //print_r($cval);
                ?>
                            <tr>
                                <td class=" sorting_1"><?php echo $ckey+1;?></td>
                                <td class=" "><?php echo $cval['first_name']." ".$cval['last_name'];?></td>
                                <td class=" "><?php echo $cval['comment']; ?></td>
                            </tr>
            ...
            ?>
                    ...
                    <div class="dataTables_info" id="DataTables_Table_<?php echo $i+1; ?>_info">Showing  entries</div>
