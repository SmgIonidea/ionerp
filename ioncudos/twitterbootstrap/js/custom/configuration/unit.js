...
$(document).ready(function() {
	var currentID;
        ...
        function currentIDSt(id)
        {
			...
			var unit_delete_path = 'unit/delete_unit_msg';
			...
			var unit_del_path = 'unit/unit_delete';
 ...
 $(document).ready(function() {
	 $.validator.addMethod("loginRegex", function(value, element) {
            ...
            $('.submit1').on('click', function(e) {
                ...
                var flag;
                flag = $('#form1').valid();
                var data_val = document.getElementById("unit_name").value;
                ...
                {
                    $.ajax({type: "POST",
                        url:base_url+'configuration/unit/unit_uniqueness',
                        data: post_data,
                        datatype: "JSON",
                        success: function(msg) {
                            if (msg == 1) {
            ...
            $('.submit_edit').on('click', function(e) {
                ...
                var data_val = document.getElementById("unit_name").value;
				var data_val1 = document.getElementById("unit_id").value;
                ...
                {
                    $.ajax({type: "POST",
                        url:base_url+'configuration/unit/edit_unit_uniqueness',
                        data: post_data,
                        datatype: "JSON",
                        success: function(msg) {
                            if (msg == 1) {
