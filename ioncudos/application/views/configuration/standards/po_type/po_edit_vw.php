<?php
/**
 * Description	:	Edit View for Program Outcomes(POs) Type Module.
 * Created		:	03-04-2013. 
                ...
                <div class="bs-docs-example fixed-height">
                    ...
                    <div class="navbar">
                        <div class="navbar-inner-custom">
                            Edit  <?php echo $this->lang->line('student_outcome_full'); ?> <?php echo $this->lang->line('student_outcome'); ?> Type
                        </div>
                    </div>	
                    <br>
                    <form  class="form-horizontal" method="POST" id="edit_form_id" name="edit_form_id" action= "<?php echo base_url('configuration/po_type/po_update_record'); ?>">
                        <div class="control-group">
                            <p class="control-label" for="crs_type_name"> <?php echo $this->lang->line('student_outcome_full'); ?> <?php echo $this->lang->line('student_outcome'); ?> Type Name:<font color="red">*</font></p>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <div class="controls"> 
                                <?php echo form_input($po_type_id); ?>
                            </div>
                        </div>
                        ...
                        <div class="pull-right">
                            <button class="edit_form_submit btn btn-primary"><i class="icon-file icon-white"></i> Update</button>
                    </form>
