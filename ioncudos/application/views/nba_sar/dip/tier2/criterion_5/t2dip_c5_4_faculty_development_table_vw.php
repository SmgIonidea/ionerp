...
/**
 * Description          :   View for NBA SAR Report - Section 5.4 (Diploma TIER 2) - table of Faculty development / training activities
 * Created              :   07-06-2017
...
$table .= '<tr><td colspan="4" gridspan="5">Average assessment over three years (Marks limited to 30) = ' . number_format((float) $avg, 2, '.', '') . '</td></tr></tbody></table>';
echo $table;
/*
 * End of file t2dip_c5_4_faculty_development_table_vw.php 
 * Location: .nba_sar/dip/tier2/criterion_5/t2dip_c5_4_faculty_development_table_vw.php
 */
?>