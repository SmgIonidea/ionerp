        ...
        <div class="span10">
            ...
            <section id="contents">
                <div class="bs-docs-example">
                    <!--content goes here-->
                    <form target="_self" name="form_id" id="form_id" method="POST" action="<?php echo base_url('nba_sar/curriculum_student_info/insert_student_info'); ?>" class="row-fluid" style="width:100%; overflow:auto;">
                        <div class="navbar">
                            ...
                            <div class="span12">
                                        ...
                                        <tr>
                                            <td>
                                                <p>
                                                    ...
                                                    <select size="1" id="dept" name="dept" aria-controls="example" onChange = "fetch_program();" class="required">
                                            ...
                                            <td>
                                                <p>
                                                    ...
                                                    <select size="1" id="program" name="program" aria-controls="example" onChange = "fetch_curriculum();" class="required">
                                            ...
                                            <td>
                                                <p>
                                                    ...
                                                    <select size="1" id="curriculum" name="curriculum" aria-controls="example" onChange = "fetch_details();" class="required">
                                ...
                                <div id="main_table" class="bs-docs-example span8 wrapper2" style="width:98%;height:100%;overflow:auto;display:none">
                                    <div class="map_po_to_peo"><div class="accordion">
                                        ...
                                        <div id="std_intake" class="panel-collapse collapse in"></div>
                                            ...
                                            <div class="accordion-group">
                                                ...
                                                <div class="brand-custom">
                                                    <a class="brand-custom collapsed" data-toggle="collapse" href="#student_placement" style="text-decoration:none;">
                                                        <h5><b>&nbsp;<i class="icon-chevron-down"></i>&nbsp;Student Placement & Higher Study Details</b></h5>
                                                    </a>                    
                                                </div>
                                            </div>
                                        </div>
...
<script src="<?php echo base_url('twitterbootstrap/js/custom/nba_sar/curriculum_student_info.js'); ?>" type="text/javascript"></script>
<!-- End of file curriculum_student_info_vw.php 
                        Location: nba_sar/modules/curriculum_student_info/curriculum_student_info_vw.php  -->