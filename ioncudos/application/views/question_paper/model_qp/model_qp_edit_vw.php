    ...
    ================================================== -->
                    <section id="contents">
                        <div class="bs-docs-example fixed-height">
							...
							<form class="form-horizontal" method="POST" id="add_form_id" name="add_form_id" action= "<?php echo base_url('question_paper/manage_model_qp/update_qp_data/4'); ?>">
							  <div class="control-group">
								...
								<div class="span12">
									...
									<div class="span6 ">
										  <div class="control-group pull-right">
											...
											<div class="controls">
											  <input type="text" id="attempt_question_<?php echo $unit_counter; ?>" name="attempt_question_<?php echo $unit_counter; ?>" value="<?php echo $unit_details['qp_attempt_unitquestion']; ?>" class="input-mini required numeric attempt_question total_marks_validation">
											</div>
										  </div>
									</div>
								</div>
													...
													if($qp_entity_config['entity_id'] == 10 ){?>
														<td>
															<select onmouseover="tool_tip_on(this.id);" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="" name="topic_list_<?php echo $mq_counter;?>_<?php echo $sub_counter;?>" id="topic_list_<?php echo $mq_counter;?>_<?php echo $sub_counter;?>" class="input-small topic_list_data required">
																	<option value="" abbr="Select Topic">Select</option>
					...
					<input type="hidden" name="url_ids" id="url_ids" value="<?php echo $url_ids;?>" />
					...
					<input type="text" id="qp_max_marks" name="qp_max_marks" class="input-mini required max_marks" value="<?php echo $meta_data[0]['qpd_gt_marks'];?>" readonly />
					</div>		
					</div>		
					</div>		
					</div>
						...
						<a href= "<?php echo base_url('question_paper/manage_model_qp'); ?>"><b class="btn btn-danger"><i class="icon-remove icon-white"></i><span></span> Close</b></a>
						</div>
						<br>
					 	</form>
