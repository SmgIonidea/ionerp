 ...
 * 08/05/2017               Bhagyalaxmi S S             Code cleaning			
  ------------------------------------------------------------------------------------- */
?>
...
class T2ug_c4_student_performance_model extends CI_Model {
    ...
    public function fetch_student_performance($pgm_id, $year) {
        $result = $this->db->query('CALL nba_t2ug_c4_Cummulative_shifts(' . $pgm_id . ', ' . $year . ')');
    ...
    public function fetch_student_without_backlogs($pgm_id, $year) {
        $result = $this->db->query('CALL nba_t2ug_c4_Without_backlogs(' . $pgm_id . ', ' . $year . ')');
        mysqli_next_result($this->db->conn_id);
        $result = $result->result_array();
        return $result;
    }
    ...
    public function fetch_students_graduated($pgm_id, $year) {
        $result = $this->db->query('CALL nba_t2ug_c4_Graduated_students(' . $pgm_id . ', ' . $year . ')');
        mysqli_next_result($this->db->conn_id);
        $result = $result->result_array();
        return $result;
    }
    ...
    public function fetch_enrolment_ratio($crclm_id) {
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c4_1_EnrolmentRatio(' . $result['pgm_id'] . ',' . $result['start_year'] . ')');
        mysqli_next_result($this->db->conn_id);
    ...
    public function fetch_success_rate($crclm_id) {
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c4_2_1_SRWithoutBacklog(' . $result['pgm_id'] . ',' . $result['start_year'] . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    /**
     * Function to fetch the success rate avarage - section 4.2.1
     * @paramenters : curriculum id
     * @return      : array
     */
    public function fetch_success_rate_avg_si($crclm_id) {
        $query = 'SELECT pgm_id, start_year 
                  FROM curriculum 
                  WHERE crclm_id = "' . $crclm_id . '" ';
        $result_data = $this->db->query($query);
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c4_2_1_SRWithoutBacklogAverageSI(' . $result['pgm_id'] . ',' . $result['start_year'] . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_success_rate_in_stipulated($crclm_id) {
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c4_2_2_SRInPeriod(' . $result['pgm_id'] . ',' . $result['start_year'] . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    /**
     * Function to fetch the success in stipulated rate avarage si - section 4.2.2
     * @paramenters : curriculum id
     * @return      : array
     */
    public function fetch_success_rate_in_stipulated_avg_si($crclm_id) {
        $query = 'SELECT pgm_id, start_year 
                  FROM curriculum 
                  WHERE crclm_id = "' . $crclm_id . '" ';
        $result_data = $this->db->query($query);
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c4_2_2_SRInPeriodAverageSI(' . $result['pgm_id'] . ',' . $result['start_year'] . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
     ...
     * @return      : array
     */
    public function fetch_academic_performance_third_yr($crclm_id) {
        $query = 'SELECT pgm_id, start_year 
                    FROM curriculum 
                    WHERE crclm_id = "' . $crclm_id . '" ';
        $result_data = $this->db->query($query);
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c4_3_AcademicPerformance(' . $result['pgm_id'] . ',' . $result['start_year'] . ',3' . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    /**
     * Function to fetch the academic performance in third year - section 4.4
     * @paramenters : curriculum id
     * @return      : array
     */
    public function fetch_academic_performance_sec_yr($crclm_id) {
        $query = 'SELECT pgm_id, start_year 
                    FROM curriculum 
                    WHERE crclm_id = "' . $crclm_id . '" ';
        $result_data = $this->db->query($query);
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c4_3_AcademicPerformance(' . $result['pgm_id'] . ',' . $result['start_year'] . ',2' . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    /**
     * Function to fetch the Placement,Higher Studies and Entrepreneurship details - section 4.5
     * @paramenters : curriculum id
     * @return      : array
     */
    public function fetch_placement_higher_studies($crclm_id) {
        ...
        $call_proce = $this->db->query('CALL nba_t2ug_c4_5_Placement(' . $result['pgm_id'] . ',' . $result['start_year'] . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_professional_societies($dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c4_6_1_Professional_Societies(' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
    ...
    public function fetch_publications($dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c4_6_2_Publication(' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
     ...
     * @return      : Array
     */
    public function fetch_inter_institute_events($dept_id) {
        $call_proce = $this->db->query('CALL nba_t2ug_c4_6_3_inter_institute_events(' . $dept_id . ')');
        mysqli_next_result($this->db->conn_id);
        $proce_result = $call_proce->result_array();
...
/*
 * End of file t2ug_c4_student_performance_model.php 
 * Location: .nba_sar/ug/tier2/criterion_4/t2ug_c4_student_performance_model.php
 */
?>