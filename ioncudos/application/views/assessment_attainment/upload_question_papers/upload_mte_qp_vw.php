            ...
            <section id="contents">
                <div class="bs-docs-example fixed-height" >
					...
					<div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                1) Click here to 
                                                <a href="<?php echo base_url('uploads/question_paper_template/MTE_Question_Paper_Template.xls'); ?>" title="Select Section before downloading Template." target="" id="download_file" 0="rel=" facebox""=""><b>Download Question Paper Template</b></a><input type="hidden" name="import_type" id="import_type" value="excel"><font color="#8E2727"> (File name: MTE_Question_Paper_Template.xls).</font>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                        ...
                        $form_action = "assessment_attainment/upload_mte_question_papers/index/".$pgm_id."/".$crclm_id."/".$crclm_term_id."/".$crs_id."/".$qn_type;
                        echo form_open($form_action, $form_attribute);
                        ?>
                        <br>
                        <div class="container_one" style="margin-top:-12px">
                            <div class="row">
