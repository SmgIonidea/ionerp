...
$(function(){
    ...
    $('#view').on('change','#curriculum_2_2_2', function() {
        ...
        if(curriculum){
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/display_curriculum_courses',
                async:false,
                data: post_data,
    ...
    $('#view').on('change','#curriculum_course_examination', function() {
        ...
        if(selected_course){
            ...
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/display_course_qp',
                async:false,
                data: post_data,
    ...
    $('#view').on('click','#generate_2_2_2_report', function() {
        ...
        if(selected_qp) {
            ...
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/generate_model_qp_modal_tee',
                async:false,
                data: post_data,
                success: function(question_paper) {
                    tiny_init();
            ...
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/course_co_planned_coverage',
                async:false,
                data: post_data,
            ...
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/course_bloom_level_marks_distribution',
                async:false,
                data: post_data,
            ...
            $.ajax({
                type:"POST",
                url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/create_graph_image',
                async:false,
                data: post_data,
    ...
    //Report 2.2.4 
    //Function is to fetch term list. - section 2.2.4 
    $('#view').on('change','#curriculum_2_2_4_list', function() { 
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/get_term_list',
            async:false,
            data: post_data,
            success: function(msg) {
                $('#term_2_2_4_list').empty();
                $('#term_2_2_4_list').html(msg);
            }
        });
    });
		
    //Function is to fetch course list. - section 2.2.4 
    $('#view').on('change','#term_2_2_4_list', function() {
        $("#student_quality_project_div").html('');
        var base_url = $('#get_base_url').val();
        var crclm_id = $('#curriculum_2_2_4_list').val();
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/get_course_list',
            async:false,
            data: post_data,
            success: function(msg) {
                $('#course_2_2_4_list').html(msg);
            }
        });
    });		
    
    //Function is to display quality of student project. - section 2.2.4 
    $('#view').on('click','#generate_2_2_4_report', function() {
        $('#student_quality_project_div').empty();
        var base_url = $('#get_base_url').val();
        var name = $('#curriculum_2_2_4_list').attr('name'); 
        var name_value = name.replace('curriculum_list__', '');
        var curriculum = $('#curriculum_2_2_4_list').val();
        var course_id = $('#course_2_2_4_list').val();
        var crclm_id = $('#curriculum_2_2_4_list').val();
        var term_id = $('#term_2_2_4_list').val();
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/get_quality_student_project',
            async:false,
            data: post_data,
            dataType: 'json',
    ...
    $('#view').on('change','#curriculum_2_2_5', function() {
        ...
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t2dip_c2_teaching_learning_process/display_industry_internship',
            async:false,
            data: post_data,
            dataType: 'json',
            success: function(msg) {
