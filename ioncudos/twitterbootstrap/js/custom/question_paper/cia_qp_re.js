        ...
        if (validation_flag == true) {
            if (grand_total >= max_marks) {
                ...
                if (all_unit_marks != Grand_total && all_unit_marks != 0) {
                    ...
                    $.ajax({type: "POST",
                        url: base_url + 'question_paper/manage_model_qp/cia_model_qp_def',
                        data: post_data,
                        dataType: 'json',
                        success: function (data) {
                            ...
                            if (data == "false") {
                                ...
                                window.location = base_url + 'question_paper/manage_model_qp/generate_cia_model_qp/' + pgm_id + '/' + crclm_id + '/' + term_id + '/' + crs_id + '/' + ao_id + '/3';
                            }
