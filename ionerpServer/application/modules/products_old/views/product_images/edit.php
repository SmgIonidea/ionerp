...
$form_action= "/products/product_images/edit";
...
"required"=>"", 
"type"=>"hidden", 
"value" => (isset($data["image_id"]))?$data["image_id"]:""
); 
echo form_error("image_id"); echo form_input($attribute); ?><div class = 'form-group row'>
