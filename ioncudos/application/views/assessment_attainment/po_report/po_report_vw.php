<?php
/**
 * Description	:	It is to display the complete report of PO.
...
?>
                            ...
                            <form target="_blank" name="form1" id="form1" method="POST" action="<?php echo base_url('report/clo_po_map_report/export_pdf'); ?>">
                                <div class="navbar">
                                    <div class="navbar-inner-custom">
                                       <?php echo $this->lang->line('student_outcome_full'); ?> (<?php echo $this->lang->line('so'); ?>) Attainment Report
                                    </div>
                                    ...
                                    <div class="span12">
                                        <div class="row-fluid" style="width:100%; overflow:auto;">
											...
											<div id="po_modal_view" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-controls-modal="myModal1" data-backdrop="static" data-keyboard="false" style="width:1000px; margin-left:-225px;">
												...
												<div class="controls" id="crs_name">
												</div>
											...
											<br>
											<div id="co_drill_down_modal_view" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-controls-modal="myModal1" data-backdrop="static" data-keyboard="false" style="width:1000px; margin-left:-225px;">
												<div class="modal-header">
													<div class="navbar">
														<div class="navbar-inner-custom" id="co_drill_change_navbar">
															<?php echo $this->lang->line('so'); ?> Data
														</div>
													</div>
												</div>
												...
												<div class="modal-body" id="co_drill_down_modal_body">
												</div>
												<div class="modal-footer">
													<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-white"></i> Close </button>
												</div>
	...
	<script src="<?php echo base_url('twitterbootstrap/js/custom/assessment_attainment/po_report.js'); ?>" type="text/javascript"> </script>
