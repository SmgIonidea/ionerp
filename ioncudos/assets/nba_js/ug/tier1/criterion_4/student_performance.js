...
//
//SECTION 4 JS function Starts from here
$('#view').on('change','#c4_crclm_list', function() {
    ...
    if(curriculum_year) {	
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c4_student_performance/fetch_student_performance',
            async:false,
            data: post_data,
...
$('#view').on('change','#c4_1_crclm_list', function() {
    ...
    if(curriculum) {
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c4_student_performance/fetch_enrolment_ratio',
            async:false,
            data: post_data,
            success: function(msg) {
...
$('#view').on('change','#c4_2_crclm_list', function() {
    ...
    if(curriculum) {
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c4_student_performance/fetch_success_rate_in_program',
            async:false,
            data: post_data,
            success: function(msg) {
                $('#enrolment_ratio').html(msg);
...
$('#view').on('change','#c4_2_2_crclm_list', function() {
    ...
    if(curriculum) {
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c4_student_performance/fetch_success_rate_in_stipulated_period',
            async:false,
            data: post_data,
            success: function(msg) {
                $('#enrolment_ratio').html(msg);
...
$('#view').on('change','#c4_3_crclm_list', function() {
    ...
    if(curriculum) {
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c4_student_performance/fetch_academic_performance',
            async:false,
            data: post_data,
            success: function(msg) {
                $('#enrolment_ratio').html(msg);
...
$('#view').on('change','#c4_4_crclm_list', function() {
    ...
    if(curriculum) {
        $.ajax({
            type:"POST",
            url: base_url+'nba_sar/t1ug_c4_student_performance/fetch_placement_higher_studies',
            async:false,
            data: post_data,
            success: function(msg) {
                $('#enrolment_ratio').html(msg);
