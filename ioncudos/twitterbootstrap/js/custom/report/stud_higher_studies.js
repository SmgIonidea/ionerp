...
function display_higher_studies_modal() {
    ...
    $.ajax({type: 'POST',
        url: base_url + 'report/curriculum_student_info/stud_higher_studies_details',
        data: post_data,
        dataType: 'json',
...
$("#submit_higher_studies").click(function () {
    ...
    if (flag) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'report/curriculum_student_info/check_higher_studies_save',
            data: post_data,
            datatype: "json",
            success: function (data) {
                if (data == 1) {
                    $.ajax({
                        type: "POST",
                        url: base_url + 'report/curriculum_student_info/insert_higher_studies_data',
                        data: post_data,
                        datatype: "json",
                        success: function (data) {
...
$("#update_higher_studies").click(function () {
    ...
    if (flag) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'report/curriculum_student_info/check_higher_studies_edit',
            data: post_data,
            datatype: "json",
            success: function (data) {
                ...
                if (data == 1) {
                    $.ajax({
                        type: "POST",
                        url: base_url + 'report/curriculum_student_info/update_higher_studies_data',
                        data: post_data,
                        datatype: "json",
                        success: function (data) {
                            display_higher_studies_modal();
...
$("#higher_studies_delete_selected").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: base_url + 'report/curriculum_student_info/higher_studies_details_delete',
        data: post_data,
        datatype: "json",
        success: function (data) {
            display_higher_studies_modal();
...
function warning_modal(msg) {
    var data_options = '{"text":"Higher Studies data already exists.","layout":"center","type":"error","animateOpen": {"opacity": "show"}}';
    var options = $.parseJSON(data_options);
    noty(options);
}
