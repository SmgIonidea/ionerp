<?php
/*
 * Description	:	Tier II MTE CO Level Attainment View
                ...
                <div class="bs-docs-example" >
                    ...
                    <div class="navbar">
                        <div class="navbar-inner-custom">
                          <?php echo $this->lang->line('entity_mte'); ?> - <?php echo $this->lang->line('entity_clo_full'); ?> (<?php echo $this->lang->line('entity_clo'); ?>) Attainment
                        </div>
                    </div>
					...
					<!-- <form  method="POST" id="indirect_direct_attainment_form" name="indirect_direct_attainment_form" class="form-inline"  action="<?php echo base_url('assessment_attainment/tier1_section_clo_attainment/export_to_doc'); ?>">-->
                        ...
                        <table style="width:100%; overflow:auto;">
                            <tr>
                                ...
                                <td>
                                    <p>
                                        ...
                                        <select  id="course" name="course" class="input-large" onchange="">
                            ...
                            <tr>
                                ...
                                <td>
                                         <?php echo $this->lang->line('entity_mte'); ?>  Occasion :<font color='red'>*</font> <?php echo str_repeat('&nbsp;', 2); ?>
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="direct_attainment">
							   ...
							   <div id="main_div">
                                ...
                                <div id="finalize_direct_indirect_success" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="finalize_direct_indirect_success" data-backdrop="static" data-keyboard="true">
                                    ...
                                    <div class="modal-body">
                                        <p> Course - <?php echo $this->lang->line('entity_mte'); ?> <?php echo $this->lang->line('entity_clo_full'); ?>(<?php echo $this->lang->line('entity_clo'); ?>) Attainment for the course are finalized and updated successfully.</p>
                                    </div>
                                    <div class="modal-footer">
                            ...
                            <!-- Tab one - Course Plan ends here -->	
                                ...
                                <div id="myModalfinalize" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    ...
                                    <div class="modal-body">
                                        <p>Are you sure you want to Finalize the Course - <?php echo $this->lang->line('entity_mte'); ?>  <?php echo $this->lang->line('entity_clo_full'); ?>(<?php echo $this->lang->line('entity_clo'); ?>) Attainment for the Final Submit ?</p>
                                    </div>
                                    <div class="modal-footer">
...
<script type="text/javascript" src="<?php echo base_url('twitterbootstrap/js/custom/assessment_attainment/tier_ii/mte_section_level_attainment/mte_co_section_level_attainment.js'); ?>"></script>
