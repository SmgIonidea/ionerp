...
<body data-spy="scroll" data-target=".bs-docs-sidebar">
                ...
                <section id="contents">
                    <div class="bs-docs-example" >
                        ...
                        <div class="navbar">
                            <div class="navbar-inner-custom">
                                Course Outcomes (<?php echo $this->lang->line('entity_clo'); ?>) Attainment <?php echo $this->lang->line('entity_mte'); ?>
                            </div>
                        </div>
                        <div class="bs-example bs-example-tabs">
                            <form  method="POST" id="indirect_direct_attainment_form" name="indirect_direct_attainment_form" class="form-inline"  action="<?php echo base_url('assessment_attainment/tier1_mte_clo_attainment/export_to_doc'); ?>">
                                 <div class="row-fluid">
								   ...
								   <input type="hidden" id="doc_occasion_id" name="doc_occasion_id" value=""/>
                                    <div class="control-group span4 form-horizontal_new">
                                ...
                                <div class="row-fluid">
                                  <!--  <div class="control-group span4 form-horizontal_new">
                                    ...
                                    <div class="control-group span4 form-horizontal_new">
                                       <label class="control-label" style="width:100px;" for="inputEmail"> <?php echo $this->lang->line('entity_mte'); ?> Occasion: <font color="red">*</font></label>
                                       <div class="controls">
                                ...
                                <div id="clo_finalize_data_div" style="display:none;">
                                    <div class="navbar">
                                       <div class="navbar-inner-custom">
                                           <?php echo $this->lang->line('entity_mte'); ?>- Course Outcomes(<?php echo $this->lang->line('entity_clo'); ?>) Attainment is Finalized 
                                       </div>
                                    </div>
                                ...
                                <div id="po_attainment_div" style="display:none;">
                                    <div class="navbar">
                                       <div class="navbar-inner-custom">
                                         <?php echo $this->lang->line('student_outcomes_full'); ?> (<?php echo $this->lang->line('sos'); ?>) Attainment Through (<?php echo $this->lang->line('entity_mte'); ?>) By.
                                       </div>
                                    </div>
                            ...
                            <div id="export_file_content">         
                                ...
                                <div id="display_finalized_attainment_div" style="display:none;" >
                                    <div class="navbar" id="cia_tee_attainment_navbar"  >
                                        <div class="navbar-inner-custom">
                                            Course - <?php echo $this->lang->line('entity_mte'); ?> <?php echo $this->lang->line('entity_clo_full'); ?> (<?php echo $this->lang->line('entity_clo'); ?>) Attainment is Finalized
                                        </div>
                                    </div>
                    ...
                    <!--finalize-->
                                <div id="section_attainment_finalize" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    ...
                                    <div class="modal-body">
                                        <p>Are you sure you want to Finalize Course - (<?php echo $this->lang->line('entity_mte'); ?>) Course Outcomes(COs) Attainment for the Final Submit ? </p>
                                    </div>
                                    <div class="modal-footer">
                                ...
                                <div id="clo_attainment_final_success" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="finalize_direct_indirect_success" data-backdrop="static" data-keyboard="true">
                                    ...
                                    <div class="modal-body">
                                        <p> Course - (<?php echo $this->lang->line('entity_mte'); ?>) Course Outcomes(COs) Attainment for the course are finalized and updated successfully.</p>
                                    </div>
                                    <div class="modal-footer">
                                ...
                                <div id="clo_attainment_final_unsuccess" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="finalize_direct_indirect_success" data-backdrop="static" data-keyboard="true">
                                    ...
                                    <div class="modal-body">
                                        <p>The finalization of Course Outcomes (COs) Attainment for the Course are unsuccessful.</p>
                                    </div>
                                    <div class="modal-footer">
                    ...
                    <div id="attainmnet_modal" class="modal hide fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" data-controls-modal="error_dialog_window" data-backdrop="static" data-keyboard="true"></br>
                        ...
                        <div class="modal-body">
                            ...
                            <div id="cia_weight" class="span12">
                                <b> <?php echo $this->lang->line('entity_mte'); ?> Weightage: </b> <font id="mte"></font>
                            </div>
                            <br/>
    ...
    <script type="text/javascript" src="<?php echo base_url('twitterbootstrap/js/custom/assessment_attainment/tier_i/tier1_mte_clo_attainment.js'); ?>"></script>
