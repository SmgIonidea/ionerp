<?php
/**
 * Description          :   View for NBA SAR Report - Section 1.2 (TIER 2) - PEO.
 * Created              :   3-8-2015
 * Author               :       
 * Modification History :
 * Date                     Modified by                      Description
 * 3-8-2015                 Jevi V. G.              Added file headers, public function headers, indentations & comments.
 * 3-5-2016                 Arihant Prasad          Code cleanup and indentation
  --------------------------------------------------------------------------------------------------------------- */
?>
<?php
...
<!-- End of file t2ug_c1_2_peo_vw.php 
        Location: .nba_sar/ug/tier2/criterion_1/t2ug_c1_2_peo_vw.php -->