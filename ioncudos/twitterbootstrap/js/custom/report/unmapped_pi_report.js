	...
	//Unmapped Performance Indicator Report

	var base_url = $('#get_base_url').val();

	//Unmapped Performance Indicator Report View and Static View Page
	...
	function select_pos() {
		...
		$.ajax({type: "POST",
			url: base_url + 'report/unmapped_pi_report/fetch_unmapped',
			data: post_data,
