...
class PrepareBill extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('hostel/PrepareBill_model');
    ...
    public function getBuildingList() {
        ...
        $data = $this->PrepareBill_model->getBuildList($formData);       
    ...
    public function prepareBillDetails() {       
        ...
        $createResult = $this->PrepareBill_model->BillDetails($formData);        
