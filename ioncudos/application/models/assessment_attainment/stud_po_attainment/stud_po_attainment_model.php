 ...
 */
  ...
  class Stud_po_attainment_model extends CI_Model 
  {
...
public function getPOThreshholdAttainment($crclm_id, $term, $course=NULL, $qpid=NULL, $student_usn, $qptype,$po_attainment_type,$core_crs_id) {
	if($term == 'All'){
		...
		/*   if($po_attainment_type=='CO_TARGET'){
			...
			$result = $this->db->query("call getPOThreshholdAttainment(".$crclm_id.", NULL,'".$core_crs_id."', NULL, NULL, ".$student_usn.", '".$qptype_val."')");  	
		  }
		return $result->result_array();
		...
		if($qptype == 1){
		 ...
		 /*  if($po_attainment_type=='CO_TARGET'){
			...
			$result1 = $this->db->query("call getPOThreshholdAttainment(".$crclm_id.",'".$term."','".$core_crs_id."', NULL, NULL,'".$student_usn."', '".$qptype_val."')");  	
		  }
