<?php
/**
 * Description		:   View page for listed companies.
 * Created		:   22-11-2016
...
<div class="container-fluid">
                ...
                <div class="bs-docs-example">
                    <div class="navbar">
                        <div class="navbar-inner-custom">
                            <?php echo $this->lang->line('industry_plur'); ?> List
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span12">
                    ...
                    <input type="hidden" id="edit_contact_name" name="edit_contact_name">
                    <input type="hidden" id="edit_contact_no" name="edit_contact_no">
                    <input type="hidden" id="edit_email" name="edit_email">
                    </section>
                </div>
        </div>
    </div>
    ...
    <script src="<?php echo base_url('twitterbootstrap/js/custom/nba_sar/companies_list.js'); ?>" type="text/javascript"></script>
    <script>
    ...
    <!-- End of file companies_list_vw.php 
